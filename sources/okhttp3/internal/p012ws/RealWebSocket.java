...
public final class RealWebSocket implements WebSocket, FrameCallback {
    ...
    public RealWebSocket(Request request, WebSocketListener webSocketListener, Random random2, long j) {
        if ("GET".equals(request.method())) {
            ...
            this.key = ByteString.m398of(bArr).base64();
    ...
    public void connect(OkHttpClient okHttpClient) {
        ...
        final Request build2 = newBuilder.header(str, "websocket").header(HttpHeaders.CONNECTION, str).header("Sec-WebSocket-Key", this.key).header("Sec-WebSocket-Version", "13").build();
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x0058, code lost:
        if ((r5 instanceof okhttp3.internal.p012ws.RealWebSocket.Message) == false) goto L_0x0086;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:37:0x0088, code lost:
        if ((r5 instanceof okhttp3.internal.p012ws.RealWebSocket.Close) == false) goto L_0x009f;
     */
    ...
    public boolean writeOneFrame() throws java.io.IOException {
        ...
        L_0x0008:
            ...
            boolean r6 = r5 instanceof okhttp3.internal.p012ws.RealWebSocket.Close     // Catch:{ all -> 0x00aa }
        ...
        L_0x0031:
            ...
            r8 = r5
            okhttp3.internal.ws.RealWebSocket$Close r8 = (okhttp3.internal.p012ws.RealWebSocket.Close) r8     // Catch:{ all -> 0x00aa }
        ...
        L_0x004f:
            ...
            goto L_0x009a
        L_0x0056:
            boolean r2 = r5 instanceof okhttp3.internal.p012ws.RealWebSocket.Message     // Catch:{ all -> 0x00a5 }
            if (r2 == 0) goto L_0x0086
            r1 = r5
            okhttp3.internal.ws.RealWebSocket$Message r1 = (okhttp3.internal.p012ws.RealWebSocket.Message) r1     // Catch:{ all -> 0x00a5 }
            okio.ByteString r1 = r1.data     // Catch:{ all -> 0x00a5 }
            okhttp3.internal.ws.RealWebSocket$Message r5 = (okhttp3.internal.p012ws.RealWebSocket.Message) r5     // Catch:{ all -> 0x00a5 }
        ...
        L_0x0086:
            boolean r2 = r5 instanceof okhttp3.internal.p012ws.RealWebSocket.Close     // Catch:{ all -> 0x00a5 }
            if (r2 == 0) goto L_0x009f
            okhttp3.internal.ws.RealWebSocket$Close r5 = (okhttp3.internal.p012ws.RealWebSocket.Close) r5     // Catch:{ all -> 0x00a5 }
