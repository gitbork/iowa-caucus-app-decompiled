...
public final class Status {
    ...
    static final Key<Status> CODE_KEY = Key.m373of("grpc-status", false, (TrustedAsciiMarshaller<T>) new StatusCodeMarshaller<T>());
    ...
    static final Key<String> MESSAGE_KEY = Key.m373of("grpc-message", false, STATUS_MESSAGE_MARSHALLER);
    public static final Status NOT_FOUND = Code.NOT_FOUND.toStatus();

    /* renamed from: OK */
    public static final Status f146OK = Code.OK.toStatus();
        ...
        private static byte[] toAsciiStringSlow(byte[] bArr, int i) {
            ...
            while (i < bArr.length) {
                ...
                if (isEscapingChar(b)) {
                    ...
                    bArr2[i2 + 2] = bArr3[b & Ascii.f158SI];
                    i2 += 3;
                } else {
                    int i4 = i2 + 1;
                    bArr2[i2] = b;
    ...
    public java.lang.String toString() {
        ...
        L_0x0020:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p006io.grpc.Status.toString():java.lang.String");
    }
