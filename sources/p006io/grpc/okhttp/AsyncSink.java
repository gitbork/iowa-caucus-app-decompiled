...
final class AsyncSink implements Sink {
    ...
    private AsyncSink(SerializingExecutor serializingExecutor2, TransportExceptionHandler transportExceptionHandler2) {
        this.serializingExecutor = (SerializingExecutor) Preconditions.checkNotNull(serializingExecutor2, "executor");
        this.transportExceptionHandler = (TransportExceptionHandler) Preconditions.checkNotNull(transportExceptionHandler2, "exceptionHandler");
    }

    static AsyncSink sink(SerializingExecutor serializingExecutor2, TransportExceptionHandler transportExceptionHandler2) {
    ...
    public void write(Buffer buffer2, long j) throws IOException {
        Preconditions.checkNotNull(buffer2, Param.SOURCE);
        if (!this.closed) {
