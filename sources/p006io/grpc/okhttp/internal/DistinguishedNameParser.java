...
final class DistinguishedNameParser {
    ...
    /* renamed from: dn */
    private final String f466dn;
    private int end;
    private final int length = this.f466dn.length();
    private int pos;

    public DistinguishedNameParser(X500Principal x500Principal) {
        this.f466dn = x500Principal.getName("RFC2253");
    }
    ...
    private java.lang.String escapedAV() {
        ...
        L_0x009b:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p006io.grpc.okhttp.internal.DistinguishedNameParser.escapedAV():java.lang.String");
    }
    ...
    public String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f466dn.toCharArray();
