...
import p006io.grpc.internal.TransportFrameUtil;
...
class Headers {
    ...
    public static List<Header> createRequestHeaders(Metadata metadata, String str, String str2, String str3, boolean z) {
        ...
        for (int i = 0; i < http2Headers.length; i += 2) {
            ByteString of = ByteString.m398of(http2Headers[i]);
            if (isApplicationHeader(of.utf8())) {
                arrayList.add(new Header(of, ByteString.m398of(http2Headers[i + 1])));
            }
        }
        return arrayList;
    }
