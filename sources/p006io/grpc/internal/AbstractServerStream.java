...
import p006io.grpc.InternalStatus;
import p006io.grpc.Metadata;
import p006io.grpc.Status;

/* renamed from: io.grpc.internal.AbstractServerStream */
public abstract class AbstractServerStream extends AbstractStream implements ServerStream, p006io.grpc.internal.MessageFramer.Sink {
    ...
    protected static abstract class TransportState extends p006io.grpc.internal.AbstractStream.TransportState {
        ...
        public void complete() {
            if (this.deframerClosed) {
                this.deframerClosedTask = null;
                closeListener(Status.f146OK);
                return;
            }
            this.deframerClosedTask = new Runnable() {
                public void run() {
                    TransportState.this.closeListener(Status.f146OK);
                }
            };
            this.immediateCloseRequested = true;
            closeDeframer(true);
