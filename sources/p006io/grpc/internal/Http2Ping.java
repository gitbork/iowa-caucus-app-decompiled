...
public class Http2Ping {
    ...
    public void addCallback(p006io.grpc.internal.ClientTransport.PingCallback r3, java.util.concurrent.Executor r4) {
        /*
            r2 = this;
            monitor-enter(r2)
        ...
        L_0x000c:
            ...
            java.lang.Throwable r0 = r2.failureCause     // Catch:{ all -> 0x0022 }
            java.lang.Runnable r3 = asRunnable(r3, r0)     // Catch:{ all -> 0x0022 }
            goto L_0x001d
        L_0x0017:
        ...
        L_0x0022:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: p006io.grpc.internal.Http2Ping.addCallback(io.grpc.internal.ClientTransport$PingCallback, java.util.concurrent.Executor):void");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x0029, code lost:
        ...
        doExecute((java.util.concurrent.Executor) r4.getValue(), asRunnable((p006io.grpc.internal.ClientTransport.PingCallback) r4.getKey(), r1));
     */
    ...
    public boolean complete() {
        ...
        L_0x0023:
            ...
            io.grpc.internal.ClientTransport$PingCallback r4 = (p006io.grpc.internal.ClientTransport.PingCallback) r4
            java.lang.Runnable r4 = asRunnable(r4, r1)
            doExecute(r5, r4)
            goto L_0x0023
        L_0x0043:
            return r0
        ...
        L_0x0048:
            goto L_0x0047
        */
        throw new UnsupportedOperationException("Method not decompiled: p006io.grpc.internal.Http2Ping.complete():boolean");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:11:0x0020, code lost:
        ...
        notifyFailed((p006io.grpc.internal.ClientTransport.PingCallback) r1.getKey(), (java.util.concurrent.Executor) r1.getValue(), r4);
     */
    ...
    public void failed(java.lang.Throwable r4) {
        ...
        L_0x001a:
            ...
            io.grpc.internal.ClientTransport$PingCallback r2 = (p006io.grpc.internal.ClientTransport.PingCallback) r2
        ...
        L_0x003b:
            goto L_0x003a
        */
        throw new UnsupportedOperationException("Method not decompiled: p006io.grpc.internal.Http2Ping.failed(java.lang.Throwable):void");
    }
    ...
    private static Runnable asRunnable(final PingCallback pingCallback, final Throwable th) {
        return new Runnable() {
            public void run() {
                PingCallback.this.onFailure(th);
            }
        };
    }
}
