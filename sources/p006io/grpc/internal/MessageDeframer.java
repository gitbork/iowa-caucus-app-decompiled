...
public class MessageDeframer implements Closeable, Deframer {
    ...
    static /* synthetic */ class C21041 {
        ...
        static {
            /*
                io.grpc.internal.MessageDeframer$State[] r0 = p006io.grpc.internal.MessageDeframer.State.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                ...
                io.grpc.internal.MessageDeframer$State r1 = p006io.grpc.internal.MessageDeframer.State.HEADER     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = $SwitchMap$io$grpc$internal$MessageDeframer$State     // Catch:{ NoSuchFieldError -> 0x001f }
                io.grpc.internal.MessageDeframer$State r1 = p006io.grpc.internal.MessageDeframer.State.BODY     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p006io.grpc.internal.MessageDeframer.C21041.<clinit>():void");
        }
    }
    ...
    private static class SingleMessageProducer implements MessageProducer {
        ...
        /* synthetic */ SingleMessageProducer(InputStream inputStream, C21041 r2) {
            this(inputStream);
        }
    ...
    private void deliver() {
        if (!this.inDelivery) {
            ...
            while (!this.stopDelivery && this.pendingDeliveries > 0 && readRequiredBytes()) {
                try {
                    int i = C21041.$SwitchMap$io$grpc$internal$MessageDeframer$State[this.state.ordinal()];
                    if (i == 1) {
                        processHeader();
                    } else if (i == 2) {
                        processBody();
