...
abstract class RetriableStream<ReqT> implements ClientStream {
    ...
    @VisibleForTesting
    static final Key<String> GRPC_PREVIOUS_RPC_ATTEMPTS = Key.m370of("grpc-previous-rpc-attempts", Metadata.ASCII_STRING_MARSHALLER);
    @VisibleForTesting
    static final Key<String> GRPC_RETRY_PUSHBACK_MS = Key.m370of("grpc-retry-pushback-ms", Metadata.ASCII_STRING_MARSHALLER);
    /* access modifiers changed from: private */
    ...
    private static final class State {
        ...
        State(@Nullable List<BufferEntry> list, Collection<Substream> collection, Collection<Substream> collection2, @Nullable Substream substream, boolean z, boolean z2, boolean z3, int i) {
            ...
            Preconditions.checkState(z4, "cancelled should imply committed");
        }

        /* access modifiers changed from: 0000 */
        @CheckReturnValue
        public State cancelled() {
            State state = new State(this.buffer, this.drainedSubstreams, this.activeHedges, this.winningSubstream, true, this.passThrough, this.hedgingFrozen, this.hedgingAttemptCount);
            return state;
        }
        ...
        public State substreamDrained(Substream substream) {
            ...
            State state = new State(list, collection, this.activeHedges, this.winningSubstream, this.cancelled, z2, this.hedgingFrozen, this.hedgingAttemptCount);
            return state;
        }
        ...
        public State substreamClosed(Substream substream) {
            ...
            State state = new State(this.buffer, Collections.unmodifiableCollection(arrayList), this.activeHedges, this.winningSubstream, this.cancelled, this.passThrough, this.hedgingFrozen, this.hedgingAttemptCount);
            return state;
        }
        ...
        public State committed(Substream substream) {
            ...
            State state = new State(list, collection, this.activeHedges, substream, this.cancelled, z, this.hedgingFrozen, this.hedgingAttemptCount);
            return state;
        }
        ...
        public State freezeHedging() {
            ...
            State state = new State(this.buffer, this.drainedSubstreams, this.activeHedges, this.winningSubstream, this.cancelled, this.passThrough, true, this.hedgingAttemptCount);
            return state;
        }
        ...
        public State addActiveHedge(Substream substream) {
            ...
            State state = new State(this.buffer, this.drainedSubstreams, collection, this.winningSubstream, this.cancelled, this.passThrough, this.hedgingFrozen, this.hedgingAttemptCount + 1);
            return state;
        }
        ...
        public State removeActiveHedge(Substream substream) {
            ...
            arrayList.remove(substream);
            State state = new State(this.buffer, this.drainedSubstreams, Collections.unmodifiableCollection(arrayList), this.winningSubstream, this.cancelled, this.passThrough, this.hedgingFrozen, this.hedgingAttemptCount);
            return state;
        }
    ...
    class BufferSizeTracer extends ClientStreamTracer {
        ...
        public void outboundWireSize(long r8) {
            /*
                r7 = this;
                io.grpc.internal.RetriableStream r0 = p006io.grpc.internal.RetriableStream.this
            ...
            L_0x000b:
                r0 = 0
                io.grpc.internal.RetriableStream r1 = p006io.grpc.internal.RetriableStream.this
                java.lang.Object r1 = r1.lock
                monitor-enter(r1)
                io.grpc.internal.RetriableStream r2 = p006io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0088 }
            ...
            L_0x0037:
                ...
                goto L_0x0071
            L_0x0049:
                io.grpc.internal.RetriableStream r8 = p006io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0088 }
                io.grpc.internal.RetriableStream$ChannelBufferMeter r8 = r8.channelBufferUsed     // Catch:{ all -> 0x0088 }
                long r2 = r7.bufferNeeded     // Catch:{ all -> 0x0088 }
                io.grpc.internal.RetriableStream r9 = p006io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0088 }
            ...
            L_0x0088:
                ...
                throw r8
            */
            throw new UnsupportedOperationException("Method not decompiled: p006io.grpc.internal.RetriableStream.BufferSizeTracer.outboundWireSize(long):void");
        }
    }
                ...
                public void run() {
                    ...
                    synchronized (RetriableStream.this.lock) {
                        ...
                        if (HedgingRunnable.this.scheduledHedgingRef.isCancelled()) {
                            ...
                            RetriableStream.this.state = RetriableStream.this.state.addActiveHedge(access$200);
    ...
    private final class Sublistener implements ClientStreamListener {
         ...
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void closed(p006io.grpc.Status r5, p006io.grpc.internal.ClientStreamListener.RpcProgress r6, p006io.grpc.Metadata r7) {
            /*
                r4 = this;
                io.grpc.internal.RetriableStream r0 = p006io.grpc.internal.RetriableStream.this
                java.lang.Object r0 = r0.lock
                monitor-enter(r0)
                io.grpc.internal.RetriableStream r1 = p006io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x01be }
                io.grpc.internal.RetriableStream r2 = p006io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x01be }
                ...
                io.grpc.internal.RetriableStream r6 = p006io.grpc.internal.RetriableStream.this
                io.grpc.internal.RetriableStream$Substream r0 = r4.substream
                r6.commitAndRun(r0)
                io.grpc.internal.RetriableStream r6 = p006io.grpc.internal.RetriableStream.this
            ...
            L_0x003c:
                ...
                io.grpc.internal.ClientStreamListener$RpcProgress r0 = p006io.grpc.internal.ClientStreamListener.RpcProgress.REFUSED
                r1 = 0
                r2 = 1
                ...
                io.grpc.internal.RetriableStream r5 = p006io.grpc.internal.RetriableStream.this
                ...
                monitor-enter(r6)
                io.grpc.internal.RetriableStream r7 = p006io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x00a8 }
                io.grpc.internal.RetriableStream r0 = p006io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x00a8 }
            ...
            L_0x00cf:
                ...
                return
            L_0x00de:
                io.grpc.internal.ClientStreamListener$RpcProgress r0 = p006io.grpc.internal.ClientStreamListener.RpcProgress.DROPPED
            ...
            L_0x00f0:
                ...
                r6.nextBackoffIntervalNanos = r0
            L_0x0119:
                ...
                monitor-enter(r0)
                io.grpc.internal.RetriableStream r5 = p006io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0150 }
                ...
                io.grpc.internal.RetriableStream r1 = p006io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0150 }
                java.lang.Object r1 = r1.lock     // Catch:{ all -> 0x0150 }
                r7.<init>(r1)     // Catch:{ all -> 0x0150 }
                r5.scheduledRetry = r7     // Catch:{ all -> 0x0150 }
            ...
            L_0x015c:
                ...
                java.lang.Object r6 = r6.lock
                monitor-enter(r6)
                io.grpc.internal.RetriableStream r0 = p006io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x019e }
                io.grpc.internal.RetriableStream r2 = p006io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x019e }
                ...
                r0.state = r2     // Catch:{ all -> 0x019e }
                if (r1 != 0) goto L_0x019c
                io.grpc.internal.RetriableStream r0 = p006io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x019e }
                io.grpc.internal.RetriableStream r1 = p006io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x019e }
            ...
            L_0x01be:
                ...
                throw r5
            */
            throw new UnsupportedOperationException("Method not decompiled: p006io.grpc.internal.RetriableStream.Sublistener.closed(io.grpc.Status, io.grpc.internal.ClientStreamListener$RpcProgress, io.grpc.Metadata):void");
        }

        /* JADX WARNING: Removed duplicated region for block: B:34:0x00ed  */
        /* JADX WARNING: Removed duplicated region for block: B:35:0x00ef  */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        private p006io.grpc.internal.RetriableStream.RetryPlan makeRetryDecision(p006io.grpc.Status r13, p006io.grpc.Metadata r14) {
            /*
                r12 = this;
                io.grpc.internal.RetriableStream r0 = p006io.grpc.internal.RetriableStream.this
                ...
                return r13
            L_0x0036:
                io.grpc.Metadata$Key<java.lang.String> r1 = p006io.grpc.internal.RetriableStream.GRPC_RETRY_PUSHBACK_MS
            ...
            L_0x004c:
                r14 = r1
            L_0x004d:
                io.grpc.internal.RetriableStream r2 = p006io.grpc.internal.RetriableStream.this
            ...
            L_0x0063:
                io.grpc.internal.RetriableStream r13 = p006io.grpc.internal.RetriableStream.this
            ...
            L_0x0070:
                ...
                double r2 = (double) r2
                java.util.Random r13 = p006io.grpc.internal.RetriableStream.random
                ...
                r13.nextBackoffIntervalNanos = r5
                goto L_0x00db
            L_0x00bf:
                int r13 = r14.intValue()
                if (r13 < 0) goto L_0x00de
            ...
            L_0x00f0:
                ...
                return r13
            */
            throw new UnsupportedOperationException("Method not decompiled: p006io.grpc.internal.RetriableStream.Sublistener.makeRetryDecision(io.grpc.Status, io.grpc.Metadata):io.grpc.internal.RetriableStream$RetryPlan");
        }
    ...
    RetriableStream(MethodDescriptor<ReqT, ?> methodDescriptor, Metadata metadata, ChannelBufferMeter channelBufferMeter, long j, long j2, Executor executor, ScheduledExecutorService scheduledExecutorService2, Provider provider, Provider provider2, @Nullable Throttle throttle2) {
        State state2 = new State(new ArrayList(8), Collections.emptyList(), null, null, false, false, false, 0);
        this.state = state2;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:29:0x0061, code lost:
        r3 = (p006io.grpc.internal.RetriableStream.BufferEntry) r1.next();
        r4 = r7.state;
     */
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void drain(p006io.grpc.internal.RetriableStream.Substream r8) {
        /*
            r7 = this;
            r0 = 0
            r1 = 0
        ...
        L_0x005b:
            ...
            io.grpc.internal.RetriableStream$BufferEntry r3 = (p006io.grpc.internal.RetriableStream.BufferEntry) r3
        ...
        L_0x008c:
            goto L_0x008b
        */
        throw new UnsupportedOperationException("Method not decompiled: p006io.grpc.internal.RetriableStream.drain(io.grpc.internal.RetriableStream$Substream):void");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:17:0x002c, code lost:
        r2.setFuture(r5.scheduledExecutorService.schedule(new p006io.grpc.internal.RetriableStream.HedgingRunnable(r5, r2), (long) r6.intValue(), java.util.concurrent.TimeUnit.MILLISECONDS));
     */
    ...
    public void pushbackHedging(@javax.annotation.Nullable java.lang.Integer r6) {
        ...
        L_0x0042:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: p006io.grpc.internal.RetriableStream.pushbackHedging(java.lang.Integer):void");
    }
