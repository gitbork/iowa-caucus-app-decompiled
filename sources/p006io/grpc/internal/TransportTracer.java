...
import p006io.grpc.InternalChannelz.TransportStats;
...
public final class TransportTracer {
    ...
    public TransportStats getStats() {
        ...
        TransportStats transportStats = new TransportStats(this.streamsStarted, this.lastLocalStreamCreatedTimeNanos, this.lastRemoteStreamCreatedTimeNanos, this.streamsSucceeded, this.streamsFailed, this.messagesSent, this.messagesReceived.value(), this.keepAlivesSent, this.lastMessageSentTimeNanos, this.lastMessageReceivedTimeNanos, j2, j);
