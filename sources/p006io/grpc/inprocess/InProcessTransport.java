...
import p006io.grpc.internal.ClientStream;
import p006io.grpc.internal.ClientStreamListener;
...
import p006io.grpc.internal.NoopClientStream;
import p006io.grpc.internal.ObjectPool;
import p006io.grpc.internal.ServerStream;
import p006io.grpc.internal.ServerStreamListener;
import p006io.grpc.internal.ServerTransport;
...
final class InProcessTransport implements ServerTransport, ConnectionClientTransport {
        ...
        private class InProcessClientStream implements ClientStream {
            ...
            public synchronized boolean serverRequested(int r5) {
                ...
                L_0x0015:
                    ...
                    io.grpc.internal.StreamListener$MessageProducer r3 = (p006io.grpc.internal.StreamListener.MessageProducer) r3     // Catch:{ all -> 0x0055 }
                ...
                L_0x0059:
                    goto L_0x0058
                */
                throw new UnsupportedOperationException("Method not decompiled: p006io.grpc.inprocess.InProcessTransport.InProcessStream.InProcessClientStream.serverRequested(int):boolean");
            }
            ...
            public synchronized void writeMessage(java.io.InputStream r9) {
                ...
                L_0x0007:
                    ...
                    io.grpc.inprocess.InProcessTransport$InProcessStream r0 = p006io.grpc.inprocess.InProcessTransport.InProcessStream.this     // Catch:{ all -> 0x005a }
                ...
                L_0x005a:
                    ...
                    throw r9
                */
                throw new UnsupportedOperationException("Method not decompiled: p006io.grpc.inprocess.InProcessTransport.InProcessStream.InProcessClientStream.writeMessage(java.io.InputStream):void");
            }
            ...
            public synchronized boolean isReady() {
                ...
                L_0x000f:
                    ...
                    throw r0
                */
                throw new UnsupportedOperationException("Method not decompiled: p006io.grpc.inprocess.InProcessTransport.InProcessStream.InProcessClientStream.isReady():boolean");
            }
            ...
            public synchronized void halfClose() {
                ...
                L_0x001a:
                    ...
                    throw r0
                */
                throw new UnsupportedOperationException("Method not decompiled: p006io.grpc.inprocess.InProcessTransport.InProcessStream.InProcessClientStream.halfClose():void");
            }
        ...
        private class InProcessServerStream implements ServerStream {
            ...
            public synchronized boolean clientRequested(int r6) {
                ...
                L_0x0015:
                    ...
                    io.grpc.internal.StreamListener$MessageProducer r3 = (p006io.grpc.internal.StreamListener.MessageProducer) r3     // Catch:{ all -> 0x0079 }
                ...
                L_0x003a:
                    ...
                    io.grpc.inprocess.InProcessTransport$InProcessStream r6 = p006io.grpc.inprocess.InProcessTransport.InProcessStream.this     // Catch:{ all -> 0x0079 }
                ...
                L_0x007d:
                    goto L_0x007c
                */
                throw new UnsupportedOperationException("Method not decompiled: p006io.grpc.inprocess.InProcessTransport.InProcessStream.InProcessServerStream.clientRequested(int):boolean");
            }
            ...
            public synchronized void writeMessage(java.io.InputStream r9) {
                ...
                L_0x005a:
                    ...
                    throw r9
                */
                throw new UnsupportedOperationException("Method not decompiled: p006io.grpc.inprocess.InProcessTransport.InProcessStream.InProcessServerStream.writeMessage(java.io.InputStream):void");
            }
            ...
            public synchronized boolean isReady() {
                ...
                L_0x000f:
                    ...
                    throw r0
                */
                throw new UnsupportedOperationException("Method not decompiled: p006io.grpc.inprocess.InProcessTransport.InProcessStream.InProcessServerStream.isReady():boolean");
            }

            public void writeHeaders(Metadata metadata) {
                if (InProcessTransport.this.clientMaxInboundMetadataSize != Integer.MAX_VALUE) {
                    int access$1600 = InProcessTransport.metadataSize(metadata);
            ...
            public void close(Status status, Metadata metadata) {
                InProcessStream.this.clientStream.serverClosed(Status.f146OK, status);
                if (InProcessTransport.this.clientMaxInboundMetadataSize != Integer.MAX_VALUE) {
            ...
            /* JADX WARNING: Code restructure failed: missing block: B:12:0x0037, code lost:
                p006io.grpc.inprocess.InProcessTransport.InProcessStream.access$1900(r1.this$1);
             */
            /* JADX WARNING: Code restructure failed: missing block: B:13:0x003c, code lost:
                return;
             */
            /* Code decompiled incorrectly, please refer to instructions dump. */
            private void notifyClientClose(p006io.grpc.Status r2, p006io.grpc.Metadata r3) {
                /*
                    r1 = this;
                    io.grpc.Status r2 = p006io.grpc.inprocess.InProcessTransport.stripCause(r2)
                    monitor-enter(r1)
                ...
                L_0x000b:
                    ...
                    io.grpc.inprocess.InProcessTransport$InProcessStream r0 = p006io.grpc.inprocess.InProcessTransport.InProcessStream.this     // Catch:{ all -> 0x003d }
                ...
                L_0x0036:
                    monitor-exit(r1)     // Catch:{ all -> 0x003d }
                    io.grpc.inprocess.InProcessTransport$InProcessStream r2 = p006io.grpc.inprocess.InProcessTransport.InProcessStream.this
                    r2.streamClosed()
                    return
                L_0x003d:
                    r2 = move-exception
                    ...
                    throw r2
                */
                throw new UnsupportedOperationException("Method not decompiled: p006io.grpc.inprocess.InProcessTransport.InProcessStream.InProcessServerStream.notifyClientClose(io.grpc.Status, io.grpc.Metadata):void");
            }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized void shutdown(p006io.grpc.Status r2) {
        /*
            r1 = this;
            monitor-enter(r1)
        ...
        L_0x0019:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: p006io.grpc.inprocess.InProcessTransport.shutdown(io.grpc.Status):void");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x0021, code lost:
        p006io.grpc.inprocess.InProcessTransport.InProcessStream.access$700((p006io.grpc.inprocess.InProcessTransport.InProcessStream) r0.next()).cancel(r3);
     */
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void shutdownNow(p006io.grpc.Status r3) {
        /*
            r2 = this;
        ...
        L_0x001b:
            ...
            io.grpc.inprocess.InProcessTransport$InProcessStream r1 = (p006io.grpc.inprocess.InProcessTransport.InProcessStream) r1
        ...
        L_0x0034:
            goto L_0x0033
        */
        throw new UnsupportedOperationException("Method not decompiled: p006io.grpc.inprocess.InProcessTransport.shutdownNow(io.grpc.Status):void");
    }

    public String toString() {
        return MoreObjects.toStringHelper((Object) this).add("logId", this.logId.getId()).add(ConditionalUserProperty.NAME, (Object) this.name).toString();
    }
    ...
    public synchronized void notifyTerminated() {
        ...
        L_0x002a:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p006io.grpc.inprocess.InProcessTransport.notifyTerminated():void");
    }
