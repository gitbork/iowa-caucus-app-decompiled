...
public final class HttpConnectProxiedSocketAddress extends ProxiedSocketAddress {
    ...
    public static final class Builder {
        ...
        public HttpConnectProxiedSocketAddress build() {
            HttpConnectProxiedSocketAddress httpConnectProxiedSocketAddress = new HttpConnectProxiedSocketAddress(this.proxyAddress, this.targetAddress, this.username, this.password);
