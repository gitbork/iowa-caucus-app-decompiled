...
public abstract class NameResolver {
    ...
    public static abstract class Factory {
        ...
        @Deprecated
        private static final Key<ServiceConfigParser> PARAMS_PARSER = Key.create("params-parser");
        @ExperimentalApi("https://github.com/grpc/grpc-java/issues/5113")
        @Deprecated
        public static final Key<ProxyDetector> PARAMS_PROXY_DETECTOR = Key.create("params-proxy-detector");
        @Deprecated
        private static final Key<SynchronizationContext> PARAMS_SYNC_CONTEXT = Key.create("params-sync-context");
