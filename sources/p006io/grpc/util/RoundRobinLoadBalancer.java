...
import p006io.grpc.internal.ServiceConfigUtil;

/* renamed from: io.grpc.util.RoundRobinLoadBalancer */
final class RoundRobinLoadBalancer extends LoadBalancer {
    private static final Status EMPTY_OK = Status.f146OK.withDescription("no subchannels ready");
    @VisibleForTesting
    ...
    @VisibleForTesting
    /* renamed from: io.grpc.util.RoundRobinLoadBalancer$StickinessState */
    static final class StickinessState {
        ...
        StickinessState(@Nonnull String str) {
            this.key = Metadata.Key.m370of(str, Metadata.ASCII_STRING_MARSHALLER);
        }
    ...
    static final class ReadyPicker extends RoundRobinPicker {
        ...
        public p006io.grpc.LoadBalancer.PickResult pickSubchannel(p006io.grpc.LoadBalancer.PickSubchannelArgs r3) {
            /*
                r2 = this;
                ...
                boolean r1 = p006io.grpc.util.RoundRobinLoadBalancer.isReady(r0)
            ...
            L_0x0035:
                io.grpc.LoadBalancer$PickResult r3 = p006io.grpc.LoadBalancer.PickResult.withSubchannel(r0)
                return r3
            */
            throw new UnsupportedOperationException("Method not decompiled: p006io.grpc.util.RoundRobinLoadBalancer.ReadyPicker.pickSubchannel(io.grpc.LoadBalancer$PickSubchannelArgs):io.grpc.LoadBalancer$PickResult");
        }
    ...
    public void handleResolvedAddresses(ResolvedAddresses resolvedAddresses) {
        ...
        Set stripAttrs = stripAttrs(addresses);
        ...
        while (it.hasNext()) {
            shutdownSubchannel((Subchannel) it.next());
        }
    }
    ...
    /* access modifiers changed from: 0000 */
    public Map<String, Ref<Subchannel>> getStickinessMapForTest() {
        StickinessState stickinessState2 = this.stickinessState;
        if (stickinessState2 == null) {
            return null;
        }
