...
public final class Metadata {
    ...
    public static abstract class Key<T> {
        ...
        /* renamed from: of */
        public static <T> Key<T> m371of(String str, BinaryMarshaller<T> binaryMarshaller) {
            return new BinaryKey(str, binaryMarshaller);
        }

        /* renamed from: of */
        public static <T> Key<T> m370of(String str, AsciiMarshaller<T> asciiMarshaller) {
            return m372of(str, false, asciiMarshaller);
        }

        /* renamed from: of */
        static <T> Key<T> m372of(String str, boolean z, AsciiMarshaller<T> asciiMarshaller) {
            return new AsciiKey(str, z, asciiMarshaller);
        }

        /* renamed from: of */
        static <T> Key<T> m373of(String str, boolean z, TrustedAsciiMarshaller<T> trustedAsciiMarshaller) {
