...
public final class RpcViews {
    ...
    static void registerClientGrpcViews(ViewManager viewManager) {
        UnmodifiableIterator it = GRPC_CLIENT_VIEWS_SET.iterator();
        while (it.hasNext()) {
    ...
    static void registerServerGrpcViews(ViewManager viewManager) {
        UnmodifiableIterator it = GRPC_SERVER_VIEWS_SET.iterator();
        while (it.hasNext()) {
            viewManager.registerView((View) it.next());
        }
    }
    ...
    static void registerClientGrpcBasicViews(ViewManager viewManager) {
        UnmodifiableIterator it = GRPC_CLIENT_BASIC_VIEWS_SET.iterator();
        while (it.hasNext()) {
            viewManager.registerView((View) it.next());
        }
    }
    ...
    static void registerServerGrpcBasicViews(ViewManager viewManager) {
        UnmodifiableIterator it = GRPC_SERVER_BASIC_VIEWS_SET.iterator();
        while (it.hasNext()) {
            viewManager.registerView((View) it.next());
        }
    }
    ...
    static void registerRealTimeMetricsViews(ViewManager viewManager) {
        UnmodifiableIterator it = GRPC_REAL_TIME_METRICS_VIEWS_SET.iterator();
        while (it.hasNext()) {
            viewManager.registerView((View) it.next());
        }
    }
