...
final class AutoValue_MetricOptions extends MetricOptions {
    ...
    static final class Builder extends p006io.opencensus.metrics.MetricOptions.Builder {
        ...
        public p006io.opencensus.metrics.MetricOptions.Builder setDescription(String str) {
            if (str != null) {
        ...
        public p006io.opencensus.metrics.MetricOptions.Builder setUnit(String str) {
            if (str != null) {
                this.unit = str;
                return this;
            }
        ...
        public p006io.opencensus.metrics.MetricOptions.Builder setLabelKeys(List<LabelKey> list) {
            if (list != null) {
                this.labelKeys = list;
                return this;
            }
        ...
        public p006io.opencensus.metrics.MetricOptions.Builder setConstantLabels(Map<LabelKey, LabelValue> map) {
            if (map != null) {
