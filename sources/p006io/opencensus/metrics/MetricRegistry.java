...
public abstract class MetricRegistry {
    ...
    private static final class NoopMetricRegistry extends MetricRegistry {
        ...
        public LongGauge addLongGauge(String str, MetricOptions metricOptions) {
            return LongGauge.newNoopLongGauge((String) Utils.checkNotNull(str, ConditionalUserProperty.NAME), metricOptions.getDescription(), metricOptions.getUnit(), metricOptions.getLabelKeys());
        }

        public DoubleGauge addDoubleGauge(String str, MetricOptions metricOptions) {
            return DoubleGauge.newNoopDoubleGauge((String) Utils.checkNotNull(str, ConditionalUserProperty.NAME), metricOptions.getDescription(), metricOptions.getUnit(), metricOptions.getLabelKeys());
        }

        public DerivedLongGauge addDerivedLongGauge(String str, MetricOptions metricOptions) {
            return DerivedLongGauge.newNoopDerivedLongGauge((String) Utils.checkNotNull(str, ConditionalUserProperty.NAME), metricOptions.getDescription(), metricOptions.getUnit(), metricOptions.getLabelKeys());
        }

        public DerivedDoubleGauge addDerivedDoubleGauge(String str, MetricOptions metricOptions) {
            return DerivedDoubleGauge.newNoopDerivedDoubleGauge((String) Utils.checkNotNull(str, ConditionalUserProperty.NAME), metricOptions.getDescription(), metricOptions.getUnit(), metricOptions.getLabelKeys());
        }

        public LongCumulative addLongCumulative(String str, MetricOptions metricOptions) {
            return LongCumulative.newNoopLongCumulative((String) Utils.checkNotNull(str, ConditionalUserProperty.NAME), metricOptions.getDescription(), metricOptions.getUnit(), metricOptions.getLabelKeys());
        }

        public DoubleCumulative addDoubleCumulative(String str, MetricOptions metricOptions) {
            return DoubleCumulative.newNoopDoubleCumulative((String) Utils.checkNotNull(str, ConditionalUserProperty.NAME), metricOptions.getDescription(), metricOptions.getUnit(), metricOptions.getLabelKeys());
        }

        public DerivedLongCumulative addDerivedLongCumulative(String str, MetricOptions metricOptions) {
            return DerivedLongCumulative.newNoopDerivedLongCumulative((String) Utils.checkNotNull(str, ConditionalUserProperty.NAME), metricOptions.getDescription(), metricOptions.getUnit(), metricOptions.getLabelKeys());
        }

        public DerivedDoubleCumulative addDerivedDoubleCumulative(String str, MetricOptions metricOptions) {
            return DerivedDoubleCumulative.newNoopDerivedDoubleCumulative((String) Utils.checkNotNull(str, ConditionalUserProperty.NAME), metricOptions.getDescription(), metricOptions.getUnit(), metricOptions.getLabelKeys());
        }
    }
