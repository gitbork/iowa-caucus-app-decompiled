...
public final class TraceId implements Comparable<TraceId> {
    ...
    public static TraceId fromBytes(byte[] bArr) {
        ...
        Utils.checkArgument(bArr.length == 16, "Invalid size: expected %s, got %s", Integer.valueOf(16), Integer.valueOf(bArr.length));
    ...
    public static TraceId fromLowerBase16(CharSequence charSequence) {
        ...
        Utils.checkArgument(charSequence.length() == 32, "Invalid size: expected %s, got %s", Integer.valueOf(32), Integer.valueOf(charSequence.length()));
