...
@Immutable
/* renamed from: io.opencensus.trace.Status */
public final class Status {
    ...
    /* renamed from: OK */
    public static final Status f474OK = CanonicalCode.OK.toStatus();
    ...
    /* renamed from: io.opencensus.trace.Status$CanonicalCode */
    ...
    private static List<Status> buildStatusList() {
        ...
        while (i < length) {
            ...
            Status status = (Status) treeMap.put(Integer.valueOf(canonicalCode2.value()), new Status(canonicalCode2, null));
            if (status == null) {
                i++;
            } else {
                StringBuilder sb = new StringBuilder();
                sb.append("Code value duplication between ");
                sb.append(status.getCanonicalCode().name());
                sb.append(" & ");
                sb.append(canonicalCode2.name());
