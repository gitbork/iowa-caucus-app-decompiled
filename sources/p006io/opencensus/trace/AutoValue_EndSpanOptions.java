...
/* renamed from: io.opencensus.trace.AutoValue_EndSpanOptions */
final class AutoValue_EndSpanOptions extends EndSpanOptions {
    private final boolean sampleToLocalSpanStore;
    private final Status status;

    /* renamed from: io.opencensus.trace.AutoValue_EndSpanOptions$Builder */
    static final class Builder extends p006io.opencensus.trace.EndSpanOptions.Builder {
        ...
        public p006io.opencensus.trace.EndSpanOptions.Builder setSampleToLocalSpanStore(boolean z) {
            this.sampleToLocalSpanStore = Boolean.valueOf(z);
            return this;
        }

        public p006io.opencensus.trace.EndSpanOptions.Builder setStatus(@Nullable Status status2) {
            this.status = status2;
            return this;
        }
