package p006io.opencensus.trace.config;

import p006io.opencensus.trace.Sampler;

/* renamed from: io.opencensus.trace.config.AutoValue_TraceParams */
final class AutoValue_TraceParams extends TraceParams {
    ...
    /* renamed from: io.opencensus.trace.config.AutoValue_TraceParams$Builder */
    static final class Builder extends p006io.opencensus.trace.config.TraceParams.Builder {
        ...
        public p006io.opencensus.trace.config.TraceParams.Builder setSampler(Sampler sampler2) {
            if (sampler2 != null) {
        ...
        public p006io.opencensus.trace.config.TraceParams.Builder setMaxNumberOfAttributes(int i) {
            this.maxNumberOfAttributes = Integer.valueOf(i);
            return this;
        }

        public p006io.opencensus.trace.config.TraceParams.Builder setMaxNumberOfAnnotations(int i) {
            this.maxNumberOfAnnotations = Integer.valueOf(i);
            return this;
        }

        public p006io.opencensus.trace.config.TraceParams.Builder setMaxNumberOfMessageEvents(int i) {
            this.maxNumberOfMessageEvents = Integer.valueOf(i);
            return this;
        }

        public p006io.opencensus.trace.config.TraceParams.Builder setMaxNumberOfLinks(int i) {
    ...
    public p006io.opencensus.trace.config.TraceParams.Builder toBuilder() {
