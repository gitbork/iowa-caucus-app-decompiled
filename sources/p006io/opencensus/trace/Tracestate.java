...
@Immutable
/* renamed from: io.opencensus.trace.Tracestate */
public abstract class Tracestate {
    ...
    /* renamed from: io.opencensus.trace.Tracestate$Builder */
    public static final class Builder {
        ...
        public Builder set(String str, String str2) {
            ...
            while (true) {
                if (i >= this.entries.size()) {
                    break;
                } else if (((Entry) this.entries.get(i)).getKey().equals(create.getKey())) {
        ...
        public Builder remove(String str) {
            ...
            while (true) {
                if (i >= this.entries.size()) {
                    break;
                } else if (((Entry) this.entries.get(i)).getKey().equals(str)) {
                    this.entries.remove(i);
                    break;
                } else {
                    i++;
    ...
    @Immutable
    /* renamed from: io.opencensus.trace.Tracestate$Entry */
