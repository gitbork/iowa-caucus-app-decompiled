...
import p006io.invertase.firebase.common.ReactNativeFirebaseJSON;
import p006io.invertase.firebase.common.ReactNativeFirebaseMeta;
import p006io.invertase.firebase.common.ReactNativeFirebaseModule;
import p006io.invertase.firebase.common.ReactNativeFirebasePreferences;
...
public class ReactNativeFirebaseAppModule extends ReactNativeFirebaseModule {
    ...
    public void setAutomaticDataCollectionEnabled(String str, Boolean bool) {
        FirebaseApp.getInstance(str).setDataCollectionDefaultEnabled(bool.booleanValue());
    }
