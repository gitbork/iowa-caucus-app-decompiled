...
/* renamed from: io.invertase.firebase.storage.ReactNativeFirebaseStorageModule */
public class ReactNativeFirebaseStorageModule extends ReactNativeFirebaseModule {
    ...
    public void getMetadata(String str, String str2, Promise promise) {
        getReferenceFromUrl(str2, str).getMetadata().addOnCompleteListener((Executor) getExecutor(), (OnCompleteListener<TResult>) new OnCompleteListener() {
            public final void onComplete(Task task) {
    ...
    public void list(String str, String str2, ReadableMap readableMap, Promise promise) {
        ...
        task.addOnCompleteListener((Executor) getExecutor(), (OnCompleteListener<TResult>) new OnCompleteListener() {
            public final void onComplete(Task task) {
    ...
    public void listAll(String str, String str2, Promise promise) {
        getReferenceFromUrl(str2, str).listAll().addOnCompleteListener((Executor) getExecutor(), (OnCompleteListener<TResult>) new OnCompleteListener() {
            public final void onComplete(Task task) {
    ...
    public void updateMetadata(String str, String str2, ReadableMap readableMap, Promise promise) {
        getReferenceFromUrl(str2, str).updateMetadata(ReactNativeFirebaseStorageCommon.buildMetadataFromMap(readableMap, null)).addOnCompleteListener((Executor) getExecutor(), (OnCompleteListener<TResult>) new OnCompleteListener() {
            public final void onComplete(Task task) {
