package p006io.sentry.android.event.helper;
...
/* renamed from: io.sentry.android.event.helper.AndroidEventBuilderHelper */
public class AndroidEventBuilderHelper implements EventBuilderHelper {
    ...
    public void helpBuildingEvent(EventBuilder eventBuilder) {
        ...
        if (packageInfo != null) {
            if (eventBuilder.getEvent().getRelease() == null) {
                ...
                eventBuilder.withRelease(sb.toString());
            }
        ...
        if (string != null && !string.trim().equals("")) {
            ...
            sb2.append("android:");
            sb2.append(string);
            eventBuilder.withSentryInterface(new UserInterface(sb2.toString(), null, null, null), false);
        }
        ...
        if (proGuardUuids != null && proGuardUuids.length > 0) {
            ...
            for (String debugImage : proGuardUuids) {
                debugMetaInterface.addDebugImage(new DebugImage(debugImage));
            }
    ...
    public Map<String, Map<String, Object>> getContexts() {
        ...
        hashMap3.put(ConditionalUserProperty.NAME, "Android");
    ...
    protected static Boolean isEmulator() {
        ...
        String str2 = "generic";
        try {
            if (!Build.FINGERPRINT.startsWith(str2) && !Build.FINGERPRINT.startsWith(EnvironmentCompat.MEDIA_UNKNOWN) && !Build.MODEL.contains(str) && !Build.MODEL.contains("Emulator") && !Build.MODEL.contains("Android SDK built for x86") && !Build.MANUFACTURER.contains("Genymotion") && (!Build.BRAND.startsWith(str2) || !Build.DEVICE.startsWith(str2))) {
    ...
    protected static MemoryInfo getMemInfo(Context context) {
        try {
    ...
    protected static java.lang.String getKernelVersion() {
        ...
        L_0x0058:
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p006io.sentry.android.event.helper.AndroidEventBuilderHelper.getKernelVersion():java.lang.String");
    }

    protected static Boolean isRooted() {
        String str = Build.TAGS;
        Boolean valueOf = Boolean.valueOf(true);
        if (str != null && Build.TAGS.contains("test-keys")) {
            return valueOf;
        }
