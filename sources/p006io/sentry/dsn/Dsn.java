...
/* renamed from: io.sentry.dsn.Dsn */
public class Dsn {
    ...
    public Dsn(URI uri2) throws InvalidDsnException {
        if (uri2 != null) {
            ...
            validate();
            try {
                URI uri3 = new URI(this.protocol, null, this.host, this.port, this.path, null, null);
                this.uri = uri3;
                ...
                sb.append(uri2);
                sb.append("'");
                throw new InvalidDsnException(sb.toString(), e);
            }
        } else {
        ...
        if (query != null && !query.isEmpty()) {
            ...
            while (i < length) {
                ...
                try {
                    ...
                    this.options.put(URLDecoder.decode(split2[0], str), split2.length > 1 ? URLDecoder.decode(split2[1], str) : null);
                    i++;
    ...
    private void validate() {
        ...
        if (!linkedList.isEmpty()) {
            ...
            sb.append("'");
            throw new InvalidDsnException(sb.toString());
        }
    }
