...
/* renamed from: io.sentry.connection.BufferedConnection */
public class BufferedConnection implements Connection {
    /* access modifiers changed from: private */
    public static final Logger logger = LoggerFactory.getLogger(BufferedConnection.class);
    ...
    /* renamed from: io.sentry.connection.BufferedConnection$Flusher */
            ...
            try {
                ...
                while (events.hasNext() && !BufferedConnection.this.closed) {
                    ...
                    try {
                        ...
                        access$3002.trace(sb2.toString());
    ...
    /* renamed from: io.sentry.connection.BufferedConnection$ShutDownHook */
    ...
    public void close() throws java.io.IOException {
        /*
            ...
            p006io.sentry.util.Util.safelyRemoveShutdownHook(r1)
            io.sentry.connection.BufferedConnection$ShutDownHook r1 = r6.shutDownHook
            r2 = 0
            r1.enabled = r2
        L_0x0011:
        ...
        L_0x003d:
            ...
            r2.warn(r0, r1)     // Catch:{ InterruptedException -> 0x0072 }
        L_0x0063:
            org.slf4j.Logger r1 = logger     // Catch:{ InterruptedException -> 0x0072 }
        ...
        L_0x0072:
            ...
            r2.warn(r0, r1)     // Catch:{ all -> 0x0070 }
            goto L_0x006a
        L_0x0094:
            return
        L_0x0095:
        ...
        L_0x009c:
            goto L_0x009b
        */
        throw new UnsupportedOperationException("Method not decompiled: p006io.sentry.connection.BufferedConnection.close():void");
    }
