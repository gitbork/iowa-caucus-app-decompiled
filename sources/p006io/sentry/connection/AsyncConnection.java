...
/* renamed from: io.sentry.connection.AsyncConnection */
public class AsyncConnection implements Connection {
    private static final Logger lockdownLogger;
    /* access modifiers changed from: private */
    public static final Logger logger = LoggerFactory.getLogger(AsyncConnection.class);
    /* access modifiers changed from: private */
    ...
    /* renamed from: io.sentry.connection.AsyncConnection$EventSubmitter */
    private final class EventSubmitter implements Runnable {
        ...
        public void run() {
            /*
                r4 = this;
                p006io.sentry.environment.SentryEnvironment.startManagingThread()
            ...
            L_0x0012:
                io.sentry.connection.AsyncConnection r1 = p006io.sentry.connection.AsyncConnection.this     // Catch:{ LockedDownException | TooManyRequestsException -> 0x0039, Exception -> 0x002c }
            ...
            L_0x0026:
                p006io.sentry.environment.SentryEnvironment.stopManagingThread()
                goto L_0x0056
            L_0x002a:
                r1 = move-exception
                goto L_0x0057
            L_0x002c:
                r1 = move-exception
                org.slf4j.Logger r2 = p006io.sentry.connection.AsyncConnection.logger     // Catch:{ all -> 0x002a }
                java.lang.String r3 = "An exception occurred while sending the event to Sentry."
                r2.error(r3, r1)     // Catch:{ all -> 0x002a }
                if (r0 != 0) goto L_0x0023
                goto L_0x001f
            L_0x0039:
                org.slf4j.Logger r1 = p006io.sentry.connection.AsyncConnection.logger     // Catch:{ all -> 0x002a }
            ...
            L_0x0065:
                goto L_0x0064
            */
            throw new UnsupportedOperationException("Method not decompiled: p006io.sentry.connection.AsyncConnection.EventSubmitter.run():void");
        }
    }

    /* renamed from: io.sentry.connection.AsyncConnection$ShutDownHook */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:?, code lost:
        ...
        logger.warn(r0, (java.lang.Object) java.lang.Integer.valueOf(r6.executorService.shutdownNow().size()));
     */
    ...
    public void doClose() throws java.io.IOException {
        ...
        L_0x002e:
            ...
            r2.warn(r0, r1)     // Catch:{ InterruptedException -> 0x0063 }
        L_0x0054:
            org.slf4j.Logger r1 = logger     // Catch:{ InterruptedException -> 0x0063 }
        ...
        L_0x0063:
            ...
            r2.warn(r0, r1)     // Catch:{ all -> 0x0061 }
            goto L_0x005b
        L_0x0085:
            return
        L_0x0086:
        ...
        L_0x008d:
            goto L_0x008c
        */
        throw new UnsupportedOperationException("Method not decompiled: p006io.sentry.connection.AsyncConnection.doClose():void");
    }
}
