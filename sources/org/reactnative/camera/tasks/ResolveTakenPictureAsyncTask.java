...
public class ResolveTakenPictureAsyncTask extends AsyncTask<Void, Void, WritableMap> {
    ...
    static /* synthetic */ class C24541 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.reactnative.camera.tasks.ResolveTakenPictureAsyncTask.C24541.<clinit>():void");
        }
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:134:0x027a A[SYNTHETIC, Splitter:B:134:0x027a] */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:29:0x00a6 A[Catch:{ NotFoundException -> 0x0243, IOException -> 0x0240, all -> 0x023d }] */
    ...
    public com.facebook.react.bridge.WritableMap doInBackground(java.lang.Void... r17) {
        ...
        L_0x002c:
            ...
            r2.<init>(r9)     // Catch:{ NotFoundException -> 0x0243, IOException -> 0x0240, all -> 0x023d }
        ...
        L_0x00b1:
            ...
            int[] r14 = org.reactnative.camera.tasks.ResolveTakenPictureAsyncTask.C24541.$SwitchMap$com$facebook$react$bridge$ReadableType     // Catch:{ NotFoundException -> 0x0243, IOException -> 0x0240, all -> 0x023d }
        ...
        L_0x01f2:
            ...
            r5.<init>(r4)     // Catch:{ NotFoundException -> 0x0243, IOException -> 0x0240, all -> 0x023d }
        ...
        L_0x024c:
            ...
            r2.reject(r3, r4, r0)     // Catch:{ all -> 0x0275 }
    ...
    /* JADX WARNING: type inference failed for: r2v0, types: [java.io.FileOutputStream] */
    /* JADX WARNING: type inference failed for: r0v4, types: [java.io.IOException] */
    /* JADX WARNING: type inference failed for: r0v5 */
    /* JADX WARNING: type inference failed for: r4v4, types: [java.io.IOException] */
    /* JADX WARNING: type inference failed for: r2v1 */
    /* JADX WARNING: type inference failed for: r0v6 */
    /* JADX WARNING: type inference failed for: r4v7, types: [java.io.IOException] */
    /* JADX WARNING: type inference failed for: r2v3 */
    /* JADX WARNING: type inference failed for: r2v4, types: [java.io.OutputStream, java.io.FileOutputStream] */
    /* JADX WARNING: type inference failed for: r4v8, types: [java.io.IOException] */
     ...
     */
    /* JADX WARNING: Failed to process nested try/catch */
    /* JADX WARNING: Multi-variable type inference failed. Error: jadx.core.utils.exceptions.JadxRuntimeException: No candidate types for var: r0v4, types: [java.io.IOException]
      assigns: [?[OBJECT, ARRAY], ?[int, float, boolean, short, byte, char, OBJECT, ARRAY]]
      uses: [java.io.IOException, ?[int, boolean, OBJECT, ARRAY, byte, short, char], java.lang.Throwable, java.io.FileOutputStream]
      mth insns count: 40
