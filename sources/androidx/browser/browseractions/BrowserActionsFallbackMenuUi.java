...
class BrowserActionsFallbackMenuUi implements OnItemClickListener {
    ...
    public void displayMenu() {
        final View inflate = LayoutInflater.from(this.mContext).inflate(C0127R.layout.browser_actions_context_menu_page, null);
    ...
    private BrowserActionsFallbackMenuView initMenuView(View view) {
        BrowserActionsFallbackMenuView browserActionsFallbackMenuView = (BrowserActionsFallbackMenuView) view.findViewById(C0127R.C0129id.browser_actions_menu_view);
        final TextView textView = (TextView) view.findViewById(C0127R.C0129id.browser_actions_header_text);
        ...
        ListView listView = (ListView) view.findViewById(C0127R.C0129id.browser_actions_menu_items);
