    ...
    public boolean executeKeyEvent(@NonNull KeyEvent keyEvent) {
        ...
        if (!canScroll) {
            if (isFocused() && keyEvent.getKeyCode() != 4) {
                ...
                View findNextFocus = FocusFinder.getInstance().findNextFocus(this, findFocus, NikonType2MakernoteDirectory.TAG_ADAPTER);
                if (!(findNextFocus == null || findNextFocus == this || !findNextFocus.requestFocus(NikonType2MakernoteDirectory.TAG_ADAPTER))) {
                    z = true;
                }
            }
            return z;
