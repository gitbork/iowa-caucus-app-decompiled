...
class NotificationCompatJellybean {
    ...
    private static RemoteInput fromBundle(Bundle bundle) {
        ...
        RemoteInput remoteInput = new RemoteInput(bundle.getString(KEY_RESULT_KEY), bundle.getCharSequence(KEY_LABEL), bundle.getCharSequenceArray(KEY_CHOICES), bundle.getBoolean(KEY_ALLOW_FREE_FORM_INPUT), 0, bundle.getBundle(KEY_EXTRAS), hashSet);
        return remoteInput;
    }
