...
class RCTCameraViewFinder extends TextureView implements SurfaceTextureListener, PreviewCallback {
        ...
        public Void doInBackground(Void... voidArr) {
            ...
            try {
                ...
                if (barcodeAnyOrientation != null) {
                    ...
                    ((RCTDeviceEventEmitter) reactContextSingleton.getJSModule(RCTDeviceEventEmitter.class)).emit("CameraBarCodeReadAndroid", createMap);
                    RCTCameraViewFinder.this._multiFormatReader.reset();
    ...
    public RCTCameraViewFinder(Context context, int i) {
        ...
        this._cameraType = i;
        initBarcodeReader(C1827RCTCamera.getInstance().getBarCodeTypes());
    }
    ...
    public double getRatio() {
        return (double) (((float) C1827RCTCamera.getInstance().getPreviewWidth(this._cameraType)) / ((float) C1827RCTCamera.getInstance().getPreviewHeight(this._cameraType)));
    }
    ...
    public void setCaptureMode(int i) {
        C1827RCTCamera.getInstance().setCaptureMode(this._cameraType, i);
        this._captureMode = i;
    }

    public void setCaptureQuality(String str) {
        C1827RCTCamera.getInstance().setCaptureQuality(this._cameraType, str);
    }

    public void setTorchMode(int i) {
        C1827RCTCamera.getInstance().setTorchMode(this._cameraType, i);
    }

    public void setFlashMode(int i) {
        C1827RCTCamera.getInstance().setFlashMode(this._cameraType, i);
    }
    ...
    public void setZoom(int i) {
        C1827RCTCamera.getInstance().setZoom(this._cameraType, i);
    }
    ...
    private synchronized void startCamera() {
        ...
        if (!this._isStarting) {
            ...
            try {
                this._camera = C1827RCTCamera.getInstance().acquireCameraInstance(this._cameraType);
                ...
                if (!z2) {
                    if (!z) {
                        ...
                        sb.append("Unsupported capture mode:");
                        sb.append(this._captureMode);
                ...
                if (z2) {
                    ...
                    list = C1827RCTCamera.getInstance().getSupportedVideoSizes(this._camera);
                } else {
                    StringBuilder sb2 = new StringBuilder();
                    sb2.append("Unsupported capture mode:");
                    sb2.append(this._captureMode);
                    throw new RuntimeException(sb2.toString());
                }
                Size bestSize = C1827RCTCamera.getInstance().getBestSize(list, Integer.MAX_VALUE, Integer.MAX_VALUE);
        ...
        if (!this._isStopping) {
            ...
            try {
                if (this._camera != null) {
                    ...
                    C1827RCTCamera.getInstance().releaseCameraInstance(this._cameraType);
                    this._camera = null;
                }
            } catch (Exception e) {
                try {
    ...
    private BarcodeFormat parseBarCodeString(String str) {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("Unsupported code.. [");
        sb.append(str);
        sb.append("]");
        Log.v("RCTCamera", sb.toString());
        return null;
    }
    ...
    public void onPreviewFrame(byte[] bArr, Camera camera) {
        if (C1827RCTCamera.getInstance().isBarcodeScannerEnabled() && !barcodeScannerTaskLock) {
