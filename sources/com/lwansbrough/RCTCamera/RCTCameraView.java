...
public class RCTCameraView extends ViewGroup {
    ...
    public RCTCameraView(Context context) {
        ...
        C1827RCTCamera.createInstance(getDeviceOrientation(context));
    ...
    public void setCameraType(int i) {
        ...
        if (rCTCameraViewFinder != null) {
            ...
            C1827RCTCamera.getInstance().adjustPreviewLayout(i);
            return;
        }
    ...
    public void setOrientation(int i) {
        C1827RCTCamera.getInstance().setOrientation(i);
    ...
    public void setBarcodeScannerEnabled(boolean z) {
        C1827RCTCamera.getInstance().setBarcodeScannerEnabled(z);
    }

    public void setBarCodeTypes(List<String> list) {
        C1827RCTCamera.getInstance().setBarCodeTypes(list);
    }
    ...
    public boolean setActualDeviceOrientation(Context context) {
        ...
        C1827RCTCamera.getInstance().setActualDeviceOrientation(this._actualDeviceOrientation);
        return true;
    }
        ...
        if (rCTCameraViewFinder != null) {
            ...
            if (i7 == 0) {
                ...
                if (d < d3) {
                    ...
                    C1827RCTCamera.getInstance().setPreviewVisibleSize(this._viewFinder.getCameraType(), (int) f, (int) f2);
