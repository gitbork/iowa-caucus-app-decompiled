...
/* renamed from: com.lwansbrough.RCTCamera.RCTCamera */
public class C1827RCTCamera {
    ...
    private static C1827RCTCamera ourInstance;
    ...
    /* renamed from: com.lwansbrough.RCTCamera.RCTCamera$CameraInfoWrapper */
    ...
    /* renamed from: com.lwansbrough.RCTCamera.RCTCamera$Resolution */
    ...
    public static C1827RCTCamera getInstance() {
        return ourInstance;
    }

    public static void createInstance(int i) {
        ourInstance = new C1827RCTCamera(i);
    }
    ...
    public CamcorderProfile setCaptureVideoQuality(int i, String str) {
        ...
        if (c == 0) {
            ...
            size = (Size) supportedVideoSizes.get(supportedVideoSizes.size() / 2);
