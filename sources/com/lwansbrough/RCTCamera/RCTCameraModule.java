...
public class RCTCameraModule extends ReactContextBaseJavaModule implements OnInfoListener, OnErrorListener, LifecycleEventListener {
    ...
    /* access modifiers changed from: private */
    public Boolean mSafeToCapture = Boolean.valueOf(true);
                ...
                return Collections.unmodifiableMap(new HashMap<String, Object>() {
                    {
                        ...
                        String str2 = "medium";
                        put(str2, str2);
                        String str3 = RCTCameraModule.RCT_CAMERA_CAPTURE_QUALITY_HIGH;
                        put(str3, str3);
                        put("photo", str3);
                        String str4 = RCTCameraModule.RCT_CAMERA_CAPTURE_QUALITY_PREVIEW;
                        put(str4, str4);
                        String str5 = RCTCameraModule.RCT_CAMERA_CAPTURE_QUALITY_480P;
                        put(str5, str5);
                        String str6 = RCTCameraModule.RCT_CAMERA_CAPTURE_QUALITY_720P;
                        put(str6, str6);
                        String str7 = RCTCameraModule.RCT_CAMERA_CAPTURE_QUALITY_1080P;
                        put(str7, str7);
                    }
                });
            }
                ...
                return Collections.unmodifiableMap(new HashMap<String, Object>() {
                    {
                        ...
                        put(ViewProps.f59ON, Integer.valueOf(1));
    ...
    private Throwable prepareMediaRecorder(ReadableMap readableMap, int i) {
        CamcorderProfile captureVideoQuality = C1827RCTCamera.getInstance().setCaptureVideoQuality(readableMap.getInt("type"), readableMap.getString("quality"));
        ...
        String str2 = "maxFileSize";
        if (readableMap.hasKey(str2)) {
            this.mMediaRecorder.setMaxFileSize((long) readableMap.getInt(str2));
        }
        try {
    ...
    private void record(ReadableMap readableMap, Promise promise, int i) {
        if (this.mRecordingPromise == null) {
            this.mCamera = C1827RCTCamera.getInstance().acquireCameraInstance(readableMap.getInt("type"));
    ...
    public void capture(final ReadableMap readableMap, final Promise promise) {
        if (C1827RCTCamera.getInstance() == null) {
            promise.reject("Camera is not ready yet.");
            return;
        }
        String str = "orientation";
        int i = readableMap.hasKey(str) ? readableMap.getInt(str) : C1827RCTCamera.getInstance().getOrientation();
    ...
    public void captureWithOrientation(final ReadableMap readableMap, final Promise promise, int i) {
        String str = "type";
        final Camera acquireCameraInstance = C1827RCTCamera.getInstance().acquireCameraInstance(readableMap.getInt(str));
        if (acquireCameraInstance == null) {
            ...
            String str2 = "quality";
            C1827RCTCamera.getInstance().setCaptureQuality(readableMap.getInt(str), readableMap.getString(str2));
            ...
            C1827RCTCamera.getInstance().adjustCameraRotationToDeviceOrientation(readableMap.getInt(str), i);
            acquireCameraInstance.setPreviewCallback(null);
            C18393 r1 = new PictureCallback() {
    ...
    public synchronized void processImage(com.lwansbrough.RCTCamera.MutableImage r12, com.facebook.react.bridge.ReadableMap r13, com.facebook.react.bridge.Promise r14) {
        ...
        L_0x001c:
            ...
            r14.reject(r3, r0)     // Catch:{ all -> 0x0167 }
        L_0x0022:
            ...
            com.lwansbrough.RCTCamera.RCTCamera r7 = com.lwansbrough.RCTCamera.C1827RCTCamera.getInstance()     // Catch:{ IllegalArgumentException -> 0x0069 }
            ...
            com.lwansbrough.RCTCamera.RCTCamera r9 = com.lwansbrough.RCTCamera.C1827RCTCamera.getInstance()     // Catch:{ IllegalArgumentException -> 0x0069 }
        ...
        L_0x0087:
            ...
            r14.reject(r4, r3)     // Catch:{ all -> 0x0167 }
        L_0x008d:
        ...
        L_0x00a4:
            ...
            r14.reject(r3, r1)     // Catch:{ all -> 0x0167 }
        L_0x00aa:
            r1 = 80
        ...
        L_0x00e4:
            ...
            r14.reject(r12)     // Catch:{ all -> 0x0167 }
            monitor-exit(r11)
            return
        L_0x00f1:
        ...
        L_0x00fb:
            ...
            r14.reject(r13, r12)     // Catch:{ all -> 0x0167 }
            monitor-exit(r11)
            return
        L_0x0103:
    ...
    public void hasFlash(ReadableMap readableMap, Promise promise) {
        Camera acquireCameraInstance = C1827RCTCamera.getInstance().acquireCameraInstance(readableMap.getInt("type"));
        if (acquireCameraInstance == null) {
            promise.reject("No camera found.");
            return;
        }
    ...
    public void setZoom(ReadableMap readableMap, int i) {
        C1827RCTCamera instance = C1827RCTCamera.getInstance();
        if (instance != null) {
    ...
    private File getTempMediaFile(int i) {
        ...
        try {
            ...
            if (i == 1) {
                ...
                sb.append("IMG_");
                sb.append(format);
                file = File.createTempFile(sb.toString(), ".jpg", cacheDir);
            } else if (i == 2) {
                StringBuilder sb2 = new StringBuilder();
                sb2.append("VID_");
                sb2.append(format);
                file = File.createTempFile(sb2.toString(), ".mp4", cacheDir);
            } else {
