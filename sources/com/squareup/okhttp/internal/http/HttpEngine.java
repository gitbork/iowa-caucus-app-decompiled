...
public final class HttpEngine {
    ...
    class NetworkInterceptorChain implements Chain {
        ...
        public Response proceed(Request request2) throws IOException {
            ...
            if (this.index < HttpEngine.this.client.networkInterceptors().size()) {
                ...
                sb5.append(access$200.body().contentLength());
    ...
    private Response unzip(Response response) throws IOException {
        if (this.transparentGzip) {
            ...
            if ("gzip".equalsIgnoreCase(response2.header(str))) {
                ...
                response = response.newBuilder().headers(build).body(new RealResponseBody(build, Okio.buffer((Source) gzipSource))).build();
            }
        }
        return response;
    }
    ...
    public static boolean hasBody(Response response) {
        ...
        if (((code >= 100 && code < 200) || code == 204 || code == 304) && OkHeaders.contentLength(response) == -1) {
    ...
    private Request networkRequest(Request request) throws IOException {
        ...
        String str2 = HttpHeaders.CONNECTION;
        if (request.header(str2) == null) {
            newBuilder.header(str2, "Keep-Alive");
        }
        String str3 = HttpHeaders.ACCEPT_ENCODING;
        if (request.header(str3) == null) {
            this.transparentGzip = true;
            newBuilder.header(str3, "gzip");
        }
        ...
        String str4 = HttpHeaders.USER_AGENT;
        if (request.header(str4) == null) {
            newBuilder.header(str4, Version.userAgent());
        }
