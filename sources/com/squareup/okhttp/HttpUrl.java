...
public final class HttpUrl {
    ...
    static /* synthetic */ class C18901 {
        static final /* synthetic */ int[] $SwitchMap$com$squareup$okhttp$HttpUrl$Builder$ParseResult = new int[ParseResult.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = $SwitchMap$com$squareup$okhttp$HttpUrl$Builder$ParseResult     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = $SwitchMap$com$squareup$okhttp$HttpUrl$Builder$ParseResult     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                int[] r0 = $SwitchMap$com$squareup$okhttp$HttpUrl$Builder$ParseResult     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                int[] r0 = $SwitchMap$com$squareup$okhttp$HttpUrl$Builder$ParseResult     // Catch:{ NoSuchFieldError -> 0x0035 }
            ...
            L_0x0035:
                int[] r0 = $SwitchMap$com$squareup$okhttp$HttpUrl$Builder$ParseResult     // Catch:{ NoSuchFieldError -> 0x0040 }
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.squareup.okhttp.HttpUrl.C18901.<clinit>():void");
        }
    }
    ...
    public static final class Builder {
        ...
        public Builder addQueryParameter(String str, String str2) {
            if (str != null) {
                ...
                list.add(HttpUrl.canonicalize(str, str3, false, true, true));
                this.encodedQueryNamesAndValues.add(str2 != null ? HttpUrl.canonicalize(str2, str3, false, true, true) : null);
                return this;
            }
        ...
        public Builder addEncodedQueryParameter(String str, String str2) {
            if (str != null) {
                ...
                List<String> list = this.encodedQueryNamesAndValues;
                String str3 = HttpUrl.QUERY_COMPONENT_ENCODE_SET;
                list.add(HttpUrl.canonicalize(str, str3, true, true, true));
                this.encodedQueryNamesAndValues.add(str2 != null ? HttpUrl.canonicalize(str2, str3, true, true, true) : null);
                return this;
            }
    ...
    /* synthetic */ HttpUrl(Builder builder, C18901 r2) {
        this(builder);
    }
    ...
    static HttpUrl getChecked(String str) throws MalformedURLException, UnknownHostException {
        ...
        int i = C18901.$SwitchMap$com$squareup$okhttp$HttpUrl$Builder$ParseResult[parse.ordinal()];
        if (i == 1) {
            return builder.build();
        }
        if (i != 2) {
            ...
            if (!z || !(codePointAt == 9 || codePointAt == 10 || codePointAt == 12 || codePointAt == 13)) {
                if (codePointAt == 43 && z2) {
                    ...
                    while (!buffer2.exhausted()) {
                        ...
                        buffer.writeByte((int) HEX_DIGITS[readByte & Ascii.f158SI]);
                    }
                } else {
                    buffer.writeUtf8CodePoint(codePointAt);
                }
