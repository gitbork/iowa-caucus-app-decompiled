...
public class XMPNormalizer {
    ...
    private static void migrateAudioCopyright(XMPMeta xMPMeta, XMPNode xMPNode) {
        ...
        try {
            ...
            if (findChildNode != null) {
                if (findChildNode.hasChildren()) {
                    ...
                    if (lookupLanguageItem < 0) {
                        ...
                        xMPMeta2.setLocalizedText("http://purl.org/dc/elements/1.1/", "rights", "", XMPConst.X_DEFAULT, findChildNode.getChild(1).getValue(), null);
            ...
            xMPMeta3.setLocalizedText("http://purl.org/dc/elements/1.1/", "rights", "", XMPConst.X_DEFAULT, sb4.toString(), null);
            xMPNode.getParent().removeChild(xMPNode);
        } catch (XMPException unused) {
        }
    }
