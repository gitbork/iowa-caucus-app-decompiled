...
public abstract class SequentialReader {
    ...
    public long getUInt32() throws IOException {
        ...
        return (4278190080L & (((long) getByte()) << 24)) | (16711680 & (((long) getByte()) << 16)) | (65280 & (((long) getByte()) << 8)) | (255 & ((long) getByte()));
    }
    ...
    public float getS15Fixed16() throws IOException {
        if (this._isMotorolaByteOrder) {
            ...
            double d2 = (double) (((getByte() & UnsignedBytes.MAX_VALUE) << 8) | (getByte() & UnsignedBytes.MAX_VALUE));
            Double.isNaN(d2);
            double d3 = d2 / 65536.0d;
            Double.isNaN(d);
            return (float) (d + d3);
        }
        double d4 = (double) ((float) ((getByte() & UnsignedBytes.MAX_VALUE) | ((getByte() & UnsignedBytes.MAX_VALUE) << 8)));
        double d5 = (double) ((getByte() & UnsignedBytes.MAX_VALUE) | ((getByte() & UnsignedBytes.MAX_VALUE) << 8));
        Double.isNaN(d5);
        double d6 = d5 / 65536.0d;
        Double.isNaN(d4);
        return (float) (d4 + d6);
    }
