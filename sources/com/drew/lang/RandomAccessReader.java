...
public abstract class RandomAccessReader {
    ...
    public float getS15Fixed16(int i) throws IOException {
        ...
        validateIndex(i, 4);
        if (this._isMotorolaByteOrder) {
            float f = (float) (((getByte(i) & UnsignedBytes.MAX_VALUE) << 8) | (getByte(i + 1) & UnsignedBytes.MAX_VALUE));
            ...
            float f2 = (float) (((getByte(i + 3) & UnsignedBytes.MAX_VALUE) << 8) | (getByte(i + 2) & UnsignedBytes.MAX_VALUE));
