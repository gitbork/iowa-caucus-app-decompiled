...
public class RandomAccessStreamReader extends RandomAccessReader {
    ...
    public boolean isValidIndex(int i, int i2) throws IOException {
        ...
        if (this._isStreamFinished) {
            if (((long) i3) < this._streamLength) {
                z = true;
            }
            return z;
        }
        int i4 = i3 / this._chunkLength;
        while (i4 >= this._chunks.size()) {
            ...
            while (!this._isStreamFinished) {
                ...
                int read = this._stream.read(bArr, i5, i6 - i5);
                if (read == -1) {
                    this._isStreamFinished = true;
                    int size = (this._chunks.size() * this._chunkLength) + i5;
    ...
    public byte[] getBytes(int i, int i2) throws IOException {
        ...
        while (i2 != 0) {
            ...
            System.arraycopy((byte[]) this._chunks.get(i5), i6, bArr, i3, min);
            i2 -= min;
            i += min;
            i3 += min;
        }
