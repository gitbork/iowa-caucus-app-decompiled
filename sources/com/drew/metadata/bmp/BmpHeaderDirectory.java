...
public class BmpHeaderDirectory extends Directory {
    ...
    static /* synthetic */ class C04321 {
        ...
        /* renamed from: $SwitchMap$com$drew$metadata$bmp$BmpHeaderDirectory$ColorSpaceType */
        static final /* synthetic */ int[] f26xfa95b2b3 = new int[ColorSpaceType.values().length];

        /* renamed from: $SwitchMap$com$drew$metadata$bmp$BmpHeaderDirectory$RenderingHalftoningAlgorithm */
        static final /* synthetic */ int[] f27x161283b7 = new int[RenderingHalftoningAlgorithm.values().length];

        /* renamed from: $SwitchMap$com$drew$metadata$bmp$BmpHeaderDirectory$RenderingIntent */
        static final /* synthetic */ int[] f28x34cafd92 = new int[RenderingIntent.values().length];
        ...
        static {
            /*
                ...
                f28x34cafd92 = r0
                r0 = 1
                int[] r1 = f28x34cafd92     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                r1 = 2
                int[] r2 = f28x34cafd92     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                r2 = 3
                int[] r3 = f28x34cafd92     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                r3 = 4
                int[] r4 = f28x34cafd92     // Catch:{ NoSuchFieldError -> 0x0035 }
            ...
            L_0x0035:
                ...
                int[] r4 = new int[r4]
                f26xfa95b2b3 = r4
                int[] r4 = f26xfa95b2b3     // Catch:{ NoSuchFieldError -> 0x0048 }
            ...
            L_0x0048:
                int[] r4 = f26xfa95b2b3     // Catch:{ NoSuchFieldError -> 0x0052 }
            ...
            L_0x0052:
                int[] r4 = f26xfa95b2b3     // Catch:{ NoSuchFieldError -> 0x005c }
            ...
            L_0x005c:
                int[] r4 = f26xfa95b2b3     // Catch:{ NoSuchFieldError -> 0x0066 }
            ...
            L_0x0066:
                r4 = 5
                int[] r5 = f26xfa95b2b3     // Catch:{ NoSuchFieldError -> 0x0071 }
            ...
            L_0x0071:
                ...
                int[] r5 = new int[r5]
                f27x161283b7 = r5
                int[] r5 = f27x161283b7     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                int[] r5 = f27x161283b7     // Catch:{ NoSuchFieldError -> 0x008e }
            ...
            L_0x008e:
                int[] r5 = f27x161283b7     // Catch:{ NoSuchFieldError -> 0x0098 }
            ...
            L_0x0098:
                int[] r5 = f27x161283b7     // Catch:{ NoSuchFieldError -> 0x00a2 }
            ...
            L_0x0174:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.drew.metadata.bmp.BmpHeaderDirectory.C04321.<clinit>():void");
        }
    }
        ...
        public String toString() {
            switch (this) {
                ...
                default:
                    ...
                    sb.append("Unimplemented bitmap type ");
    ...
    public enum ColorSpaceType {
        ...
        @NotNull
        public String toString() {
            int i = C04321.f26xfa95b2b3[ordinal()];
            if (i == 1) {
            ...
            StringBuilder sb = new StringBuilder();
            sb.append("Unimplemented color space type ");
            sb.append(super.toString());
            throw new IllegalStateException(sb.toString());
        }
    }
    ...
    public enum Compression {
        ...
        public String toString() {
            switch (this) {
                ...
                default:
                    StringBuilder sb = new StringBuilder();
                    sb.append("Unimplemented compression type ");
                    sb.append(super.toString());
                    throw new IllegalStateException(sb.toString());
            }
        }
    ...
    public enum RenderingHalftoningAlgorithm {
        ...
        @NotNull
        public String toString() {
            int i = C04321.f27x161283b7[ordinal()];
            if (i == 1) {
            ...
            StringBuilder sb = new StringBuilder();
            sb.append("Unimplemented rendering halftoning algorithm type ");
            sb.append(super.toString());
            throw new IllegalStateException(sb.toString());
        }
    }
    ...
    public enum RenderingIntent {
        ...
        @NotNull
        public String toString() {
            int i = C04321.f28x34cafd92[ordinal()];
            if (i == 1) {
            ...
            StringBuilder sb = new StringBuilder();
            sb.append("Unimplemented rendering intent ");
            sb.append(super.toString());
            throw new IllegalStateException(sb.toString());
        }
    }
