...
public class NikonType2MakernoteDescriptor extends TagDescriptor<NikonType2MakernoteDirectory> {
    ...
    public String getShootingModeDescription() {
        return getBitFlagDescription(137, new String[]{"Single Frame", "Continuous"}, "Delay", 0, "PC Control", "Exposure Bracketing", "Auto ISO", "White-Balance Bracketing", "IR Control");
    }
    ...
    public String getAutoFocusPositionDescription() {
        ...
        sb2.append(str2);
        sb2.append(((NikonType2MakernoteDirectory) this._directory).getString(136));
        sb2.append(str);
        return sb2.toString();
    }
    ...
    public String getIsoSettingDescription() {
        ...
        if (intArray[0] != 0 || intArray[1] == 0) {
            StringBuilder sb = new StringBuilder();
            sb.append("Unknown (");
            sb.append(((NikonType2MakernoteDirectory) this._directory).getString(2));
            sb.append(")");
            return sb.toString();
        }
        StringBuilder sb2 = new StringBuilder();
