...
public class NikonType2MakernoteDirectory extends Directory {
    ...
    static {
        ...
        String str2 = "Camera Serial Number";
        _tagNameMap.put(Integer.valueOf(29), str2);
        ...
        _tagNameMap.put(Integer.valueOf(160), str2);
        ...
        Integer valueOf2 = Integer.valueOf(170);
        String str3 = ExifInterface.TAG_SATURATION;
        ...
        _tagNameMap.put(Integer.valueOf(148), str3);
