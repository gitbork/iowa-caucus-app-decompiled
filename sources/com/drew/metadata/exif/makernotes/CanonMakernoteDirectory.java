...
public class CanonMakernoteDirectory extends Directory {
    ...
    static {
        ...
        _tagNameMap.put(Integer.valueOf(FocalLength.TAG_WHITE_BALANCE), str2);
        String str3 = "Sequence Number";
        _tagNameMap.put(Integer.valueOf(FocalLength.TAG_SEQUENCE_NUMBER), str3);
        ...
        String str4 = "Auto Exposure Bracketing";
        _tagNameMap.put(Integer.valueOf(FocalLength.TAG_AUTO_EXPOSURE_BRACKETING), str4);
        String str5 = "AEB Bracket Value";
        _tagNameMap.put(Integer.valueOf(FocalLength.TAG_AEB_BRACKET_VALUE), str5);
        ...
        _tagNameMap.put(Integer.valueOf(ShotInfo.TAG_WHITE_BALANCE), str2);
        _tagNameMap.put(Integer.valueOf(ShotInfo.TAG_SLOW_SHUTTER), "Slow Shutter");
        _tagNameMap.put(Integer.valueOf(ShotInfo.TAG_SEQUENCE_NUMBER), str3);
        ...
        String str6 = "AF Points in Focus";
        _tagNameMap.put(Integer.valueOf(ShotInfo.TAG_AF_POINTS_IN_FOCUS), str6);
        _tagNameMap.put(Integer.valueOf(ShotInfo.TAG_FLASH_EXPOSURE_BRACKETING), "Flash Exposure Compensation");
        _tagNameMap.put(Integer.valueOf(ShotInfo.TAG_AUTO_EXPOSURE_BRACKETING), str4);
        _tagNameMap.put(Integer.valueOf(ShotInfo.TAG_AEB_BRACKET_VALUE), str5);
        ...
        _tagNameMap.put(Integer.valueOf(AFInfo.TAG_AF_POINTS_IN_FOCUS), str6);
