...
public class PanasonicMakernoteDescriptor extends TagDescriptor<PanasonicMakernoteDirectory> {
    ...
    public String getUptimeDescription() {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append(((float) integer.intValue()) / 100.0f);
        sb.append(" s");
        return sb.toString();
    }
    ...
    public String getWhiteBalanceDescription() {
        String str = "Manual";
        return getIndexedDescription(3, 1, "Auto", "Daylight", "Cloudy", "Incandescent", str, null, null, ExifInterface.TAG_FLASH, null, "Black & White", str, "Shade");
    }
