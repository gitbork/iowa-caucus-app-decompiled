...
public class OlympusMakernoteDirectory extends Directory {
    ...
    static {
        ...
        String str3 = "Image Quality";
        _tagNameMap.put(Integer.valueOf(258), str3);
        _tagNameMap.put(Integer.valueOf(259), str3);
        ...
        String str4 = "Digital Zoom";
        _tagNameMap.put(Integer.valueOf(516), str4);
        ...
        String str5 = "Serial Number";
        _tagNameMap.put(Integer.valueOf(1028), str5);
        ...
        String str6 = "Flash Mode";
        _tagNameMap.put(Integer.valueOf(4100), str6);
        ...
        String str7 = "Focus Mode";
        _tagNameMap.put(Integer.valueOf(4107), str7);
        String str8 = "Focus Distance";
        _tagNameMap.put(Integer.valueOf(TAG_FOCUS_DISTANCE), str8);
        ...
        String str9 = ExifInterface.TAG_SHARPNESS;
        hashMap.put(valueOf, str9);
        ...
        _tagNameMap.put(Integer.valueOf(TAG_SERIAL_NUMBER_2), str5);
        ...
        String str10 = ExifInterface.TAG_CONTRAST;
        hashMap2.put(valueOf2, str10);
        ...
        _tagNameMap.put(Integer.valueOf(CameraSettings.TAG_FLASH_MODE), str6);
        ...
        _tagNameMap.put(Integer.valueOf(CameraSettings.TAG_IMAGE_QUALITY), str3);
        ...
        _tagNameMap.put(Integer.valueOf(CameraSettings.TAG_DIGITAL_ZOOM), str4);
        ...
        _tagNameMap.put(Integer.valueOf(CameraSettings.TAG_FOCUS_DISTANCE), str8);
        ...
        _tagNameMap.put(Integer.valueOf(CameraSettings.TAG_CONTRAST), str10);
        _tagNameMap.put(Integer.valueOf(CameraSettings.TAG_SHARPNESS), str9);
        ...
        _tagNameMap.put(Integer.valueOf(CameraSettings.TAG_FOCUS_MODE), str7);
        ...
        String str11 = "FE190/X750";
        OlympusCameraTypes.put("D4327", str11);
        OlympusCameraTypes.put("D4328", "u760,S760");
        String str12 = "FE180/X745";
        OlympusCameraTypes.put("D4330", str12);
        ...
        OlympusCameraTypes.put("SX875", str12);
        OlympusCameraTypes.put("SX876", str11);
    }
