...
public class CanonMakernoteDescriptor extends TagDescriptor<CanonMakernoteDirectory> {
    ...
    public String getShortFocalLengthDescription() {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append(Integer.toString(integer.intValue()));
        sb.append(" ");
        sb.append(focalUnitsPerMillimetreDescription);
        return sb.toString();
    }
    ...
    public String getFocusMode1Description() {
        String str = "Manual Focus";
        return getIndexedDescription(CameraSettings.TAG_FOCUS_MODE_1, "One-shot", "AI Servo", "AI Focus", str, "Single", "Continuous", str);
    }
    ...
    public String getContinuousDriveModeDescription() {
        ...
        int intValue = integer.intValue();
        if (intValue == 0) {
            Integer integer2 = ((CanonMakernoteDirectory) this._directory).getInteger(CameraSettings.TAG_SELF_TIMER_DELAY);
            if (integer2 != null) {
    ...
    static {
        ...
        String str2 = "Canon EF 35-80mm f/4-5.6";
        _lensTypeById.put(Integer.valueOf(27), str2);
        ...
        _lensTypeById.put(Integer.valueOf(35), str2);
        ...
        String str3 = "Canon EF 28-90mm f/4-5.6";
        _lensTypeById.put(Integer.valueOf(41), str3);
        ...
        _lensTypeById.put(Integer.valueOf(46), str3);
        ...
        String str4 = "Canon EF 300mm f/2.8L";
        _lensTypeById.put(Integer.valueOf(129), str4);
        ...
        String str5 = "Canon EF 600mm f/4L IS";
        _lensTypeById.put(Integer.valueOf(NikonType2MakernoteDirectory.TAG_DIGITAL_ZOOM), str5);
        _lensTypeById.put(Integer.valueOf(NikonType2MakernoteDirectory.TAG_FLASH_USED), "Canon EF 200mm f/1.8L");
        _lensTypeById.put(Integer.valueOf(136), str4);
        ...
        String str6 = "Canon EF 400mm f/2.8L";
        _lensTypeById.put(Integer.valueOf(NikonType2MakernoteDirectory.TAG_LENS_STOPS), str6);
        String str7 = "Canon EF 500mm f/4.5L";
        _lensTypeById.put(Integer.valueOf(140), str7);
        _lensTypeById.put(Integer.valueOf(141), str7);
        ...
        String str8 = "Canon EF 35-135mm f/4-5.6 USM";
        _lensTypeById.put(Integer.valueOf(144), str8);
        ...
        _lensTypeById.put(Integer.valueOf(147), str8);
        String str9 = "Canon EF 28-80mm f/3.5-5.6 USM";
        _lensTypeById.put(Integer.valueOf(148), str9);
        ...
        String str10 = "Canon EF 200mm f/2.8L";
        _lensTypeById.put(Integer.valueOf(151), str10);
        ...
        _lensTypeById.put(Integer.valueOf(162), str10);
        String str11 = "Canon EF 300mm f/4L";
        _lensTypeById.put(Integer.valueOf(163), str11);
        ...
        _lensTypeById.put(Integer.valueOf(171), str11);
        ...
        _lensTypeById.put(Integer.valueOf(NikonType2MakernoteDirectory.TAG_UNKNOWN_30), str6);
        ...
        _lensTypeById.put(Integer.valueOf(NikonType2MakernoteDirectory.TAG_AF_TUNE), str5);
        ...
        String str12 = "Canon EF 75-300mm f/4-5.6 USM";
        _lensTypeById.put(Integer.valueOf(196), str12);
        ...
        _lensTypeById.put(Integer.valueOf(199), str9);
        _lensTypeById.put(Integer.valueOf(LogSeverity.INFO_VALUE), str12);
        _lensTypeById.put(Integer.valueOf(XMPError.BADXML), str9);
