...
public class OlympusEquipmentMakernoteDescriptor extends TagDescriptor<OlympusEquipmentMakernoteDirectory> {
    ...
    public String getFocalPlaneDiagonalDescription() {
        ...
        sb.append(((OlympusEquipmentMakernoteDirectory) this._directory).getString(259));
        sb.append(" mm");
        return sb.toString();
    }
    ...
    public String getExtenderDescription() {
        ...
        try {
            return (String) _olympusExtenderTypes.get(String.format("%X %02X", new Object[]{Integer.valueOf(Integer.parseInt(split[0])), Integer.valueOf(Integer.parseInt(split[2]))}));
        } catch (NumberFormatException unused) {
            return null;
        }
    }
    ...
    static {
        ...
        String str3 = "Sigma 30mm F1.4 EX DC HSM";
        _olympusLensTypes.put("1 05 00", str3);
        _olympusLensTypes.put("1 05 10", "Sigma 60mm F2.8 DN | A");
        String str4 = "Sigma APO 50-500mm F4.0-6.3 EX DG HSM";
        _olympusLensTypes.put("1 06 00", str4);
        ...
        _olympusLensTypes.put("1 13 00", str3);
        _olympusLensTypes.put("1 14 00", str4);
        ...
        String str5 = "Leica D Vario Elmarit 14-50mm F2.8-3.5 Asph.";
        _olympusLensTypes.put("2 01 00", str5);
        _olympusLensTypes.put("2 01 10", "Lumix G Vario 14-45mm F3.5-5.6 Asph. Mega OIS");
        String str6 = "Leica D Summilux 25mm F1.4 Asph.";
        _olympusLensTypes.put("2 02 00", str6);
        ...
        _olympusLensTypes.put("3 01 00", str5);
        _olympusLensTypes.put("3 02 00", str6);
