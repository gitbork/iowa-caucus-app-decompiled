...
public abstract class ExifDescriptorBase<T extends Directory> extends TagDescriptor<T> {
    ...
    public String getInteropIndexDescription() {
        ...
        if ("R98".equalsIgnoreCase(string.trim())) {
            str = "Recommended Exif Interoperability Rules (ExifR98)";
        } else {
    ...
    public String getBitsPerSampleDescription() {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append(string);
        sb.append(" bits/component/pixel");
        return sb.toString();
    }
    ...
    private int[] decodeCfaPattern(int i) {
        ...
        try {
            ...
            directory.addError(sb.toString());
        }
        return iArr2;
    }
    ...
    public String getFocalPlaneXResolutionDescription() {
        ...
        if (focalPlaneResolutionUnitDescription == null) {
            ...
            sb2.append(" ");
            sb2.append(focalPlaneResolutionUnitDescription.toLowerCase());
            str = sb2.toString();
        }
        sb.append(str);
        return sb.toString();
    ...
    public String getSubjectDistanceDescription() {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append(decimalFormat.format(rational.doubleValue()));
        sb.append(" metres");
        return sb.toString();
    }
