...
public class Mp4Dictionary {
    ...
    static {
        ...
        HashMap<Integer, HashMap<String, String>> hashMap = _dictionary;
        ...
        String str5 = "Animation";
        String str6 = "rle ";
        _videoCompressionTypes.put(str6, str5);
        _videoCompressionTypes.put(str6, str5);
        ...
        String str7 = "uLaw 2:1";
        _soundAudioFormats.put("ulaw", str7);
        _soundAudioFormats.put("alaw", str7);
        _soundAudioFormats.put(new String("ms\u0000\u0002"), "Microsoft ADPCM-ACM code 2");
        _soundAudioFormats.put(new String("ms\u0000\u0011"), "DVI/Intel IMAADPCM-ACM code 17");
        ...
        _soundAudioFormats.put(new String("ms\u0000U"), "MPEG-1 layer 3, CBR only (pre-QT4.1)");
        ...
        _soundAudioFormats.put(new String("MS\u0000\u0002"), "Microsoft ADPCM");
        _soundAudioFormats.put(new String("MS\u0000\u0011"), "DV IMA");
        _soundAudioFormats.put(new String("MS\u0000U"), "MPEG3");
        ...
        String str8 = "3gp6";
        _majorBrands.put(str8, "3GPP Media (.3GP) Release 6 Basic Profile");
        _majorBrands.put(str8, "3GPP Media (.3GP) Release 6 Progressive Download");
        _majorBrands.put(str8, "3GPP Media (.3GP) Release 6 Streaming Servers");
        ...
        String str9 = "pana";
        _majorBrands.put(str9, "Panasonic Digital Camera");
    ...
    public static String lookup(int i, String str) {
        return (!_dictionary.containsKey(Integer.valueOf(i)) || !((HashMap) _dictionary.get(Integer.valueOf(i))).containsKey(str)) ? "Unknown" : (String) ((HashMap) _dictionary.get(Integer.valueOf(i))).get(str);
    }
