...
public class VideoSampleDescriptionAtom extends SampleDescriptionAtom<VideoSampleDescription> {
    ...
    public void addMetadata(QuickTimeVideoDirectory quickTimeVideoDirectory) {
        ...
        double d3 = d2 / pow;
        Double.isNaN(d);
        quickTimeVideoDirectory2.setDouble(6, d + d3);
        double d4 = (double) ((videoSampleDescription.verticalResolution & -65536) >> 16);
        double d5 = (double) (videoSampleDescription.verticalResolution & 65535);
        double pow2 = Math.pow(2.0d, 4.0d);
        Double.isNaN(d5);
        double d6 = d5 / pow2;
        Double.isNaN(d4);
        quickTimeVideoDirectory2.setDouble(7, d4 + d6);
    }
}
