        ...
        if (int32 == -976170042) {
            ...
            if (int327 != 0) {
                ...
                try {
                    ...
                    sb.append("Unable to process TIFF data: ");
                    sb.append(e.getMessage());
                    epsDirectory.addError(sb.toString());
                }
            } else if (int325 != 0) {
    ...
    private void addToDirectory(@NotNull EpsDirectory epsDirectory, String str, String str2) throws IOException {
        ...
        if (num != null) {
            ...
            if (intValue == 8) {
                ...
                StringBuilder sb = new StringBuilder();
                sb.append(epsDirectory.getString(this._previousTag));
                sb.append(" ");
                sb.append(str2);
                epsDirectory.setString(i, sb.toString());
