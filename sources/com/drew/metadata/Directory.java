...
public abstract class Directory {
    ...
    public int[] getIntArray(int i) {
        ...
        if (object instanceof Rational[]) {
            Rational[] rationalArr = (Rational[]) object;
            int[] iArr2 = new int[rationalArr.length];
            while (i2 < iArr2.length) {
                iArr2[i2] = rationalArr[i2].intValue();
                i2++;
            }
            return iArr2;
        } else if (object instanceof short[]) {
            ...
            int[] iArr5 = new int[charSequence.length()];
            while (i2 < charSequence.length()) {
                iArr5[i2] = charSequence.charAt(i2);
                i2++;
            }
            return iArr5;
        } else {
    ...
    public byte[] getByteArray(int i) {
        ...
        if (object instanceof Rational[]) {
            Rational[] rationalArr = (Rational[]) object;
            byte[] bArr2 = new byte[rationalArr.length];
            while (i2 < bArr2.length) {
                bArr2[i2] = rationalArr[i2].byteValue();
                i2++;
            }
            return bArr2;
        } else if (object instanceof byte[]) {
            ...
            if (object instanceof int[]) {
                ...
                short[] sArr = (short[]) object;
                byte[] bArr4 = new byte[sArr.length];
                while (i2 < sArr.length) {
                    bArr4[i2] = (byte) sArr[i2];
                    i2++;
                }
                return bArr4;
            } else if (object instanceof CharSequence) {
                CharSequence charSequence = (CharSequence) object;
                byte[] bArr5 = new byte[charSequence.length()];
                while (i2 < charSequence.length()) {
                    bArr5[i2] = (byte) charSequence.charAt(i2);
                    i2++;
                }
                return bArr5;
            } else {
    ...
    public double getDouble(int i) throws MetadataException {
        ...
        sb2.append(str);
        sb2.append(i);
        sb2.append("' cannot be converted to a double.  It is of type '");
        sb2.append(object.getClass());
        sb2.append("'.");
        throw new MetadataException(sb2.toString());
    }
    ...
    public float getFloat(int i) throws MetadataException {
        ...
        sb2.append(str);
        sb2.append(i);
        sb2.append("' cannot be converted to a float.  It is of type '");
        sb2.append(object.getClass());
        sb2.append("'.");
        throw new MetadataException(sb2.toString());
    }
    ...
    public long getLong(int i) throws MetadataException {
        ...
        sb2.append(str);
        sb2.append(i);
        sb2.append("' cannot be converted to a long.  It is of type '");
        sb2.append(object.getClass());
        sb2.append("'.");
        throw new MetadataException(sb2.toString());
    }
    ...
    public boolean getBoolean(int i) throws MetadataException {
        ...
        sb2.append(str);
        sb2.append(i);
        sb2.append("' cannot be converted to a boolean.  It is of type '");
        sb2.append(object.getClass());
        sb2.append("'.");
        throw new MetadataException(sb2.toString());
    }
