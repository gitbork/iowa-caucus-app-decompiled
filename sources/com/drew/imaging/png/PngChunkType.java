...
public class PngChunkType {
    ...
    static {
        ...
        String str4 = "tEXt";
        String str5 = "zTXt";
        _identifiersAllowingMultiples = new HashSet(Arrays.asList(new String[]{str, str2, str3, str4, str5}));
        try {
            IHDR = new PngChunkType("IHDR");
            PLTE = new PngChunkType("PLTE");
            IDAT = new PngChunkType(str, true);
            ...
            sPLT = new PngChunkType(str2, true);
            tIME = new PngChunkType("tIME");
            iTXt = new PngChunkType(str3, true);
            tEXt = new PngChunkType(str4, true);
            zTXt = new PngChunkType(str5, true);
