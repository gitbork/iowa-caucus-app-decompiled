        ...
        if (type.equals(PngChunkType.IHDR)) {
            ...
            if (type.equals(PngChunkType.iCCP)) {
                ...
                if (type.equals(PngChunkType.zTXt)) {
                    ...
                    if (sequentialByteArrayReader3.getInt8() == 0) {
                        try {
                    ...
                    byte int8 = sequentialByteArrayReader4.getInt8();
                    ...
                    byte int83 = sequentialByteArrayReader6.getInt8();
                    ...
                    pngDirectory17.setInt(18, int83);
