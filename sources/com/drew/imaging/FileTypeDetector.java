...
public class FileTypeDetector {
    ...
    static {
        ...
        String str = "II";
        _root.addPath(FileType.Tiff, str.getBytes(), new byte[]{42, 0});
        _root.addPath(FileType.Tiff, "MM".getBytes(), new byte[]{0, 42});
        _root.addPath(FileType.Psd, "8BPS".getBytes());
        _root.addPath(FileType.Png, new byte[]{-119, 80, 78, 71, Ascii.f149CR, 10, Ascii.SUB, 10, 0, 0, 0, Ascii.f149CR, 73, 72, 68, 82});
        ...
        _root.addPath(FileType.Arw, str.getBytes(), new byte[]{42, 0, 8, 0});
        _root.addPath(FileType.Crw, str.getBytes(), new byte[]{Ascii.SUB, 0, 0, 0}, "HEAPCCDR".getBytes());
        _root.addPath(FileType.Cr2, str.getBytes(), new byte[]{42, 0, Ascii.DLE, 0, 0, 0, 67, 82});
        ...
        _root.addPath(FileType.Rw2, str.getBytes(), new byte[]{85, 0});
        ...
        _root.addPath(FileType.Indd, new byte[]{6, 6, -19, -11, -40, Ascii.f153GS, 70, -27, -67, 49, ByteSourceJsonBootstrapper.UTF8_BOM_1, -25, -2, 116, -73, Ascii.f153GS});
        _root.addPath(FileType.Mxf, new byte[]{6, Ascii.f159SO, 43, 52, 2, 5, 1, 1, Ascii.f149CR, 1, 2, 1, 1, 2});
