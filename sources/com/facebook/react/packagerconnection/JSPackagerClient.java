...
public final class JSPackagerClient implements MessageCallback {
    ...
    private class ResponderImpl implements Responder {
        ...
        public void respond(Object obj) {
            try {
                ...
                FLog.m45e(JSPackagerClient.TAG, "Responding failed", (Throwable) e);
            }
        }
        ...
        public void error(Object obj) {
            try {
                ...
                FLog.m45e(JSPackagerClient.TAG, "Responding with error failed", (Throwable) e);
            }
        }
    }
    ...
    public JSPackagerClient(String str, PackagerConnectionSettings packagerConnectionSettings, Map<String, RequestHandler> map, @Nullable ConnectionCallback connectionCallback) {
        ...
        String str2 = "app";
        builder.scheme("ws").encodedAuthority(packagerConnectionSettings.getDebugServerHost()).appendPath(JsonMarshaller.MESSAGE).appendQueryParameter("device", AndroidInfoHelpers.getFriendlyDeviceName()).appendQueryParameter(str2, packagerConnectionSettings.getPackageName()).appendQueryParameter("clientid", str);
    ...
    public void onMessage(String str) {
        try {
            ...
            FLog.m45e(TAG, "Handling the message failed", (Throwable) e);
        }
    }

    public void onMessage(ByteString byteString) {
        FLog.m84w(TAG, "Websocket received message with payload of unexpected type binary");
    }
