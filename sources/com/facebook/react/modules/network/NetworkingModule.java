                        ...
                        public void onResponse(Call call, Response response) throws IOException {
                            if (!NetworkingModule.this.mShuttingDown) {
                                ...
                                try {
                                    ...
                                    } else if (str11.equals(NetworkingModule.REQUEST_BODY_KEY_BASE64)) {
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        if (!NetworkingModule.this.mShuttingDown) {
                            ...
                            try {
                                ...
                                } else if (str112.equals(NetworkingModule.REQUEST_BODY_KEY_BASE64)) {
                                    str2 = Base64.encodeToString(body.bytes(), 2);
                                }
    ...
    private MultipartBody.Builder constructMultipartBody(ReadableArray readableArray, String str, int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (map.hasKey(str4)) {
                ...
                String str5 = REQUEST_BODY_KEY_URI;
                if (!map.hasKey(str5)) {
