...
public class ReactViewPagerManager extends ViewGroupManager<ReactViewPager> {
    ...
    public Map getExportedCustomDirectEventTypeConstants() {
        ...
        return MapBuilder.m121of(PageScrollEvent.EVENT_NAME, MapBuilder.m119of(str, "onPageScroll"), PageScrollStateChangedEvent.EVENT_NAME, MapBuilder.m119of(str, "onPageScrollStateChanged"), PageSelectedEvent.EVENT_NAME, MapBuilder.m119of(str, "onPageSelected"));
    }

    public Map<String, Integer> getCommandsMap() {
        return MapBuilder.m120of("setPage", Integer.valueOf(1), "setPageWithoutAnimation", Integer.valueOf(2));
    }
    ...
    public void receiveCommand(com.facebook.react.views.viewpager.ReactViewPager r5, java.lang.String r6, @androidx.annotation.Nullable com.facebook.react.bridge.ReadableArray r7) {
        /*
            r4 = this;
