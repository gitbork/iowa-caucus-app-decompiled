...
public class ReactTextViewManager extends ReactTextAnchorViewManager<ReactTextView, ReactTextShadowNode> implements IViewManagerWithChildren {
    ...
    public Object updateState(ReactTextView reactTextView, ReactStylesDiffMap reactStylesDiffMap, StateWrapper stateWrapper) {
        ...
        ReactTextUpdate reactTextUpdate = new ReactTextUpdate(orCreateSpannableForText, -1, false, textAttributeProps.getStartPadding(), textAttributeProps.getTopPadding(), textAttributeProps.getEndPadding(), textAttributeProps.getBottomPadding(), 0, 1, 0);
    ...
    public Map getExportedCustomDirectEventTypeConstants() {
        ...
        return MapBuilder.m120of("topTextLayout", MapBuilder.m119of(str, "onTextLayout"), "topInlineViewLayout", MapBuilder.m119of(str, "onInlineViewLayout"));
    }
