...
public class ReactDrawerLayoutManager extends ViewGroupManager<ReactDrawerLayout> {
    ...
    public void setElevation(ReactDrawerLayout reactDrawerLayout, float f) {
        if (VERSION.SDK_INT >= 21) {
            try {
                ...
                FLog.m85w(ReactConstants.TAG, "setDrawerElevation is not available in this version of the support lib.", (Throwable) e);
            }
        }
    }
    ...
    public Map<String, Integer> getCommandsMap() {
        return MapBuilder.m120of("openDrawer", Integer.valueOf(1), "closeDrawer", Integer.valueOf(2));
    }
    ...
    public Map getExportedViewConstants() {
        return MapBuilder.m119of("DrawerPosition", MapBuilder.m120of("Left", Integer.valueOf(GravityCompat.START), "Right", Integer.valueOf(GravityCompat.END)));
    }

    @Nullable
    public Map getExportedCustomDirectEventTypeConstants() {
        String str = "registrationName";
        return MapBuilder.m122of(DrawerSlideEvent.EVENT_NAME, MapBuilder.m119of(str, "onDrawerSlide"), DrawerOpenedEvent.EVENT_NAME, MapBuilder.m119of(str, "onDrawerOpen"), DrawerClosedEvent.EVENT_NAME, MapBuilder.m119of(str, "onDrawerClose"), DrawerStateChangedEvent.EVENT_NAME, MapBuilder.m119of(str, "onDrawerStateChanged"));
    }
