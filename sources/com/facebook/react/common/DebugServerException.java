...
public class DebugServerException extends RuntimeException {
    ...
    public static DebugServerException parse(String str, String str2) {
        ...
        try {
            ...
            return new DebugServerException(jSONObject.getString(JsonMarshaller.MESSAGE), shortenFileName(jSONObject.getString("filename")), jSONObject.getInt(StackTraceHelper.LINE_NUMBER_KEY), jSONObject.getInt(StackTraceHelper.COLUMN_KEY));
        } catch (JSONException e) {
            StringBuilder sb = new StringBuilder();
            sb.append("Could not parse DebugServerException from: ");
            sb.append(str2);
            FLog.m85w(ReactConstants.TAG, sb.toString(), (Throwable) e);
            return null;
        }
    }
