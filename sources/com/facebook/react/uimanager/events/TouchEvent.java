...
public class TouchEvent extends Event<TouchEvent> {
    ...
    static /* synthetic */ class C08211 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.uimanager.events.TouchEvent.C08211.<clinit>():void");
        }
    }
    ...
    public boolean canCoalesce() {
        int i = C08211.$SwitchMap$com$facebook$react$uimanager$events$TouchEventType[((TouchEventType) Assertions.assertNotNull(this.mTouchEventType)).ordinal()];
        if (i == 1 || i == 2 || i == 3) {
            return false;
        }
        if (i == 4) {
