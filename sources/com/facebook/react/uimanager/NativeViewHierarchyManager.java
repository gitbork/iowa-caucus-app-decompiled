...
public class NativeViewHierarchyManager {
    ...
    public synchronized void updateInstanceHandle(int i, long j) {
        ...
        try {
            ...
            sb.append(i);
            FLog.m45e(str, sb.toString(), (Throwable) e);
        }
        return;
    }
    ...
    private void updateInstanceHandle(View view, long j) {
        UiThreadUtil.assertOnUiThread();
        view.setTag(C0575R.C0577id.view_tag_instance_handle, Long.valueOf(j));
    }
    ...
    public long getInstanceHandle(int i) {
        ...
        if (view != null) {
            Long l = (Long) view.getTag(C0575R.C0577id.view_tag_instance_handle);
            if (l != null) {
                return l.longValue();
            }
            StringBuilder sb = new StringBuilder();
            ...
            if (this.mTagsToViewManagers.get(view.getId()) != null) {
                ...
                if ((view instanceof ViewGroup) && (viewManager instanceof ViewGroupManager)) {
                    ...
                    for (int childCount = viewGroupManager.getChildCount(viewGroup) - 1; childCount >= 0; childCount--) {
                        ...
                        if (childAt == null) {
                            FLog.m44e(TAG, "Unable to drop null child view");
