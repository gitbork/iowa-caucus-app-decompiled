...
public class LayoutShadowNode extends ReactShadowNodeImpl {
    ...
    private final MutableYogaValue mTempYogaValue = new MutableYogaValue((C08041) null);
    ...
    static /* synthetic */ class C08041 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.uimanager.LayoutShadowNode.C08041.<clinit>():void");
        }
    }
    ...
    private static class MutableYogaValue {
        ...
        /* synthetic */ MutableYogaValue(C08041 r1) {
            this();
        }
    ...
    public void setWidth(Dynamic dynamic) {
        if (!isVirtual()) {
            ...
            int i = C08041.$SwitchMap$com$facebook$yoga$YogaUnit[this.mTempYogaValue.unit.ordinal()];
            if (i == 1 || i == 2) {
    ...
    public void setMargins(int i, Dynamic dynamic) {
        if (!isVirtual()) {
            ...
            this.mTempYogaValue.setFromDynamic(dynamic);
            int i2 = C08041.$SwitchMap$com$facebook$yoga$YogaUnit[this.mTempYogaValue.unit.ordinal()];
            if (i2 == 1 || i2 == 2) {
