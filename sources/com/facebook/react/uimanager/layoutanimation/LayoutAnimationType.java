...
enum LayoutAnimationType {
    ...
    static /* synthetic */ class C08271 {
        ...
        static final /* synthetic */ int[] f61x364296ff = null;
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f61x364296ff = r0
                int[] r0 = f61x364296ff     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f61x364296ff     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                int[] r0 = f61x364296ff     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.uimanager.layoutanimation.LayoutAnimationType.C08271.<clinit>():void");
        }
    }

    public static String toString(LayoutAnimationType layoutAnimationType) {
        int i = C08271.f61x364296ff[layoutAnimationType.ordinal()];
        if (i == 1) {
            return "create";
        }
        if (i == 2) {
