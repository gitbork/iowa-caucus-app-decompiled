...
abstract class BaseLayoutAnimation extends AbstractLayoutAnimation {
    ...
    static /* synthetic */ class C08231 {
        ...
        static final /* synthetic */ int[] f60x36728427 = new int[AnimatedPropertyType.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f60x36728427 = r0
                int[] r0 = f60x36728427     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f60x36728427     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                int[] r0 = f60x36728427     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                int[] r0 = f60x36728427     // Catch:{ NoSuchFieldError -> 0x0035 }
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.uimanager.layoutanimation.BaseLayoutAnimation.C08231.<clinit>():void");
        }
    }
    ...
    public Animation createAnimationImpl(View view, int i, int i2, int i3, int i4) {
        if (this.mAnimatedProperty != null) {
            int i5 = C08231.f60x36728427[this.mAnimatedProperty.ordinal()];
            float f = 0.0f;
            if (i5 == 1) {
