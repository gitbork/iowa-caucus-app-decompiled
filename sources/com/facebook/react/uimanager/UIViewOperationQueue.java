...
public class UIViewOperationQueue {
    ...
    private class DispatchUIFrameCallback extends GuardedFrameCallback {
        ...
        public void doFrameGuarded(long j) {
            if (UIViewOperationQueue.this.mIsInIllegalUIState) {
                FLog.m84w(ReactConstants.TAG, "Not flushing pending UI operations because of previously thrown Exception");
                return;
            }
    ...
    private final class UpdateLayoutOperation extends ViewOperation {
        ...
        /* renamed from: mX */
        private final int f57mX;

        /* renamed from: mY */
        private final int f58mY;
        ...
        public void execute() {
            ...
            UIViewOperationQueue.this.mNativeViewHierarchyManager.updateLayout(this.mParentTag, this.mTag, this.f57mX, this.f58mY, this.mWidth, this.mHeight);
        }
    }
    ...
    public void enqueueManageChildren(int i, @Nullable int[] iArr, @Nullable ViewAtIndex[] viewAtIndexArr, @Nullable int[] iArr2, @Nullable int[] iArr3) {
        ArrayList<UIOperation> arrayList = this.mOperations;
        ManageChildrenOperation manageChildrenOperation = new ManageChildrenOperation(i, iArr, viewAtIndexArr, iArr2, iArr3);
    ...
    public void dispatchViewUpdates(int r19, long r20, long r22) {
        ...
        L_0x0051:
            ...
            com.facebook.systrace.SystraceMessage$Builder r0 = r1.arg(r4, r0)     // Catch:{ all -> 0x009e }
    ...
    public void flushPendingBatches() {
        /*
            ...
            com.facebook.common.logging.FLog.m84w(r0, r1)
            return
        L_0x000c:
