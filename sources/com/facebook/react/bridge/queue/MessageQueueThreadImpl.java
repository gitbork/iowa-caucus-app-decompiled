...
public class MessageQueueThreadImpl implements MessageQueueThread {
    ...
    static /* synthetic */ class C06595 {

        /* renamed from: $SwitchMap$com$facebook$react$bridge$queue$MessageQueueThreadSpec$ThreadType */
        static final /* synthetic */ int[] f46x16463f8b = new int[ThreadType.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f46x16463f8b = r0
                int[] r0 = f46x16463f8b     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f46x16463f8b     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.bridge.queue.MessageQueueThreadImpl.C06595.<clinit>():void");
        }
    }
    ...
    public static MessageQueueThreadImpl create(MessageQueueThreadSpec messageQueueThreadSpec, QueueThreadExceptionHandler queueThreadExceptionHandler) {
        int i = C06595.f46x16463f8b[messageQueueThreadSpec.getThreadType().ordinal()];
        if (i == 1) {
