...
public class CatalystInstanceImpl implements CatalystInstance {
    ...
    public void invokeCallback(int i, NativeArrayInterface nativeArrayInterface) {
        if (this.mDestroyed) {
            FLog.m84w(ReactConstants.TAG, "Invoking JS callback after bridge has been destroyed.");
        } else {
    ...
    public NativeModule getNativeModule(String str) {
        ...
        if (turboModuleRegistry != null) {
            TurboModule module = turboModuleRegistry.getModule(str);
            if (module != null) {
    ...
    public Collection<NativeModule> getNativeModules() {
        ...
        TurboModuleRegistry turboModuleRegistry = this.mTurboModuleRegistry;
        if (turboModuleRegistry != null) {
            for (TurboModule turboModule : turboModuleRegistry.getModules()) {
                arrayList.add((NativeModule) turboModule);
            }
        }
        return arrayList;
    }
