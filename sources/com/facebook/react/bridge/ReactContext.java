...
public class ReactContext extends ContextWrapper {
    ...
    static /* synthetic */ class C06522 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.bridge.ReactContext.C06522.<clinit>():void");
        }
    }
    ...
    public void addLifecycleEventListener(final LifecycleEventListener lifecycleEventListener) {
        ...
        if (hasActiveCatalystInstance()) {
            int i = C06522.$SwitchMap$com$facebook$react$common$LifecycleState[this.mLifecycleState.ordinal()];
            if (i != 1 && i != 2) {
                if (i == 3) {
    ...
    public void onWindowFocusChange(boolean z) {
        UiThreadUtil.assertOnUiThread();
        Iterator it = this.mWindowFocusEventListeners.iterator();
        while (it.hasNext()) {
            try {
                ((WindowFocusChangeListener) it.next()).onWindowFocusChange(z);
            } catch (RuntimeException e) {
                handleException(e);
            }
        }
