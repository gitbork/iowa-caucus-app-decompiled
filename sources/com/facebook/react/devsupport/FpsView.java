...
public class FpsView extends FrameLayout {
    ...
    private final TextView mTextView = ((TextView) findViewById(C0575R.C0577id.fps_text));
    ...
    public FpsView(ReactContext reactContext) {
        super(reactContext);
        inflate(reactContext, C0575R.layout.fps_view, this);
    ...
    public void setCurrentFPS(double d, double d2, int i, int i2) {
        ...
        FLog.m32d(ReactConstants.TAG, format);
    }
}
