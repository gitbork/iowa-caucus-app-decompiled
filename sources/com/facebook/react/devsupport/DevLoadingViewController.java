...
public class DevLoadingViewController {
    ...
    public void showForUrl(String str) {
        ...
        if (context != null) {
            try {
                URL url = new URL(str);
                int i = C0575R.string.catalyst_loading_from_url;
                ...
                FLog.m44e(ReactConstants.TAG, sb2.toString());
            }
        }
    }
    ...
    public void showForRemoteJSEnabled() {
        Context context = getContext();
        if (context != null) {
            showMessage(context.getString(C0575R.string.catalyst_debug_connecting));
        }
    }
    ...
    public void showInternal(String str) {
        ...
        if (popupWindow == null || !popupWindow.isShowing()) {
            ...
            if (currentActivity == null) {
                FLog.m44e(ReactConstants.TAG, "Unable to display loading message because react activity isn't available");
                return;
            }
            Rect rect = new Rect();
            currentActivity.getWindow().getDecorView().getWindowVisibleDisplayFrame(rect);
            int i = rect.top;
            this.mDevLoadingView = (TextView) ((LayoutInflater) currentActivity.getSystemService("layout_inflater")).inflate(C0575R.layout.dev_loading_view, null);
