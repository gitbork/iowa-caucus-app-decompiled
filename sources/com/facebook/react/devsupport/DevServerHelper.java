...
public class DevServerHelper {
    ...
    public void openPackagerConnection(final String str, final PackagerCommandListener packagerCommandListener) {
        if (this.mPackagerClient != null) {
            FLog.m84w(ReactConstants.TAG, "Packager connection already open, nooping.");
        } else {
            new AsyncTask<Void, Void, Void>() {
                ...
                public Void doInBackground(Void... voidArr) {
                    ...
                    C06734 r0 = new ConnectionCallback() {
    ...
    public void openInspectorConnection() {
        if (this.mInspectorPackagerConnection != null) {
            FLog.m84w(ReactConstants.TAG, "Inspector connection already open, nooping.");
        } else {
            new AsyncTask<Void, Void, Void>() {
                /* access modifiers changed from: protected */
                public Void doInBackground(Void... voidArr) {
        ...
        new AsyncTask<Void, String, Boolean>() {
            ...
            public boolean doSync() {
                try {
                    ...
                    FLog.m45e(ReactConstants.TAG, "Failed to send attach request to Inspector", (Throwable) e);
                    return false;
                }
            }
            ...
            public void onPostExecute(Boolean bool) {
                if (!bool.booleanValue()) {
                    Toast.makeText(context, context.getString(C0575R.string.catalyst_debug_nuclide_error), 1).show();
                }
            }
        }.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new Void[0]);
    }
        ...
        this.mClient.newCall(new Request.Builder().url(createPackagerStatusURL(this.mSettings.getPackagerConnectionSettings().getDebugServerHost())).build()).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (!isSuccessful) {
                    ...
                    FLog.m44e(str, sb.toString());
                    packagerStatusCallback.onPackagerStatusFetched(false);
                    return;
                }
                ResponseBody body = response.body();
                if (body == null) {
                    FLog.m44e(str, "Got null body response from packager when requesting status");
                    packagerStatusCallback.onPackagerStatusFetched(false);
                    return;
                }
        ...
        ((OkHttpClient) Assertions.assertNotNull(this.mOnChangePollingClient)).newCall(new Request.Builder().url(createOnChangeEndpointUrl()).tag(this).build()).enqueue(new Callback() {
            public void onFailure(Call call, IOException iOException) {
                if (DevServerHelper.this.mOnChangePollingEnabled) {
                    FLog.m37d(ReactConstants.TAG, "Error while requesting /onchange endpoint", (Throwable) iOException);
    ...
    public java.io.File downloadBundleResourceFromUrlSync(java.lang.String r6, java.io.File r7) {
        ...
        L_0x0031:
            return r1
        L_0x0032:
            okio.Sink r2 = okio.Okio.sink(r7)     // Catch:{ all -> 0x0052 }
        ...
        L_0x006f:
            ...
            com.facebook.common.logging.FLog.m46e(r6, r7, r2)
            return r1
        */
