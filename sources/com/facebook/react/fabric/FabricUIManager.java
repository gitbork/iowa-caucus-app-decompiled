...
public class FabricUIManager implements UIManager, LifecycleEventListener {
    ...
    private class DispatchUIFrameCallback extends GuardedFrameCallback {
        ...
        public void doFrameGuarded(long j) {
            ...
            if (!access$100) {
                FLog.m84w(str, "Not flushing pending UI operations because of previously thrown Exception");
                return;
            }
            try {
                ...
                FLog.m61i(str, "Exception thrown when executing UIFrameGuarded", (Throwable) e);
    ...
    public <T extends View> int addRootView(T t, WritableMap writableMap, @Nullable String str) {
        ...
        if (DEBUG) {
            FLog.m34d(TAG, "Starting surface for module: %s and reactTag: %d", (Object) jSModuleName, (Object) Integer.valueOf(nextRootViewTag));
        }
    ...
    public <T extends View> int startSurface(T t, String str, WritableMap writableMap, int i, int i2) {
        ...
        ThemedReactContext themedReactContext = new ThemedReactContext(this.mReactApplicationContext, t.getContext());
        if (DEBUG) {
            FLog.m34d(TAG, "Starting surface for module: %s and reactTag: %d", (Object) str, (Object) Integer.valueOf(nextRootViewTag));
        }
        this.mMountingManager.addRootView(nextRootViewTag, t);
        this.mReactContextForRootTag.put(Integer.valueOf(nextRootViewTag), themedReactContext);
    ...
    public void onCatalystInstanceDestroy() {
        if (DEBUG) {
            FLog.m32d(TAG, "Destroying Catalyst Instance");
        }
    ...
    private void preallocateView(int i, int i2, String str, @Nullable ReadableMap readableMap, @Nullable Object obj, boolean z) {
        ...
        synchronized (this.mPreMountItemsLock) {
            ...
            PreAllocateViewMountItem preAllocateViewMountItem = new PreAllocateViewMountItem(themedReactContext, i, i2, fabricComponentName, readableMap, (StateWrapper) obj, z);
            arrayDeque.add(preAllocateViewMountItem);
        }
    }
    ...
    private MountItem createMountItem(String str, @Nullable ReadableMap readableMap, @Nullable Object obj, int i, int i2, boolean z) {
        ...
        if (themedReactContext != null) {
            CreateMountItem createMountItem = new CreateMountItem(themedReactContext, i, i2, fabricComponentName, readableMap, (StateWrapper) obj, z);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x0057, code lost:
        ((com.facebook.react.fabric.mounting.mountitems.MountItem) r0.pollFirst()).execute(r9.mMountingManager);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x008c, code lost:
        r1 = (com.facebook.react.fabric.mounting.mountitems.MountItem) r0.next();
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x0096, code lost:
        ...
        r7.append("dispatchMountItems: Executing mountItem: ");
        r7.append(r1);
        com.facebook.common.logging.FLog.m32d(r6, r7.toString());
     */
    ...
    public void dispatchMountItems() {
        ...
        L_0x0086:
            ...
            com.facebook.common.logging.FLog.m32d(r6, r7)
        L_0x00ac:
        ...
        while (true) {
            ...
            synchronized (this.mPreMountItemsLock) {
                if (!this.mPreMountItems.isEmpty()) {
                    mountItem = (MountItem) this.mPreMountItems.pollFirst();
                }
            }
    ...
    public void updateRootLayoutSpecs(int i, int i2, int i3) {
        if (DEBUG) {
            FLog.m32d(TAG, "Updating Root Layout Specs");
        }
