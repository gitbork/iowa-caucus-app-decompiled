...
public final class CloseableReference<T> implements Cloneable, Closeable {
    ...
    private static final LeakHandler DEFAULT_LEAK_HANDLER = new LeakHandler() {
        ...
        public void reportLeak(SharedReference<Object> sharedReference, @Nullable Throwable th) {
            FLog.m82w(CloseableReference.TAG, "Finalized without closing: %x %x (type = %s)", Integer.valueOf(System.identityHashCode(this)), Integer.valueOf(System.identityHashCode(sharedReference)), sharedReference.get().getClass().getName());
        }
    };
    ...
    /* renamed from: of */
    public static <T extends Closeable> CloseableReference<T> m108of(@PropagatesNullable T t) {
        return m110of(t, DEFAULT_CLOSEABLE_RELEASER);
    }

    /* renamed from: of */
    public static <T extends Closeable> CloseableReference<T> m109of(@PropagatesNullable T t, LeakHandler leakHandler) {
        Throwable th = null;
        if (t == null) {
            return null;
        }
    ...
    /* renamed from: of */
    public static <T> CloseableReference<T> m110of(@PropagatesNullable T t, ResourceReleaser<T> resourceReleaser) {
        return m111of(t, resourceReleaser, DEFAULT_LEAK_HANDLER);
    }

    /* renamed from: of */
    public static <T> CloseableReference<T> m111of(@PropagatesNullable T t, ResourceReleaser<T> resourceReleaser, LeakHandler leakHandler) {
        Throwable th = null;
        if (t == null) {
            return null;
        }
