...
public final class BitmapUtil {
    ...
    static /* synthetic */ class C05621 {
        ...
        static {
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.imageutils.BitmapUtil.C05621.<clinit>():void");
        }
    }
    ...
    public static int getPixelSizeForBitmapConfig(Config config) {
        int i = C05621.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()];
        if (i == 1) {
            return 4;
        }
        if (i == 2) {
