...
public class HeifExifUtil {
    ...
    private static class HeifExifUtilAndroidN {
        ...
        static int getOrientation(InputStream inputStream) {
            try {
                ...
                FLog.m37d(HeifExifUtil.TAG, "Failed reading Heif Exif orientation -> ignoring", (Throwable) e);
                return 0;
            }
        }
    }
    ...
    public static int getOrientation(InputStream inputStream) {
        ...
        FLog.m32d(TAG, "Trying to read Heif Exif information before Android N -> ignoring");
        return 0;
    }
}
