...
public class WebpUtil {
    ...
    private static Pair<Integer, Integer> getVP8LDimension(InputStream inputStream) throws IOException {
        ...
        byte read = ((byte) inputStream.read()) & UnsignedBytes.MAX_VALUE;
        return new Pair<>(Integer.valueOf(((((byte) inputStream.read()) & UnsignedBytes.MAX_VALUE) | ((read & 63) << 8)) + 1), Integer.valueOf(((((((byte) inputStream.read()) & UnsignedBytes.MAX_VALUE) & Ascii.f158SI) << 10) | ((((byte) inputStream.read()) & UnsignedBytes.MAX_VALUE) << 2) | ((read & 192) >> 6)) + 1));
    }
    ...
    private static int getInt(InputStream inputStream) throws IOException {
        return ((((byte) inputStream.read()) << Ascii.CAN) & Ascii.NUL) | ((((byte) inputStream.read()) << Ascii.DLE) & Ascii.NUL) | ((((byte) inputStream.read()) << 8) & Ascii.NUL) | (((byte) inputStream.read()) & UnsignedBytes.MAX_VALUE);
    }

    public static int get2BytesAsInt(InputStream inputStream) throws IOException {
        return ((((byte) inputStream.read()) << 8) & Ascii.NUL) | (((byte) inputStream.read()) & UnsignedBytes.MAX_VALUE);
    }

    private static int read3Bytes(InputStream inputStream) throws IOException {
        byte b = getByte(inputStream);
        return ((getByte(inputStream) << Ascii.DLE) & Ascii.NUL) | ((getByte(inputStream) << 8) & Ascii.NUL) | (b & UnsignedBytes.MAX_VALUE);
    }
