...
public class MemoryPooledByteBufferOutputStream extends PooledByteBufferOutputStream {
    ...
    public MemoryPooledByteBufferOutputStream(MemoryChunkPool memoryChunkPool, int i) {
        ...
        this.mCount = 0;
        this.mBufRef = CloseableReference.m110of(this.mPool.get(i), (ResourceReleaser<T>) this.mPool);
    }
    ...
    public void realloc(int i) {
        ...
        if (i > ((MemoryChunk) this.mBufRef.get()).getSize()) {
            ...
            this.mBufRef.close();
            this.mBufRef = CloseableReference.m110of(memoryChunk, (ResourceReleaser<T>) this.mPool);
        }
    }
