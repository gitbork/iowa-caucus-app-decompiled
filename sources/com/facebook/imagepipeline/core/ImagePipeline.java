...
public class ImagePipeline {
    ...
    static /* synthetic */ class C05088 {

        /* renamed from: $SwitchMap$com$facebook$imagepipeline$request$ImageRequest$CacheChoice */
        static final /* synthetic */ int[] f40x9ce557aa = new int[CacheChoice.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f40x9ce557aa = r0
                int[] r0 = f40x9ce557aa     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f40x9ce557aa     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.imagepipeline.core.ImagePipeline.C05088.<clinit>():void");
        }
    }
    ...
    public Supplier<DataSource<CloseableReference<CloseableImage>>> getDataSourceSupplier(ImageRequest imageRequest, Object obj, RequestLevel requestLevel, @Nullable RequestListener requestListener) {
        ...
        C05022 r0 = new Supplier<DataSource<CloseableReference<CloseableImage>>>() {
            public DataSource<CloseableReference<CloseableImage>> get() {
    ...
    public DataSource<Void> prefetchToBitmapCache(ImageRequest imageRequest, Object obj) {
        ...
        try {
            ...
            boolean z = shouldDecodePrefetches != null ? !shouldDecodePrefetches.booleanValue() : ((Boolean) this.mSuppressBitmapPrefetchingSupplier.get()).booleanValue();
            if (z) {
    ...
    public void clearMemoryCaches() {
        C05044 r0 = new Predicate<CacheKey>() {
    ...
    public boolean isInDiskCacheSync(ImageRequest imageRequest) {
        CacheKey encodedCacheKey = this.mCacheKeyFactory.getEncodedCacheKey(imageRequest, null);
        int i = C05088.f40x9ce557aa[imageRequest.getCacheChoice().ordinal()];
        if (i == 1) {
