...
public abstract class PlatformBitmapFactory {
    ...
    static /* synthetic */ class C04851 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.imagepipeline.bitmaps.PlatformBitmapFactory.C04851.<clinit>():void");
        }
    }
    ...
    private static Config getSuitableBitmapConfig(Bitmap bitmap) {
        ...
        int i = C04851.$SwitchMap$android$graphics$Bitmap$Config[config2.ordinal()];
        if (i == 1) {
