...
public abstract class DefaultDecoder implements PlatformDecoder {
    ...
    public CloseableReference<Bitmap> decodeStaticImageFromStream(InputStream inputStream, Options options, @Nullable Rect rect) {
        return decodeFromStream(inputStream, options, rect, null);
    }

    /* JADX WARNING: Code restructure failed: missing block: B:44:?, code lost:
        com.facebook.common.logging.FLog.m42e(TAG, "Could not decode region %s, decoding full bitmap instead.", r11);
     */
    ...
    private com.facebook.common.references.CloseableReference<android.graphics.Bitmap> decodeFromStream(java.io.InputStream r9, android.graphics.BitmapFactory.Options r10, @javax.annotation.Nullable android.graphics.Rect r11, @javax.annotation.Nullable android.graphics.ColorSpace r12) {
        ...
        L_0x008e:
            ...
            com.facebook.common.logging.FLog.m42e(r1, r3, r4)     // Catch:{ all -> 0x009f }
        ...
        L_0x00c5:
            com.facebook.imagepipeline.memory.BitmapPool r9 = r8.mBitmapPool
            com.facebook.common.references.CloseableReference r9 = com.facebook.common.references.CloseableReference.m110of(r11, r9)
            return r9
        L_0x00cc:
            r9 = move-exception
            goto L_0x00f8
        ...
        L_0x00df:
            ...
            com.facebook.common.references.CloseableReference r9 = com.facebook.common.references.CloseableReference.m110of(r9, r11)     // Catch:{ IOException -> 0x00f7 }
