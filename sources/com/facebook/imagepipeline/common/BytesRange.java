...
public class BytesRange {
    ...
    public String toHttpRangeHeaderValue() {
        return String.format(null, "bytes=%s-%s", new Object[]{valueOrEmpty(this.from), valueOrEmpty(this.f39to)});
    }
    ...
    public boolean contains(@Nullable BytesRange bytesRange) {
        ...
        if (this.from <= bytesRange.from && this.f39to >= bytesRange.f39to) {
            z = true;
        }
        return z;
    }
    ...
    public String toString() {
        return String.format(null, "%s-%s", new Object[]{valueOrEmpty(this.from), valueOrEmpty(this.f39to)});
    }
    ...
    public int hashCode() {
        return HashCodeUtil.hashCode(this.from, this.f39to);
    }
