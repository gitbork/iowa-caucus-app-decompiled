...
import com.fasterxml.jackson.core.p005io.CharTypes;
...
public class UTF8DataInputJsonParser extends ParserBase {
    ...
    public char[] getTextCharacters() throws IOException {
        ...
        int id = this._currToken.mo13385id();
        if (id != 5) {
            if (id != 6) {
                if (!(id == 7 || id == 8)) {
    ...
    public int _readBinary(com.fasterxml.jackson.core.Base64Variant r12, java.io.OutputStream r13, byte[] r14) throws java.io.IOException {
        ...
        L_0x0006:
            ...
            goto L_0x00d2
        L_0x001c:
            int r6 = r11._decodeBase64Escape(r12, r5, r2)
            if (r6 >= 0) goto L_0x0023
            goto L_0x0006
        L_0x0023:
        ...
        L_0x002a:
            java.io.DataInput r5 = r11._inputData
            int r5 = r5.readUnsignedByte()
            int r8 = r12.decodeBase64Char(r5)
            if (r8 >= 0) goto L_0x003b
            r8 = 1
            int r8 = r11._decodeBase64Escape(r12, r5, r8)
        L_0x003b:
            int r5 = r6 << 6
            r5 = r5 | r8
            java.io.DataInput r6 = r11._inputData
            int r6 = r6.readUnsignedByte()
            int r8 = r12.decodeBase64Char(r6)
            r9 = 2
            r10 = -2
        ...
        L_0x0060:
            ...
            goto L_0x00d2
        L_0x0063:
            int r6 = r11._decodeBase64Escape(r12, r6, r9)
            r8 = r6
        L_0x0068:
            ...
            int r7 = r11._decodeBase64Escape(r12, r6, r1)
        ...
        L_0x00da:
            return r3
        L_0x00db:
            int r6 = r11._decodeBase64Escape(r12, r6, r1)
            r8 = r6
        L_0x00e0:
    ...
    public final String parseEscapedName(int[] iArr, int i, int i2, int i3, int i4) throws IOException {
        ...
        while (true) {
            if (iArr2[i3] != 0) {
                ...
                if (i3 != 92) {
                    _throwUnquotedSpace(i3, ConditionalUserProperty.NAME);
                } else {
                    i3 = _decodeEscaped();
                }
                if (i3 > 127) {
                    ...
                    if (i3 < 2048) {
                        ...
                        int i6 = (r8 << 8) | (i3 >> 12) | CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY;
                        int i7 = r10 + 1;
                        if (i7 >= 4) {
                            if (i >= iArr.length) {
                                iArr = _growArrayBy(iArr, iArr.length);
        ...
        while (readUnsignedByte != 39) {
            if (!(readUnsignedByte == 34 || iArr2[readUnsignedByte] == 0)) {
                if (readUnsignedByte != 92) {
                    _throwUnquotedSpace(readUnsignedByte, ConditionalUserProperty.NAME);
                } else {
                ...
                if (readUnsignedByte > 127) {
                    ...
                    if (readUnsignedByte < 2048) {
                        ...
                        int i8 = (i << 8) | (readUnsignedByte >> 12) | CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY;
                        int i9 = i2 + 1;
                        if (i9 >= 4) {
                            if (i5 >= iArr3.length) {
    ...
    public final byte[] _decodeBase64(Base64Variant base64Variant) throws IOException {
        ...
        sb.append("'");
        throw reportInvalidBase64Char(base64Variant, readUnsignedByte, 3, sb.toString());
    }
