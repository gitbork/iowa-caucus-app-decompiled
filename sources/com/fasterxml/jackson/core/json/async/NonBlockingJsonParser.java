...
public class NonBlockingJsonParser extends NonBlockingJsonParserBase implements ByteArrayFeeder {
    ...
    private final JsonToken _parseEscapedName(int i, int i2, int i3) throws IOException {
        ...
        while (this._inputPtr < this._inputEnd) {
            ...
            if (iArr2[i6] == 0) {
                ...
                if (i6 != 92) {
                    _throwUnquotedSpace(i6, ConditionalUserProperty.NAME);
                } else {
                ...
                if (i6 > 127) {
                    ...
                    if (i6 < 2048) {
                        ...
                        int i9 = (i2 << 8) | (i6 >> 12) | CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY;
                        int i10 = i3 + 1;
                        if (i10 >= 4) {
                            int i11 = i + 1;
                            iArr[i] = i9;
    ...
    private JsonToken _finishAposName(int i, int i2, int i3) throws IOException {
        ...
        while (this._inputPtr < this._inputEnd) {
            ...
            if (!(i5 == 34 || iArr2[i5] == 0)) {
                if (i5 != 92) {
                    _throwUnquotedSpace(i5, ConditionalUserProperty.NAME);
                } else {
                ...
                if (i5 > 127) {
                    ...
                    if (i5 < 2048) {
                        ...
                        int i8 = (r10 << 8) | (i5 >> 12) | CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY;
                        int i9 = r11 + 1;
                        if (i9 >= 4) {
                            if (i >= iArr.length) {
                                int[] growArrayBy = growArrayBy(iArr, iArr.length);
                ...
                if (iArr[i5] == 0) {
                    ...
                    if (i4 >= i3) {
                        ...
                        if (i8 == 1) {
                            ...
                            int i10 = i4 + 1;
                            int i11 = i10 + 1;
                            i5 = _decodeUTF8_3(i5, bArr2[i4], bArr2[i10]);
                            i = i11;
                        } else if (i8 != 4) {
                            if (i5 < 32) {
                            ...
                            int i13 = i12 + 1;
                            int i14 = i13 + 1;
                            int _decodeUTF8_4 = _decodeUTF8_4(i5, bArr3[i4], bArr3[i12], bArr3[i13]);
