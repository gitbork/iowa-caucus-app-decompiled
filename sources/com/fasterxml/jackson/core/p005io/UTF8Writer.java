...
public final class UTF8Writer extends Writer {
    ...
    public void write(char[] cArr, int i, int i2) throws IOException {
        ...
        while (r9 < i6) {
            ...
            if (c < 2048) {
                int i12 = i4 + 1;
                bArr[i4] = (byte) ((c >> 6) | JfifUtil.MARKER_SOFn);
                i4 = i12 + 1;
                bArr[i12] = (byte) ((c & '?') | 128);
                r9 = i7;
            } else if (c < 55296 || c > 57343) {
                int i13 = i4 + 1;
                bArr[i4] = (byte) ((c >> 12) | CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY);
                int i14 = i13 + 1;
    ...
    public void write(String str, int i, int i2) throws IOException {
        ...
        while (r9 < i6) {
            ...
            if (charAt < 2048) {
                int i12 = i4 + 1;
                bArr[i4] = (byte) ((charAt >> 6) | JfifUtil.MARKER_SOFn);
                i4 = i12 + 1;
                bArr[i12] = (byte) ((charAt & '?') | 128);
                r9 = i7;
            } else if (charAt < 55296 || charAt > 57343) {
                int i13 = i4 + 1;
                bArr[i4] = (byte) ((charAt >> 12) | CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY);
                int i14 = i13 + 1;
