...
public class CipherStorageKeystoreAESCBC implements CipherStorage {
    ...
    public boolean supportsSecureHardware() {
        String str = "Unable to remove temp key from keychain";
        String str2 = "KeystoreAESCBC";
        String str3 = "AndroidKeyStore#supportsSecureHardware";
        try {
            boolean validateKeySecurityLevel = validateKeySecurityLevel(SecurityLevel.SECURE_HARDWARE, tryGenerateRegularSecurityKey(str3));
            try {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x003c, code lost:
        ...
        r6.append("Unknown error: ");
        r6.append(r4.getMessage());
     */
    /* JADX WARNING: Code restructure failed: missing block: B:19:0x0056, code lost:
        throw new com.oblador.keychain.exceptions.CryptoFailedException(r6.toString(), r4);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x005a, code lost:
        ...
        r7.append("Could not access Keystore for service ");
        r7.append(r4);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:22:0x0070, code lost:
        throw new com.oblador.keychain.exceptions.CryptoFailedException(r7.toString(), r5);
     */
    ...
    public DecryptionResult decrypt(@NonNull String str, @NonNull byte[] bArr, @NonNull byte[] bArr2) throws CryptoFailedException {
        try {
            ...
            if (key != null) {
                return new DecryptionResult(decryptBytes(key, bArr), decryptBytes(key, bArr2), getSecurityLevel((SecretKey) key));
            }
            ...
            throw new CryptoFailedException(sb.toString(), e3);
        }
    }
    ...
    public void removeKey(@NonNull String str) throws KeyStoreAccessException {
        ...
        try {
            ...
            throw new KeyStoreAccessException(sb.toString(), e2);
        }
    }
    ...
    private byte[] encryptString(Key key, String str, String str2) throws CryptoFailedException {
        try {
            ...
            StringBuilder sb = new StringBuilder();
            sb.append("Could not encrypt value for service ");
            sb.append(str);
            sb.append(", message: ");
    ...
    private String decryptBytes(Key key, byte[] bArr) throws CryptoFailedException {
        try {
            ...
            StringBuilder sb = new StringBuilder();
            sb.append("Could not decrypt bytes: ");
            sb.append(e.getMessage());
            throw new CryptoFailedException(sb.toString(), e);
        }
    }
    ...
    private SecretKey tryGenerateStrongBoxSecurityKey(String str) throws NoSuchAlgorithmException, InvalidAlgorithmParameterException, NoSuchProviderException {
        ...
        try {
            ...
            if (e instanceof StrongBoxUnavailableException) {
                Log.i(str2, "StrongBox is unavailable on this device");
            } else {
                StringBuilder sb = new StringBuilder();
                sb.append("An error occurred when trying to generate a StrongBoxSecurityKey: ");
                sb.append(e.getMessage());
    ...
    @TargetApi(23)
    private Builder getKeyGenSpecBuilder(String str) {
        return new Builder(str, 3).setBlockModes(new String[]{ENCRYPTION_BLOCK_MODE}).setEncryptionPaddings(new String[]{ENCRYPTION_PADDING}).setRandomizedEncryptionRequired(true).setKeySize(256);
    }
}
