...
class TSpanView extends TextView {
    ...
    static /* synthetic */ class C18211 {
        ...
        static {
            ...
            L_0x0106:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.horcrux.svg.TSpanView.C18211.<clinit>():void");
        }
    }
    ...
    private void drawWrappedText(Canvas canvas, Paint paint) {
        ...
        int i = C18211.$SwitchMap$com$horcrux$svg$TextProperties$TextAnchor[font.textAnchor.ordinal()];
        if (i == 2) {
        ...
        if (VERSION.SDK_INT < 23) {
            ...
            staticLayout = Builder.obtain(spannableString, 0, spannableString.length(), textPaint, (int) fromRelative).setAlignment(alignment).setLineSpacing(0.0f, 1.0f).setIncludePad(true).setBreakStrategy(1).setHyphenationFrequency(1).build();
        }
        ...
        Double.isNaN(d);
        float f = (float) (nextY + d);
        popGlyphContext();
        canvas.save();
        canvas2.translate(nextX, f);
    ...
    private void applySpacingAndFeatures(Paint paint, FontData fontData) {
        if (VERSION.SDK_INT >= 21) {
            ...
            if (d == 0.0d && fontData.fontVariantLigatures == FontVariantLigatures.normal) {
                StringBuilder sb = new StringBuilder();
                sb.append("'rlig', 'liga', 'clig', 'calt', 'locl', 'ccmp', 'mark', 'mkmk','kern', 'hlig', 'cala', ");
                sb.append(fontData.fontFeatureSettings);
                ...
                sb2.append(fontData.fontFeatureSettings);
                paint.setFontFeatureSettings(sb2.toString());
            }
            if (VERSION.SDK_INT >= 26) {
                StringBuilder sb3 = new StringBuilder();
                sb3.append(fontWeightTag);
                sb3.append(fontData.absoluteFontWeight);
                sb3.append(fontData.fontVariationSettings);
                paint.setFontVariationSettings(sb3.toString());
            }
        }
    }
    ...
    private android.graphics.Path getLinePath(java.lang.String r73, android.graphics.Paint r74, android.graphics.Canvas r75) {
        ...
        L_0x0160:
            ...
            int[] r7 = com.horcrux.svg.TSpanView.C18211.$SwitchMap$com$horcrux$svg$TextProperties$TextLengthAdjust
        ...
        L_0x01af:
            ...
            int[] r35 = com.horcrux.svg.TSpanView.C18211.$SwitchMap$com$horcrux$svg$TextProperties$AlignmentBaseline
            int r36 = r15.ordinal()
            r35 = r35[r36]
            switch(r35) {
        ...
        L_0x023c:
            ...
            int[] r3 = com.horcrux.svg.TSpanView.C18211.$SwitchMap$com$horcrux$svg$TextProperties$AlignmentBaseline
            int r8 = r15.ordinal()
            r3 = r3[r8]
            r8 = 14
    ...
    private double getTextAnchorOffset(TextAnchor textAnchor, double d) {
        int i = C18211.$SwitchMap$com$horcrux$svg$TextProperties$TextAnchor[textAnchor.ordinal()];
        if (i == 2) {
            return (-d) / 2.0d;
        }
        if (i != 3) {
