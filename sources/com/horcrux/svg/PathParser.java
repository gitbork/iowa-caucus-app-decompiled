...
class PathParser {
    ...
    /* renamed from: i */
    private static int f413i;

    /* renamed from: l */
    private static int f414l;
    ...
    private static void arcTo(float f, float f2, float f3, boolean z, boolean z2, float f4, float f5) {
        ...
        float f9 = mPenX;
        float f10 = mPenY;
        float f11 = f2 == 0.0f ? f == 0.0f ? f5 - f10 : f : f2;
        ...
        float f33 = f12 - f8;
        float f34 = f13 - f7;
        float atan22 = (float) Math.atan2((double) ((f26 * f33) + (f27 * f34)), (double) ((f24 * f33) + (f25 * f34)));
        float f35 = f8 + f9;
        float f36 = f7 + f10;
        float f37 = f12 + f9;
        float f38 = f13 + f10;
        ...
        if (f31 == f30 && f32 == 0.0f) {
            ...
            float f39 = f35 - f31;
            float f40 = mScale;
            mPath.arcTo(new RectF(f39 * f40, (f36 - f31) * f40, (f35 + f31) * f40, (f36 + f31) * f40), degrees, abs3);
            elements.add(new PathElement(ElementType.kCGPathElementAddCurveToPoint, new Point[]{new Point((double) f37, (double) f38)}));
        } else {
            arcToBezier(f35, f36, f31, f30, atan2, atan22, z2, f32);
        }
    }
    ...
    private static void skip_spaces() {
        while (true) {
            int i = f413i;
            if (i < f414l && Character.isWhitespace(f415s.charAt(i))) {
                f413i++;
            } else {
                return;
            }
    ...
    private static boolean parse_flag() {
        skip_spaces();
        char charAt = f415s.charAt(f413i);
        if (charAt == '0' || charAt == '1') {
            f413i++;
            int i = f413i;
            if (i < f414l && f415s.charAt(i) == ',') {
                f413i++;
            }
            skip_spaces();
            if (charAt == '1') {
    ...
    private static float parse_number() {
        ...
        if (i != f414l) {
            char charAt = f415s.charAt(i);
            if (charAt == '-' || charAt == '+') {
                f413i++;
                charAt = f415s.charAt(f413i);
            }
            if (charAt >= '0' && charAt <= '9') {
                skip_digits();
                int i2 = f413i;
                if (i2 < f414l) {
                    charAt = f415s.charAt(i2);
                }
            } else if (charAt != '.') {
                throw new Error(str);
            }
            if (charAt == '.') {
                ...
                int i3 = f413i;
                if (i3 < f414l) {
                    charAt = f415s.charAt(i3);
                }
            }
            if (charAt == 'e' || charAt == 'E') {
                int i4 = f413i;
                if (i4 + 1 < f414l) {
                    char charAt2 = f415s.charAt(i4 + 1);
                    if (!(charAt2 == 'm' || charAt2 == 'x')) {
                        f413i++;
                        char charAt3 = f415s.charAt(f413i);
                        if (charAt3 == '+' || charAt3 == '-') {
                            f413i++;
                            skip_digits();
            ...
            float parseFloat = Float.parseFloat(f415s.substring(i, f413i));
    ...
    private static void skip_digits() {
        while (true) {
            int i = f413i;
            if (i < f414l && Character.isDigit(f415s.charAt(i))) {
                f413i++;
            } else {
                return;
            }
