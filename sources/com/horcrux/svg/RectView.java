...
class RectView extends RenderableView {
    ...
    /* renamed from: mH */
    private SVGLength f423mH;
    private SVGLength mRx;
    private SVGLength mRy;

    /* renamed from: mW */
    private SVGLength f424mW;

    /* renamed from: mX */
    private SVGLength f425mX;

    /* renamed from: mY */
    private SVGLength f426mY;
    ...
    public void setX(Dynamic dynamic) {
        this.f425mX = SVGLength.from(dynamic);
        invalidate();
    }

    @ReactProp(name = "y")
    public void setY(Dynamic dynamic) {
        this.f426mY = SVGLength.from(dynamic);
        invalidate();
    }

    @ReactProp(name = "width")
    public void setWidth(Dynamic dynamic) {
        this.f424mW = SVGLength.from(dynamic);
        invalidate();
    }

    @ReactProp(name = "height")
    public void setHeight(Dynamic dynamic) {
        this.f423mH = SVGLength.from(dynamic);
        invalidate();
    }
    ...
    public android.graphics.Path getPath(android.graphics.Canvas r20, android.graphics.Paint r21) {
        /*
            ...
            r9.<init>()
            com.horcrux.svg.SVGLength r1 = r0.f425mX
            double r1 = r0.relativeOnWidth(r1)
            com.horcrux.svg.SVGLength r3 = r0.f426mY
            double r3 = r0.relativeOnHeight(r3)
            com.horcrux.svg.SVGLength r5 = r0.f424mW
            double r5 = r0.relativeOnWidth(r5)
            com.horcrux.svg.SVGLength r7 = r0.f423mH
