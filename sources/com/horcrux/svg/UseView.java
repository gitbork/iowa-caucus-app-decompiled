...
class UseView extends RenderableView {
    ...
    /* renamed from: mH */
    private SVGLength f435mH;
    private String mHref;

    /* renamed from: mW */
    private SVGLength f436mW;

    /* renamed from: mX */
    private SVGLength f437mX;

    /* renamed from: mY */
    private SVGLength f438mY;
    ...
    public void setX(Dynamic dynamic) {
        this.f437mX = SVGLength.from(dynamic);
        invalidate();
    }

    @ReactProp(name = "y")
    public void setY(Dynamic dynamic) {
        this.f438mY = SVGLength.from(dynamic);
        invalidate();
    }

    @ReactProp(name = "width")
    public void setWidth(Dynamic dynamic) {
        this.f436mW = SVGLength.from(dynamic);
        invalidate();
    }

    @ReactProp(name = "height")
    public void setHeight(Dynamic dynamic) {
        this.f435mH = SVGLength.from(dynamic);
        invalidate();
    }
    ...
    public void draw(Canvas canvas, Paint paint, float f) {
        ...
        canvas.translate((float) relativeOnWidth(this.f437mX), (float) relativeOnHeight(this.f438mY));
        ...
        if (definedTemplate instanceof SymbolView) {
            ((SymbolView) definedTemplate).drawSymbol(canvas, paint, f, (float) relativeOnWidth(this.f436mW), (float) relativeOnHeight(this.f435mH));
        } else {
    ...
    public Path getPath(Canvas canvas, Paint paint) {
        ...
        matrix.setTranslate((float) relativeOnWidth(this.f437mX), (float) relativeOnHeight(this.f438mY));
