...
class PatternView extends GroupView {
    ...
    /* renamed from: mW */
    private SVGLength f417mW;

    /* renamed from: mX */
    private SVGLength f418mX;

    /* renamed from: mY */
    private SVGLength f419mY;
    ...
    public void setX(Dynamic dynamic) {
        this.f418mX = SVGLength.from(dynamic);
        invalidate();
    }

    @ReactProp(name = "y")
    public void setY(Dynamic dynamic) {
        this.f419mY = SVGLength.from(dynamic);
        invalidate();
    }

    @ReactProp(name = "width")
    public void setWidth(Dynamic dynamic) {
        this.f417mW = SVGLength.from(dynamic);
        invalidate();
    }

    @ReactProp(name = "height")
    public void setHeight(Dynamic dynamic) {
        this.f416mH = SVGLength.from(dynamic);
        invalidate();
    }
    ...
    public void saveDefinition() {
        if (this.mName != null) {
            Brush brush = new Brush(BrushType.PATTERN, new SVGLength[]{this.f418mX, this.f419mY, this.f417mW, this.f416mH}, this.mPatternUnits);
