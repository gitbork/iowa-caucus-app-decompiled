...
class RNSVGMarkerPosition {
    ...
    static /* synthetic */ class C18191 {
        ...
        static {
            ...
            L_0x0067:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.horcrux.svg.RNSVGMarkerPosition.C18191.<clinit>():void");
        }
    }
    ...
    private static double SlopeAngleRadians(Point point) {
        return Math.atan2(point.f421y, point.f420x);
    }
    ...
    private static double CurrentAngle(RNSVGMarkerType rNSVGMarkerType) {
        ...
        int i = C18191.$SwitchMap$com$horcrux$svg$RNSVGMarkerType[rNSVGMarkerType.ordinal()];
        if (i == 1) {
    ...
    private static Point subtract(Point point, Point point2) {
        return new Point(point2.f420x - point.f420x, point2.f421y - point.f421y);
    }

    private static boolean isZero(Point point) {
        return point.f420x == 0.0d && point.f421y == 0.0d;
    }
    ...
    private static SegmentData ExtractPathElementFeatures(PathElement pathElement) {
        ...
        int i = C18191.$SwitchMap$com$horcrux$svg$ElementType[pathElement.type.ordinal()];
        if (i == 1) {
