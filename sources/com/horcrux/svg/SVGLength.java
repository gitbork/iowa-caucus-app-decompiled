...
class SVGLength {
    ...
    static /* synthetic */ class C18201 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.horcrux.svg.SVGLength.C18201.<clinit>():void");
        }
    }
    ...
    static SVGLength from(Dynamic dynamic) {
        int i = C18201.$SwitchMap$com$facebook$react$bridge$ReadableType[dynamic.getType().ordinal()];
        if (i == 1) {
