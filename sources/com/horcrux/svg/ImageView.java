...
class ImageView extends RenderableView {
    ...
    /* renamed from: mW */
    private SVGLength f143mW;

    /* renamed from: mX */
    private SVGLength f144mX;

    /* renamed from: mY */
    private SVGLength f145mY;
    ...
    public void setX(Dynamic dynamic) {
        this.f144mX = SVGLength.from(dynamic);
        invalidate();
    }

    @ReactProp(name = "y")
    public void setY(Dynamic dynamic) {
        this.f145mY = SVGLength.from(dynamic);
        invalidate();
    }

    @ReactProp(name = "width")
    public void setWidth(Dynamic dynamic) {
        this.f143mW = SVGLength.from(dynamic);
        invalidate();
    }

    @ReactProp(name = "height")
    public void setHeight(Dynamic dynamic) {
        this.f142mH = SVGLength.from(dynamic);
        invalidate();
    }
    ...
    public Path getPath(Canvas canvas, Paint paint) {
        this.mPath = new Path();
        this.mPath.addRect(getRect(), Direction.CW);
        return this.mPath;
    }
    ...
    private void loadBitmap(ImagePipeline imagePipeline, ImageRequest imageRequest) {
        ...
        imagePipeline.fetchDecodedImage(imageRequest, this.mContext).subscribe(new BaseBitmapDataSubscriber() {
            ...
            public void onFailureImpl(DataSource dataSource) {
                ImageView.this.mLoading.set(false);
                FLog.m87w(ReactConstants.TAG, dataSource.getFailureCause(), "RNSVG: fetchDecodedImage failed!", new Object[0]);
            }
    ...
    private RectF getRect() {
        double relativeOnWidth = relativeOnWidth(this.f144mX);
        double relativeOnHeight = relativeOnHeight(this.f145mY);
        double relativeOnWidth2 = relativeOnWidth(this.f143mW);
        double relativeOnHeight2 = relativeOnHeight(this.f142mH);
