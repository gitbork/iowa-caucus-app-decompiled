...
final class DecodedBitStreamParser {
    ...
    /* renamed from: FS */
    private static final char f382FS = '\u001c';

    /* renamed from: GS */
    private static final char f383GS = '\u001d';
    private static final char LATCHA = '￷';
    private static final char LATCHB = '￸';
    private static final char LOCK = '￹';

    /* renamed from: NS */
    private static final char f384NS = '￻';
    private static final char PAD = '￼';

    /* renamed from: RS */
    private static final char f385RS = '\u001e';
    ...
    static DecoderResult decode(byte[] bArr, int i) {
        ...
        if (i == 2 || i == 3) {
            if (i == 2) {
                ...
                str = new DecimalFormat(str2.substring(0, getPostCode2Length(bArr))).format((long) getPostCode2(bArr));
            } else {
    ...
    private static int getPostCode2Length(byte[] bArr) {
        return getInt(bArr, new byte[]{39, 40, 41, 42, Ascii.f161US, 32});
    }

    private static int getPostCode2(byte[] bArr) {
        return getInt(bArr, new byte[]{33, 34, 35, 36, Ascii.f150EM, Ascii.SUB, Ascii.ESC, Ascii.f152FS, Ascii.f153GS, Ascii.f157RS, 19, Ascii.DC4, Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, Ascii.f149CR, Ascii.f159SO, Ascii.f158SI, Ascii.DLE, 17, Ascii.DC2, 7, 8, 9, 10, Ascii.f162VT, Ascii.f151FF, 1, 2});
    }

    private static String getPostCode3(byte[] bArr) {
        return String.valueOf(new char[]{SETS[0].charAt(getInt(bArr, new byte[]{39, 40, 41, 42, Ascii.f161US, 32})), SETS[0].charAt(getInt(bArr, new byte[]{33, 34, 35, 36, Ascii.f150EM, Ascii.SUB})), SETS[0].charAt(getInt(bArr, new byte[]{Ascii.ESC, Ascii.f152FS, Ascii.f153GS, Ascii.f157RS, 19, Ascii.DC4})), SETS[0].charAt(getInt(bArr, new byte[]{Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, Ascii.f149CR, Ascii.f159SO})), SETS[0].charAt(getInt(bArr, new byte[]{Ascii.f158SI, Ascii.DLE, 17, Ascii.DC2, 7, 8})), SETS[0].charAt(getInt(bArr, new byte[]{9, 10, Ascii.f162VT, Ascii.f151FF, 1, 2}))});
    }
