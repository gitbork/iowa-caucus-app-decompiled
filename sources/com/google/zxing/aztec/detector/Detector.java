...
public final class Detector {
    ...
    static final class Point {
        ...
        public String toString() {
            ...
            sb.append(this.f378x);
            sb.append(' ');
            sb.append(this.f379y);
            sb.append('>');
            return sb.toString();
        }
    }
    ...
    public AztecDetectorResult detect(boolean z) throws NotFoundException {
        ...
        int i = this.shift;
        AztecDetectorResult aztecDetectorResult = new AztecDetectorResult(sampleGrid(bitMatrix, bullsEyeCorners[i % 4], bullsEyeCorners[(i + 1) % 4], bullsEyeCorners[(i + 2) % 4], bullsEyeCorners[(i + 3) % 4]), getMatrixCornerPoints(bullsEyeCorners), this.compact, this.nbDataBlocks, this.nbLayers);
    ...
    private BitMatrix sampleGrid(BitMatrix bitMatrix, ResultPoint resultPoint, ResultPoint resultPoint2, ResultPoint resultPoint3, ResultPoint resultPoint4) throws NotFoundException {
        ...
        float f2 = f - ((float) i3);
        float f3 = f + ((float) i3);
        return instance.sampleGrid(bitMatrix2, i2, i, f2, f2, f3, f2, f3, f3, f2, f3, resultPoint.getX(), resultPoint.getY(), resultPoint2.getX(), resultPoint2.getY(), resultPoint3.getX(), resultPoint3.getY(), resultPoint4.getX(), resultPoint4.getY());
    }
    ...
    private static ResultPoint[] expandSquare(ResultPoint[] resultPointArr, int i, int i2) {
        ...
        float x4 = (resultPointArr[1].getX() - resultPointArr[3].getX()) * f;
        float y4 = f * (resultPointArr[1].getY() - resultPointArr[3].getY());
