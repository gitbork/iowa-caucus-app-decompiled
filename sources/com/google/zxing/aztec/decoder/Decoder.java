...
import p006io.sentry.connection.AbstractConnection;

public final class Decoder {
    private static final String[] DIGIT_TABLE = {"CTRL_PS", " ", "0", "1", ExifInterface.GPS_MEASUREMENT_2D, ExifInterface.GPS_MEASUREMENT_3D, "4", "5", AbstractConnection.SENTRY_PROTOCOL_VERSION, "7", "8", "9", ",", ".", "CTRL_UL", "CTRL_US"};
    ...
    static /* synthetic */ class C17941 {
        ...
        static {
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.aztec.decoder.Decoder.C17941.<clinit>():void");
        }
    }
    ...
    private static String getCharacter(Table table, int i) {
        int i2 = C17941.$SwitchMap$com$google$zxing$aztec$decoder$Decoder$Table[table.ordinal()];
        if (i2 == 1) {
