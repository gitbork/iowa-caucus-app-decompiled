...
public final class Encoder {
    ...
    static /* synthetic */ class C18131 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.qrcode.encoder.Encoder.C18131.<clinit>():void");
        }
    }
    ...
    public static QRCode encode(String str, ErrorCorrectionLevel errorCorrectionLevel, Map<EncodeHintType, ?> map) throws WriterException {
        ...
        if (chooseMode == Mode.BYTE && z2) {
            CharacterSetECI characterSetECIByName = CharacterSetECI.getCharacterSetECIByName(obj);
    ...
    static void appendBytes(String str, Mode mode, BitArray bitArray, String str2) throws WriterException {
        int i = C18131.$SwitchMap$com$google$zxing$qrcode$decoder$Mode[mode.ordinal()];
        if (i == 1) {
