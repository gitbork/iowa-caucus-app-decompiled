...
public class SymbolInfo {
    ...
    static {
        ...
        SymbolInfo symbolInfo21 = new SymbolInfo(false, XMPError.BADSTREAM, 84, 24, 24, 4, 102, 42);
        ...
        SymbolInfo symbolInfo24 = new SymbolInfo(false, 456, JfifUtil.MARKER_SOFn, 18, 18, 16, 114, 48);
        SymbolInfo symbolInfo25 = new SymbolInfo(false, 576, CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY, 20, 20, 16, 144, 56);
        SymbolInfo symbolInfo26 = new SymbolInfo(false, IptcDirectory.TAG_JOB_ID, 272, 22, 22, 16, 174, 68);
        SymbolInfo symbolInfo27 = new SymbolInfo(false, LeicaMakernoteDirectory.TAG_CCD_VERSION, IptcDirectory.TAG_TIME_SENT, 24, 24, 16, 136, 56);
        SymbolInfo symbolInfo28 = new SymbolInfo(false, PhotoshopDirectory.TAG_SLICES, 408, 18, 18, 36, NikonType2MakernoteDirectory.TAG_UNKNOWN_30, 68);
        SymbolInfo symbolInfo29 = new SymbolInfo(false, 1304, 496, 20, 20, 36, 163, 62);
        SymbolInfo[] symbolInfoArr = {symbolInfo, symbolInfo2, symbolInfo3, symbolInfo4, symbolInfo5, symbolInfo6, symbolInfo7, symbolInfo8, symbolInfo9, symbolInfo10, symbolInfo11, symbolInfo12, symbolInfo13, symbolInfo14, symbolInfo15, symbolInfo16, symbolInfo17, symbolInfo18, symbolInfo19, symbolInfo20, symbolInfo21, symbolInfo22, symbolInfo23, symbolInfo24, symbolInfo25, symbolInfo26, symbolInfo27, symbolInfo28, symbolInfo29, new DataMatrixSymbolInfo144()};
