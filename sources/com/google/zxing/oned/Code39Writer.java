...
public final class Code39Writer extends OneDimensionalCodeWriter {
    ...
    public boolean[] encode(String str) {
        ...
        if (length <= 80) {
            ...
            int i3 = 0;
            while (i3 < length) {
                toIntArray(Code39Reader.CHARACTER_ENCODINGS[str2.indexOf(str.charAt(i3))], iArr);
                int i4 = i2;
            ...
            for (int i6 = 0; i6 < length; i6++) {
                toIntArray(Code39Reader.CHARACTER_ENCODINGS[str2.indexOf(str.charAt(i6))], iArr);
