...
public final class Collections2 {
    ...
    private static class PermutationIterator<E> extends AbstractIterator<List<E>> {
        ...
        PermutationIterator(List<E> list2) {
            ...
            int size = list2.size();
            this.f183c = new int[size];
            this.f185o = new int[size];
            Arrays.fill(this.f183c, 0);
            Arrays.fill(this.f185o, 1);
        }
        ...
        /* access modifiers changed from: 0000 */
        public void calculateNextPermutation() {
            this.f184j = this.list.size() - 1;
            if (this.f184j != -1) {
                int i = 0;
                while (true) {
                    int[] iArr = this.f183c;
                    int i2 = this.f184j;
                    int i3 = iArr[i2] + this.f185o[i2];
                    if (i3 >= 0) {
                        if (i3 != i2 + 1) {
                            Collections.swap(this.list, (i2 - iArr[i2]) + i, (i2 - i3) + i);
                            this.f183c[this.f184j] = i3;
                            break;
                        } else if (i2 == 0) {
                            break;
                        } else {
