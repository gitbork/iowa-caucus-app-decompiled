...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    private Iterable<E> getDelegate() {
        return (Iterable) this.iterableDelegate.mo21557or(this);
    }
    ...
    @Beta
    /* renamed from: of */
    public static <E> FluentIterable<E> m207of() {
        return from((Iterable<E>) ImmutableList.m217of());
    }

    @Beta
    /* renamed from: of */
    public static <E> FluentIterable<E> m208of(@NullableDecl E e, E... eArr) {
