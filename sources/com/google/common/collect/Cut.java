...
abstract class Cut<C extends Comparable> implements Comparable<Cut<C>>, Serializable {
    ...
    static /* synthetic */ class C10901 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.collect.Cut.C10901.<clinit>():void");
        }
    }
    ...
    private static final class AboveValue<C extends Comparable> extends Cut<C> {
        ...
        public Cut<C> withLowerBoundType(BoundType boundType, DiscreteDomain<C> discreteDomain) {
            int i = C10901.$SwitchMap$com$google$common$collect$BoundType[boundType.ordinal()];
            if (i == 1) {
