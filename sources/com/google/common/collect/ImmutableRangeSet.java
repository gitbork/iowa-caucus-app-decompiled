...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
    private static final ImmutableRangeSet<Comparable<?>> ALL = new ImmutableRangeSet<>(ImmutableList.m218of(Range.all()));
    private static final ImmutableRangeSet<Comparable<?>> EMPTY = new ImmutableRangeSet<>(ImmutableList.m217of());
    @LazyInit
    ...
    private final class AsSet extends ImmutableSortedSet<C> {
        ...
        public ImmutableSortedSet<C> subSetImpl(C c, boolean z, C c2, boolean z2) {
            ...
            return ImmutableSortedSet.m297of();
        }
    ...
    public static class Builder<C extends Comparable<?>> {
        ...
        public ImmutableRangeSet<C> build() {
            ...
            if (build.isEmpty()) {
                return ImmutableRangeSet.m257of();
            }
    ...
    private static final class SerializedForm<C extends Comparable> implements Serializable {
        ...
        public Object readResolve() {
            ...
            if (this.ranges.equals(ImmutableList.m218of(Range.all()))) {
                return ImmutableRangeSet.all();
            }
    ...
    /* renamed from: of */
    public static <C extends Comparable> ImmutableRangeSet<C> m257of() {
        return EMPTY;
    }

    /* renamed from: of */
    public static <C extends Comparable> ImmutableRangeSet<C> m258of(Range<C> range) {
        ...
        return new ImmutableRangeSet<>(ImmutableList.m218of(range));
    }
