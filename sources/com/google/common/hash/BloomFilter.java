...
public final class BloomFilter<T> implements Predicate<T>, Serializable {
    ...
    public long approximateElementCount() {
        ...
        Double.isNaN(bitCount);
        Double.isNaN(bitSize);
        double d = -Math.log1p(-(bitCount / bitSize));
        Double.isNaN(bitSize);
        double d2 = d * bitSize;
    ...
    public void putAll(com.google.common.hash.BloomFilter r14) {
        ...
        L_0x0017:
            r2 = 0
        L_0x0018:
            int r3 = r13.numHashFunctions
            int r4 = r14.numHashFunctions
        ...
        L_0x0030:
            ...
            boolean r0 = r0.equals(r1)
            com.google.common.hash.BloomFilter$Strategy r1 = r13.strategy
            com.google.common.hash.BloomFilter$Strategy r2 = r14.strategy
            ...
            boolean r0 = r0.equals(r1)
            com.google.common.hash.Funnel<? super T> r1 = r13.funnel
            com.google.common.hash.Funnel<? super T> r2 = r14.funnel
