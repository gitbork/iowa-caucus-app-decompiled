...
final class Murmur3_128HashFunction extends AbstractHashFunction implements Serializable {
    ...
    private static final class Murmur3_128Hasher extends AbstractStreamingHasher {
        ...
        /* renamed from: C1 */
        private static final long f194C1 = -8663945395140668459L;

        /* renamed from: C2 */
        private static final long f195C2 = 5545529020109919103L;
        ...
        private void bmix64(long j, long j2) {
            this.f196h1 = mixK1(j) ^ this.f196h1;
            this.f196h1 = Long.rotateLeft(this.f196h1, 27);
            long j3 = this.f196h1;
            long j4 = this.f197h2;
            this.f196h1 = j3 + j4;
            this.f196h1 = (this.f196h1 * 5) + 1390208809;
            this.f197h2 = mixK2(j2) ^ j4;
            this.f197h2 = Long.rotateLeft(this.f197h2, 31);
            this.f197h2 += this.f196h1;
            this.f197h2 = (this.f197h2 * 5) + 944331445;
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:32:0x00f6, code lost:
            r11.f196h1 = mixK1(r2) ^ r11.f196h1;
            r11.f197h2 = mixK2(r0) ^ r11.f197h2;
         */
        ...
        public HashCode makeHash() {
            ...
            long j4 = this.f196h1;
            this.f197h2 = j3 + j4;
            this.f196h1 = fmix64(j4);
            this.f197h2 = fmix64(this.f197h2);
            long j5 = this.f196h1;
            long j6 = this.f197h2;
            this.f196h1 = j5 + j6;
            this.f197h2 = j6 + this.f196h1;
            return HashCode.fromBytesNoCopy(ByteBuffer.wrap(new byte[16]).order(ByteOrder.LITTLE_ENDIAN).putLong(this.f196h1).putLong(this.f197h2).array());
        }

        private static long mixK1(long j) {
            return Long.rotateLeft(j * f194C1, 31) * f195C2;
        }

        private static long mixK2(long j) {
            return Long.rotateLeft(j * f195C2, 33) * f194C1;
        }
    }
