...
public final class ServiceManager {
    ...
    private static final class ServiceManagerState {
        ...
        public void awaitHealthy(long j, TimeUnit timeUnit) throws TimeoutException {
            ...
            try {
                ...
                sb.append(Multimaps.filterKeys(this.servicesByState, Predicates.m192in(ImmutableSet.m261of(State.NEW, State.STARTING))));
        ...
        public void awaitStopped(long j, TimeUnit timeUnit) throws TimeoutException {
            ...
            try {
                if (!this.monitor.waitForUninterruptibly(this.stoppedGuard, j, timeUnit)) {
                    ...
                    sb.append(Multimaps.filterKeys(this.servicesByState, Predicates.not(Predicates.m192in(EnumSet.of(State.TERMINATED, State.FAILED)))));
                    throw new TimeoutException(sb.toString());
                }
            } finally {
                this.monitor.leave();
    ...
    public ServiceManager(Iterable<? extends Service> iterable) {
        ...
        if (copyOf.isEmpty()) {
            ...
            copyOf = ImmutableList.m218of(new NoOpService());
        }
