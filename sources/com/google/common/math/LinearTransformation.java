...
public abstract class LinearTransformation {
    ...
    public static final class LinearTransformationBuilder {
        ...
        /* renamed from: x1 */
        private final double f229x1;

        /* renamed from: y1 */
        private final double f230y1;
        ...
        public LinearTransformation and(double d, double d2) {
            ...
            double d3 = this.f229x1;
            if (d != d3) {
                return withSlope((d2 - this.f230y1) / (d - d3));
            }
            if (d2 == this.f230y1) {
                z = false;
            }
            Preconditions.checkArgument(z);
            return new VerticalLinearTransformation(this.f229x1);
        }

        public LinearTransformation withSlope(double d) {
            Preconditions.checkArgument(!Double.isNaN(d));
            if (DoubleUtils.isFinite(d)) {
                return new RegularLinearTransformation(d, this.f230y1 - (this.f229x1 * d));
            }
            return new VerticalLinearTransformation(this.f229x1);
        }
    }
    ...
    private static final class VerticalLinearTransformation extends LinearTransformation {
        ...
        public String toString() {
            return String.format("x = %g", new Object[]{Double.valueOf(this.f231x)});
        }

        private LinearTransformation createInverse() {
            RegularLinearTransformation regularLinearTransformation = new RegularLinearTransformation(0.0d, this.f231x, this);
            return regularLinearTransformation;
        }
    }
