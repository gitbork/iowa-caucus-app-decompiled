...
public final class DoubleMath {
    ...
    static /* synthetic */ class C13761 {
        ...
        static {
            ...
            L_0x0062:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.math.DoubleMath.C13761.<clinit>():void");
        }
    }
    ...
    static double roundIntermediate(double d, RoundingMode roundingMode) {
        if (DoubleUtils.isFinite(d)) {
            switch (C13761.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
                case 1:
    ...
    public static double mean(Iterator<? extends Number> it) {
        ...
        while (it.hasNext()) {
            j++;
            double checkFinite2 = checkFinite(((Number) it.next()).doubleValue()) - checkFinite;
            double d = (double) j;
            Double.isNaN(d);
