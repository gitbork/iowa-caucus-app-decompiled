...
public final class PairedStats implements Serializable {
    ...
    public String toString() {
        ...
        String str2 = "xStats";
        if (count() <= 0) {
            return MoreObjects.toStringHelper((Object) this).add(str2, (Object) this.xStats).add(str, (Object) this.yStats).toString();
        }
        return MoreObjects.toStringHelper((Object) this).add(str2, (Object) this.xStats).add(str, (Object) this.yStats).add("populationCovariance", populationCovariance()).toString();
    }
