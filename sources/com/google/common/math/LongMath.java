...
public final class LongMath {
    ...
    @VisibleForTesting
    static final byte[] maxLog10ForLeadingZeros = {19, Ascii.DC2, Ascii.DC2, Ascii.DC2, Ascii.DC2, 17, 17, 17, Ascii.DLE, Ascii.DLE, Ascii.DLE, Ascii.f158SI, Ascii.f158SI, Ascii.f158SI, Ascii.f158SI, Ascii.f159SO, Ascii.f159SO, Ascii.f159SO, Ascii.f149CR, Ascii.f149CR, Ascii.f149CR, Ascii.f151FF, Ascii.f151FF, Ascii.f151FF, Ascii.f151FF, Ascii.f162VT, Ascii.f162VT, Ascii.f162VT, 10, 10, 10, 9, 9, 9, 9, 8, 8, 8, 7, 7, 7, 6, 6, 6, 6, 5, 5, 5, 4, 4, 4, 3, 3, 3, 3, 2, 2, 2, 1, 1, 1, 0, 0, 0};
    ...
    static /* synthetic */ class C13791 {
        ...
        static {
            ...
            L_0x0062:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.math.LongMath.C13791.<clinit>():void");
        }
    }
    ...
    public static int log2(long j, RoundingMode roundingMode) {
        MathPreconditions.checkPositive("x", j);
        switch (C13791.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
    ...
    public static int log10(long r4, java.math.RoundingMode r6) {
        /*
            ...
            long[] r1 = powersOf10
            r2 = r1[r0]
            int[] r1 = com.google.common.math.LongMath.C13791.$SwitchMap$java$math$RoundingMode
            int r6 = r6.ordinal()
            r6 = r1[r6]
            switch(r6) {
    ...
    public static long divide(long r8, long r10, java.math.RoundingMode r12) {
        ...
        L_0x0010:
            ...
            r8 = 1
            r9 = r9 | r8
            int[] r6 = com.google.common.math.LongMath.C13791.$SwitchMap$java$math$RoundingMode
            int r7 = r12.ordinal()
            r6 = r6[r7]
            r7 = 0
            switch(r6) {
