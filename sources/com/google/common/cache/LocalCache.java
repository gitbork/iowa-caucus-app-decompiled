...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    static final Queue<?> DISCARDING_QUEUE = new AbstractQueue<Object>() {
        ...
        public Iterator<Object> iterator() {
            return ImmutableSet.m259of().iterator();
        }
    };
    ...
    static class Segment<K, V> extends ReentrantLock {
        ...
        public V put(K r15, int r16, V r17, boolean r18) {
            /*
                ...
                int r1 = r7.count     // Catch:{ all -> 0x00e5 }
            L_0x001f:
                java.util.concurrent.atomic.AtomicReferenceArray<com.google.common.cache.ReferenceEntry<K, V>> r10 = r7.table     // Catch:{ all -> 0x00e5 }
                int r1 = r10.length()     // Catch:{ all -> 0x00e5 }
                int r1 = r1 + -1
                r11 = r3 & r1
                java.lang.Object r1 = r10.get(r11)     // Catch:{ all -> 0x00e5 }
                com.google.common.cache.ReferenceEntry r1 = (com.google.common.cache.ReferenceEntry) r1     // Catch:{ all -> 0x00e5 }
                r12 = r1
            L_0x0030:
                r13 = 0
            ...
            L_0x009e:
                ...
                goto L_0x0097
            L_0x00bf:
                com.google.common.cache.ReferenceEntry r12 = r12.getNext()     // Catch:{ all -> 0x00e5 }
                goto L_0x0030
            L_0x00c5:
                int r2 = r7.modCount     // Catch:{ all -> 0x00e5 }
                int r2 = r2 + 1
                r7.modCount = r2     // Catch:{ all -> 0x00e5 }
                com.google.common.cache.ReferenceEntry r12 = r14.newEntry(r15, r3, r1)     // Catch:{ all -> 0x00e5 }
                r1 = r14
                r2 = r12
                r3 = r15
                r4 = r17
        ...
        public boolean replace(K r18, int r19, V r20, V r21) {
            /*
                ...
                java.util.concurrent.atomic.AtomicReferenceArray<com.google.common.cache.ReferenceEntry<K, V>> r10 = r9.table     // Catch:{ all -> 0x00b7 }
            ...
            L_0x0024:
                ...
                r5 = r19
                r7 = r16
                com.google.common.cache.ReferenceEntry r0 = r1.removeValueFromChain(r2, r3, r4, r5, r6, r7, r8)     // Catch:{ all -> 0x00b7 }
                int r1 = r9.count     // Catch:{ all -> 0x00b7 }
                int r1 = r1 - r11
            ...
            L_0x00af:
                r3 = r20
                com.google.common.cache.ReferenceEntry r13 = r13.getNext()     // Catch:{ all -> 0x00b7 }
                goto L_0x0024
            L_0x00b7:
                r0 = move-exception
                r17.unlock()
        ...
        public V replace(K r18, int r19, V r20) {
            /*
                ...
                java.util.concurrent.atomic.AtomicReferenceArray<com.google.common.cache.ReferenceEntry<K, V>> r10 = r9.table     // Catch:{ all -> 0x00a9 }
                int r1 = r10.length()     // Catch:{ all -> 0x00a9 }
                int r1 = r1 + -1
                r11 = r0 & r1
                java.lang.Object r1 = r10.get(r11)     // Catch:{ all -> 0x00a9 }
                r2 = r1
                com.google.common.cache.ReferenceEntry r2 = (com.google.common.cache.ReferenceEntry) r2     // Catch:{ all -> 0x00a9 }
                r12 = r2
            L_0x0024:
                r13 = 0
                ...
                r6 = r16
                r7 = r15
                com.google.common.cache.ReferenceEntry r0 = r1.removeValueFromChain(r2, r3, r4, r5, r6, r7, r8)     // Catch:{ all -> 0x00a9 }
                int r1 = r9.count     // Catch:{ all -> 0x00a9 }
                int r1 = r1 + -1
            ...
            L_0x00a1:
                r14 = r18
            L_0x00a3:
                com.google.common.cache.ReferenceEntry r12 = r12.getNext()     // Catch:{ all -> 0x00a9 }
                goto L_0x0024
            L_0x00a9:
                r0 = move-exception
                r17.unlock()
