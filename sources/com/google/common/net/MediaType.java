...
public final class MediaType {
    ...
    private static final MapJoiner PARAMETER_JOINER = Joiner.m187on("; ").withKeyValueSeparator("=");
    ...
    private static final ImmutableListMultimap<String, String> UTF_8_CONSTANT_PARAMETERS = ImmutableListMultimap.m231of(CHARSET_ATTRIBUTE, Ascii.toLowerCase(Charsets.UTF_8.name()));
    ...
    private static MediaType createConstant(String str, String str2) {
        MediaType addKnownType = addKnownType(new MediaType(str, str2, ImmutableListMultimap.m230of()));
    ...
    public Optional<Charset> charset() {
        ...
        if (optional == null) {
            ...
            while (it.hasNext()) {
                ...
                if (str == null) {
                    optional = Optional.m188of(Charset.forName(str2));
                    str = str2;
    ...
    public MediaType withParameter(String str, String str2) {
        return withParameters(str, ImmutableSet.m260of(str2));
    }
    ...
    /* renamed from: is */
    public boolean mo25180is(MediaType mediaType) {
        String str = "*";
    ...
    public static MediaType create(String str, String str2) {
        MediaType create = create(str, str2, ImmutableListMultimap.m230of());
