...
public final class TypeResolver {
    ...
    private static class WildcardCapturer {
        ...
        /* renamed from: id */
        private final AtomicInteger f233id;
        ...
        public TypeVariable<?> captureAsTypeVariable(Type[] typeArr) {
            ...
            sb.append("capture#");
            sb.append(this.f233id.incrementAndGet());
            sb.append("-of ? extends ");
            sb.append(Joiner.m186on('&').join((Object[]) typeArr));
        ...
        private WildcardCapturer forTypeVariable(final TypeVariable<?> typeVariable) {
            return new WildcardCapturer(this.f233id) {
                /* access modifiers changed from: 0000 */
                public TypeVariable<?> captureAsTypeVariable(Type[] typeArr) {
