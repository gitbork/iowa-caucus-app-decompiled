...
abstract class AbstractIterator<T> implements Iterator<T> {
    ...
    static /* synthetic */ class C09941 {
        ...
        static {
            /*
                ...
                int[] r0 = $SwitchMap$com$google$common$base$AbstractIterator$State     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = $SwitchMap$com$google$common$base$AbstractIterator$State     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.base.AbstractIterator.C09941.<clinit>():void");
        }
    }
    ...
    public final boolean hasNext() {
        ...
        int i = C09941.$SwitchMap$com$google$common$base$AbstractIterator$State[this.state.ordinal()];
        if (i == 1) {
            return true;
        }
        if (i != 2) {
