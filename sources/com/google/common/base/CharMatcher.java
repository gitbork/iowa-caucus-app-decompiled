...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    private static final class Any extends NamedFastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo21590or(CharMatcher charMatcher) {
    ...
    private static final class C1001Is extends FastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo21590or(CharMatcher charMatcher) {
            return charMatcher.matches(this.match) ? charMatcher : super.mo21590or(charMatcher);
        }
    ...
    private static final class C1002Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C1002Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
            this.first = (CharMatcher) Preconditions.checkNotNull(charMatcher);
            this.second = (CharMatcher) Preconditions.checkNotNull(charMatcher2);
        }
    ...
    /* renamed from: is */
    public static CharMatcher m180is(char c) {
        return new C1001Is(c);
    }
    ...
    public static CharMatcher anyOf(CharSequence charSequence) {
        ...
        if (length == 1) {
            return m180is(charSequence.charAt(0));
        }
        if (length != 2) {
    ...
    /* renamed from: or */
    public CharMatcher mo21590or(CharMatcher charMatcher) {
        return new C1002Or(this, charMatcher);
    }
    ...
    private static CharMatcher precomputedPositive(int i, BitSet bitSet, String str) {
        ...
        if (i == 1) {
            return m180is((char) bitSet.nextSetBit(0));
        }
        if (i != 2) {
