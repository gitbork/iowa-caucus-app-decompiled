...
public final class Predicates {
    ...
    private static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        ...
        /* renamed from: f */
        final Function<A, ? extends B> f165f;

        /* renamed from: p */
        final Predicate<B> f166p;

        private CompositionPredicate(Predicate<B> predicate, Function<A, ? extends B> function) {
            this.f166p = (Predicate) Preconditions.checkNotNull(predicate);
            this.f165f = (Function) Preconditions.checkNotNull(function);
        }

        public boolean apply(@NullableDecl A a) {
            return this.f166p.apply(this.f165f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (!this.f165f.equals(compositionPredicate.f165f) || !this.f166p.equals(compositionPredicate.f166p)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f165f.hashCode() ^ this.f166p.hashCode();
        }
    ...
    /* renamed from: or */
    public static <T> Predicate<T> m194or(Iterable<? extends Predicate<? super T>> iterable) {
        return new OrPredicate(defensiveCopy(iterable));
    }

    @SafeVarargs
    /* renamed from: or */
    public static <T> Predicate<T> m195or(Predicate<? super T>... predicateArr) {
        return new OrPredicate(defensiveCopy((T[]) predicateArr));
    }

    /* renamed from: or */
    public static <T> Predicate<T> m193or(Predicate<? super T> predicate, Predicate<? super T> predicate2) {
    ...
    /* renamed from: in */
    public static <T> Predicate<T> m192in(Collection<? extends T> collection) {
