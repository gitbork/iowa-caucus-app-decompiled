...
public final class Functions {
    ...
    private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        ...
        /* renamed from: f */
        private final Function<A, ? extends B> f163f;

        /* renamed from: g */
        private final Function<B, C> f164g;

        public FunctionComposition(Function<B, C> function, Function<A, ? extends B> function2) {
            this.f164g = (Function) Preconditions.checkNotNull(function);
            this.f163f = (Function) Preconditions.checkNotNull(function2);
        }

        public C apply(@NullableDecl A a) {
            return this.f164g.apply(this.f163f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (!this.f163f.equals(functionComposition.f163f) || !this.f164g.equals(functionComposition.f164g)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f163f.hashCode() ^ this.f164g.hashCode();
        }
