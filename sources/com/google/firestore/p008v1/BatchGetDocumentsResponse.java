...
public final class BatchGetDocumentsResponse extends GeneratedMessageLite<BatchGetDocumentsResponse, Builder> implements BatchGetDocumentsResponseOrBuilder {
    ...
    static /* synthetic */ class C15711 {
        ...
        static final /* synthetic */ int[] f273x4895efbc = new int[ResultCase.values().length];
        ...
        static {
            /*
                ...
                f274xa1df5c61 = r0
                r0 = 1
                int[] r1 = f274xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                r1 = 2
                int[] r2 = f274xa1df5c61     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                r2 = 3
                int[] r3 = f274xa1df5c61     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                int[] r3 = f274xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0035 }
            ...
            L_0x0035:
                int[] r3 = f274xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0040 }
            ...
            L_0x0040:
                int[] r3 = f274xa1df5c61     // Catch:{ NoSuchFieldError -> 0x004b }
            ...
            L_0x004b:
                int[] r3 = f274xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0056 }
            ...
            L_0x0056:
                int[] r3 = f274xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0062 }
            ...
            L_0x0062:
                com.google.firestore.v1.BatchGetDocumentsResponse$ResultCase[] r3 = com.google.firestore.p008v1.BatchGetDocumentsResponse.ResultCase.values()
                int r3 = r3.length
                int[] r3 = new int[r3]
                f273x4895efbc = r3
                int[] r3 = f273x4895efbc     // Catch:{ NoSuchFieldError -> 0x0075 }
                com.google.firestore.v1.BatchGetDocumentsResponse$ResultCase r4 = com.google.firestore.p008v1.BatchGetDocumentsResponse.ResultCase.FOUND     // Catch:{ NoSuchFieldError -> 0x0075 }
                int r4 = r4.ordinal()     // Catch:{ NoSuchFieldError -> 0x0075 }
                r3[r4] = r0     // Catch:{ NoSuchFieldError -> 0x0075 }
            L_0x0075:
                int[] r0 = f273x4895efbc     // Catch:{ NoSuchFieldError -> 0x007f }
                com.google.firestore.v1.BatchGetDocumentsResponse$ResultCase r3 = com.google.firestore.p008v1.BatchGetDocumentsResponse.ResultCase.MISSING     // Catch:{ NoSuchFieldError -> 0x007f }
                int r3 = r3.ordinal()     // Catch:{ NoSuchFieldError -> 0x007f }
                r0[r3] = r1     // Catch:{ NoSuchFieldError -> 0x007f }
            L_0x007f:
                int[] r0 = f273x4895efbc     // Catch:{ NoSuchFieldError -> 0x0089 }
                com.google.firestore.v1.BatchGetDocumentsResponse$ResultCase r1 = com.google.firestore.p008v1.BatchGetDocumentsResponse.ResultCase.RESULT_NOT_SET     // Catch:{ NoSuchFieldError -> 0x0089 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0089 }
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0089 }
            L_0x0089:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firestore.p008v1.BatchGetDocumentsResponse.C15711.<clinit>():void");
        }
    }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<BatchGetDocumentsResponse, Builder> implements BatchGetDocumentsResponseOrBuilder {
        ...
        public Builder setFound(com.google.firestore.p008v1.Document.Builder builder) {
            copyOnWrite();
    ...
    /* access modifiers changed from: private */
    public void setFound(com.google.firestore.p008v1.Document.Builder builder) {
    ...
    public void mergeFound(Document document) {
        if (this.resultCase_ != 1 || this.result_ == Document.getDefaultInstance()) {
            ...
            this.result_ = ((com.google.firestore.p008v1.Document.Builder) Document.newBuilder((Document) this.result_).mergeFrom(document)).buildPartial();
        }
        this.resultCase_ = 1;
    }
    ...
    public final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                int i = C15711.f273x4895efbc[batchGetDocumentsResponse.getResultCase().ordinal()];
                if (i == 1) {
                    if (this.resultCase_ == 1) {
                        z = true;
                    }
            ...
            case MERGE_FROM_STREAM:
                ...
                while (!z) {
                    try {
                        ...
                        if (readTag != 0) {
                            if (readTag == 10) {
                                com.google.firestore.p008v1.Document.Builder builder = this.resultCase_ == 1 ? (com.google.firestore.p008v1.Document.Builder) ((Document) this.result_).toBuilder() : null;
