...
public final class Target extends GeneratedMessageLite<Target, Builder> implements TargetOrBuilder {
    ...
    static /* synthetic */ class C16051 {
        ...
        /* renamed from: $SwitchMap$com$google$firestore$v1$Target$QueryTarget$QueryTypeCase */
        static final /* synthetic */ int[] f312xb069785c = new int[QueryTypeCase.values().length];
        ...
        static {
            /*
                com.google.firestore.v1.Target$ResumeTypeCase[] r0 = com.google.firestore.p008v1.Target.ResumeTypeCase.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                ...
                com.google.firestore.v1.Target$ResumeTypeCase r2 = com.google.firestore.p008v1.Target.ResumeTypeCase.RESUME_TOKEN     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r2 = r2.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r1[r2] = r0     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                r1 = 2
                int[] r2 = $SwitchMap$com$google$firestore$v1$Target$ResumeTypeCase     // Catch:{ NoSuchFieldError -> 0x001f }
                com.google.firestore.v1.Target$ResumeTypeCase r3 = com.google.firestore.p008v1.Target.ResumeTypeCase.READ_TIME     // Catch:{ NoSuchFieldError -> 0x001f }
                int r3 = r3.ordinal()     // Catch:{ NoSuchFieldError -> 0x001f }
                r2[r3] = r1     // Catch:{ NoSuchFieldError -> 0x001f }
            L_0x001f:
                r2 = 3
                int[] r3 = $SwitchMap$com$google$firestore$v1$Target$ResumeTypeCase     // Catch:{ NoSuchFieldError -> 0x002a }
                com.google.firestore.v1.Target$ResumeTypeCase r4 = com.google.firestore.p008v1.Target.ResumeTypeCase.RESUMETYPE_NOT_SET     // Catch:{ NoSuchFieldError -> 0x002a }
                int r4 = r4.ordinal()     // Catch:{ NoSuchFieldError -> 0x002a }
                r3[r4] = r2     // Catch:{ NoSuchFieldError -> 0x002a }
            L_0x002a:
                com.google.firestore.v1.Target$TargetTypeCase[] r3 = com.google.firestore.p008v1.Target.TargetTypeCase.values()
                int r3 = r3.length
                int[] r3 = new int[r3]
                ...
                com.google.firestore.v1.Target$TargetTypeCase r4 = com.google.firestore.p008v1.Target.TargetTypeCase.QUERY     // Catch:{ NoSuchFieldError -> 0x003d }
                int r4 = r4.ordinal()     // Catch:{ NoSuchFieldError -> 0x003d }
                r3[r4] = r0     // Catch:{ NoSuchFieldError -> 0x003d }
            L_0x003d:
                int[] r3 = $SwitchMap$com$google$firestore$v1$Target$TargetTypeCase     // Catch:{ NoSuchFieldError -> 0x0047 }
                com.google.firestore.v1.Target$TargetTypeCase r4 = com.google.firestore.p008v1.Target.TargetTypeCase.DOCUMENTS     // Catch:{ NoSuchFieldError -> 0x0047 }
            ...
            L_0x0047:
                ...
                com.google.firestore.v1.Target$TargetTypeCase r4 = com.google.firestore.p008v1.Target.TargetTypeCase.TARGETTYPE_NOT_SET     // Catch:{ NoSuchFieldError -> 0x0051 }
                int r4 = r4.ordinal()     // Catch:{ NoSuchFieldError -> 0x0051 }
                r3[r4] = r2     // Catch:{ NoSuchFieldError -> 0x0051 }
            L_0x0051:
                com.google.firestore.v1.Target$QueryTarget$QueryTypeCase[] r3 = com.google.firestore.p008v1.Target.QueryTarget.QueryTypeCase.values()
                int r3 = r3.length
                int[] r3 = new int[r3]
                f312xb069785c = r3
                int[] r3 = f312xb069785c     // Catch:{ NoSuchFieldError -> 0x0064 }
                com.google.firestore.v1.Target$QueryTarget$QueryTypeCase r4 = com.google.firestore.p008v1.Target.QueryTarget.QueryTypeCase.STRUCTURED_QUERY     // Catch:{ NoSuchFieldError -> 0x0064 }
                int r4 = r4.ordinal()     // Catch:{ NoSuchFieldError -> 0x0064 }
                r3[r4] = r0     // Catch:{ NoSuchFieldError -> 0x0064 }
            L_0x0064:
                int[] r3 = f312xb069785c     // Catch:{ NoSuchFieldError -> 0x006e }
                com.google.firestore.v1.Target$QueryTarget$QueryTypeCase r4 = com.google.firestore.p008v1.Target.QueryTarget.QueryTypeCase.QUERYTYPE_NOT_SET     // Catch:{ NoSuchFieldError -> 0x006e }
            ...
            L_0x006e:
                ...
                int[] r3 = new int[r3]
                f313xa1df5c61 = r3
                int[] r3 = f313xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0081 }
            ...
            L_0x0081:
                int[] r0 = f313xa1df5c61     // Catch:{ NoSuchFieldError -> 0x008b }
            ...
            L_0x008b:
                int[] r0 = f313xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0095 }
            ...
            L_0x0095:
                int[] r0 = f313xa1df5c61     // Catch:{ NoSuchFieldError -> 0x00a0 }
            ...
            L_0x00a0:
                int[] r0 = f313xa1df5c61     // Catch:{ NoSuchFieldError -> 0x00ab }
            ...
            L_0x00ab:
                int[] r0 = f313xa1df5c61     // Catch:{ NoSuchFieldError -> 0x00b6 }
            ...
            L_0x00b6:
                int[] r0 = f313xa1df5c61     // Catch:{ NoSuchFieldError -> 0x00c1 }
            ...
            L_0x00c1:
                int[] r0 = f313xa1df5c61     // Catch:{ NoSuchFieldError -> 0x00cd }
            ...
            L_0x00cd:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firestore.p008v1.Target.C16051.<clinit>():void");
        }
    }
        ...
        public final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (methodToInvoke) {
                ...
                case VISIT:
                    ...
                    int i = C16051.f312xb069785c[queryTarget.getQueryTypeCase().ordinal()];
                    if (i == 1) {
                        if (this.queryTypeCase_ == 2) {
                            z = true;
                        }
                    ...
                    if (visitor == MergeFromVisitor.INSTANCE) {
                        int i2 = queryTarget.queryTypeCase_;
                        if (i2 != 0) {
                            this.queryTypeCase_ = i2;
                        }
                    }
                    return this;
                case MERGE_FROM_STREAM:
    ...
    /* access modifiers changed from: private */
    public void setQuery(Builder builder) {
    ...
    /* access modifiers changed from: private */
    public void setDocuments(Builder builder) {
        this.targetType_ = builder.build();
        this.targetTypeCase_ = 3;
    }
    ...
    public final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                int i = C16051.$SwitchMap$com$google$firestore$v1$Target$TargetTypeCase[target.getTargetTypeCase().ordinal()];
                if (i == 1) {
                ...
                int i2 = C16051.$SwitchMap$com$google$firestore$v1$Target$ResumeTypeCase[target.getResumeTypeCase().ordinal()];
                if (i2 == 1) {
                    if (this.resumeTypeCase_ == 4) {
                        z = true;
                    }
