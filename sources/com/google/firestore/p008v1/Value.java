...
public final class Value extends GeneratedMessageLite<Value, Builder> implements ValueOrBuilder {
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<Value, Builder> implements ValueOrBuilder {
        ...
        public Builder setArrayValue(com.google.firestore.p008v1.ArrayValue.Builder builder) {
            copyOnWrite();
        ...
        public Builder setMapValue(com.google.firestore.p008v1.MapValue.Builder builder) {
            copyOnWrite();
    ...
    /* access modifiers changed from: private */
    public void setArrayValue(com.google.firestore.p008v1.ArrayValue.Builder builder) {
        this.valueType_ = builder.build();
        this.valueTypeCase_ = 9;
    }
    ...
    public void mergeArrayValue(ArrayValue arrayValue) {
        if (this.valueTypeCase_ != 9 || this.valueType_ == ArrayValue.getDefaultInstance()) {
            ...
            this.valueType_ = ((com.google.firestore.p008v1.ArrayValue.Builder) ArrayValue.newBuilder((ArrayValue) this.valueType_).mergeFrom(arrayValue)).buildPartial();
        }
        this.valueTypeCase_ = 9;
    }
    ...
    /* access modifiers changed from: private */
    public void setMapValue(com.google.firestore.p008v1.MapValue.Builder builder) {
        this.valueType_ = builder.build();
        this.valueTypeCase_ = 6;
    }
    ...
    public void mergeMapValue(MapValue mapValue) {
        if (this.valueTypeCase_ != 6 || this.valueType_ == MapValue.getDefaultInstance()) {
            ...
            this.valueType_ = ((com.google.firestore.p008v1.MapValue.Builder) MapValue.newBuilder((MapValue) this.valueType_).mergeFrom(mapValue)).buildPartial();
        }
        this.valueTypeCase_ = 6;
    }
                    ...
                    try {
                        ...
                        switch (readTag) {
                            ...
                            case 42:
                                ...
                                break;
                            case 50:
                                com.google.firestore.p008v1.MapValue.Builder builder = this.valueTypeCase_ == 6 ? (com.google.firestore.p008v1.MapValue.Builder) ((MapValue) this.valueType_).toBuilder() : null;
                            ...
                            case 66:
                                ...
                                break;
                            case 74:
                                com.google.firestore.p008v1.ArrayValue.Builder builder3 = this.valueTypeCase_ == 9 ? (com.google.firestore.p008v1.ArrayValue.Builder) ((ArrayValue) this.valueType_).toBuilder() : null;
