...
public final class CommitResponse extends GeneratedMessageLite<CommitResponse, Builder> implements CommitResponseOrBuilder {
    ...
    private ProtobufList<WriteResult> writeResults_ = emptyProtobufList();
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<CommitResponse, Builder> implements CommitResponseOrBuilder {
        ...
        public Builder setWriteResults(int i, com.google.firestore.p008v1.WriteResult.Builder builder) {
            copyOnWrite();
        ...
        public Builder addWriteResults(com.google.firestore.p008v1.WriteResult.Builder builder) {
            copyOnWrite();
            ((CommitResponse) this.instance).addWriteResults(builder);
            return this;
        }

        public Builder addWriteResults(int i, com.google.firestore.p008v1.WriteResult.Builder builder) {
            copyOnWrite();
    ...
    /* access modifiers changed from: private */
    public void setWriteResults(int i, com.google.firestore.p008v1.WriteResult.Builder builder) {
        ensureWriteResultsIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addWriteResults(com.google.firestore.p008v1.WriteResult.Builder builder) {
        ensureWriteResultsIsMutable();
        this.writeResults_.add((WriteResult) builder.build());
    }

    /* access modifiers changed from: private */
    public void addWriteResults(int i, com.google.firestore.p008v1.WriteResult.Builder builder) {
        ensureWriteResultsIsMutable();
    ...
    /* access modifiers changed from: private */
    public void setCommitTime(com.google.protobuf.Timestamp.Builder builder) {
