...
public final class Document extends GeneratedMessageLite<Document, Builder> implements DocumentOrBuilder {
    ...
    /* access modifiers changed from: private */
    public void setCreateTime(com.google.protobuf.Timestamp.Builder builder) {
    ...
    public int getSerializedSize() {
        ...
        for (Entry entry : internalGetFields().entrySet()) {
            i2 += FieldsDefaultEntryHolder.defaultEntry.computeMessageSize(2, (String) entry.getKey(), (Value) entry.getValue());
        }
        if (this.createTime_ != null) {
                    ...
                    try {
                        ...
                        if (readTag != 0) {
                            if (readTag == 10) {
                                ...
                                com.google.protobuf.Timestamp.Builder builder = this.createTime_ != null ? (com.google.protobuf.Timestamp.Builder) this.createTime_.toBuilder() : null;
                                ...
                                com.google.protobuf.Timestamp.Builder builder2 = this.updateTime_ != null ? (com.google.protobuf.Timestamp.Builder) this.updateTime_.toBuilder() : null;
