...
public final class TransactionOptions extends GeneratedMessageLite<TransactionOptions, Builder> implements TransactionOptionsOrBuilder {
    ...
    static /* synthetic */ class C16081 {
        ...
        /* renamed from: $SwitchMap$com$google$firestore$v1$TransactionOptions$ReadOnly$ConsistencySelectorCase */
        static final /* synthetic */ int[] f315x26256681 = new int[ConsistencySelectorCase.values().length];
        ...
        static {
            /*
                com.google.firestore.v1.TransactionOptions$ModeCase[] r0 = com.google.firestore.p008v1.TransactionOptions.ModeCase.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                ...
                com.google.firestore.v1.TransactionOptions$ModeCase r2 = com.google.firestore.p008v1.TransactionOptions.ModeCase.READ_ONLY     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r2 = r2.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r1[r2] = r0     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                r1 = 2
                int[] r2 = $SwitchMap$com$google$firestore$v1$TransactionOptions$ModeCase     // Catch:{ NoSuchFieldError -> 0x001f }
                com.google.firestore.v1.TransactionOptions$ModeCase r3 = com.google.firestore.p008v1.TransactionOptions.ModeCase.READ_WRITE     // Catch:{ NoSuchFieldError -> 0x001f }
                int r3 = r3.ordinal()     // Catch:{ NoSuchFieldError -> 0x001f }
                r2[r3] = r1     // Catch:{ NoSuchFieldError -> 0x001f }
            L_0x001f:
                r2 = 3
                int[] r3 = $SwitchMap$com$google$firestore$v1$TransactionOptions$ModeCase     // Catch:{ NoSuchFieldError -> 0x002a }
                com.google.firestore.v1.TransactionOptions$ModeCase r4 = com.google.firestore.p008v1.TransactionOptions.ModeCase.MODE_NOT_SET     // Catch:{ NoSuchFieldError -> 0x002a }
                int r4 = r4.ordinal()     // Catch:{ NoSuchFieldError -> 0x002a }
                r3[r4] = r2     // Catch:{ NoSuchFieldError -> 0x002a }
            L_0x002a:
                com.google.firestore.v1.TransactionOptions$ReadOnly$ConsistencySelectorCase[] r3 = com.google.firestore.p008v1.TransactionOptions.ReadOnly.ConsistencySelectorCase.values()
                int r3 = r3.length
                int[] r3 = new int[r3]
                f315x26256681 = r3
                int[] r3 = f315x26256681     // Catch:{ NoSuchFieldError -> 0x003d }
                com.google.firestore.v1.TransactionOptions$ReadOnly$ConsistencySelectorCase r4 = com.google.firestore.p008v1.TransactionOptions.ReadOnly.ConsistencySelectorCase.READ_TIME     // Catch:{ NoSuchFieldError -> 0x003d }
                int r4 = r4.ordinal()     // Catch:{ NoSuchFieldError -> 0x003d }
                r3[r4] = r0     // Catch:{ NoSuchFieldError -> 0x003d }
            L_0x003d:
                int[] r3 = f315x26256681     // Catch:{ NoSuchFieldError -> 0x0047 }
                com.google.firestore.v1.TransactionOptions$ReadOnly$ConsistencySelectorCase r4 = com.google.firestore.p008v1.TransactionOptions.ReadOnly.ConsistencySelectorCase.CONSISTENCYSELECTOR_NOT_SET     // Catch:{ NoSuchFieldError -> 0x0047 }
            ...
            L_0x0047:
                ...
                int[] r3 = new int[r3]
                f316xa1df5c61 = r3
                int[] r3 = f316xa1df5c61     // Catch:{ NoSuchFieldError -> 0x005a }
            ...
            L_0x005a:
                int[] r0 = f316xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0064 }
            ...
            L_0x0064:
                int[] r0 = f316xa1df5c61     // Catch:{ NoSuchFieldError -> 0x006e }
            ...
            L_0x006e:
                int[] r0 = f316xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0079 }
            ...
            L_0x0079:
                int[] r0 = f316xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                int[] r0 = f316xa1df5c61     // Catch:{ NoSuchFieldError -> 0x008f }
            ...
            L_0x008f:
                int[] r0 = f316xa1df5c61     // Catch:{ NoSuchFieldError -> 0x009a }
            ...
            L_0x009a:
                int[] r0 = f316xa1df5c61     // Catch:{ NoSuchFieldError -> 0x00a6 }
            ...
            L_0x00a6:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firestore.p008v1.TransactionOptions.C16081.<clinit>():void");
        }
    }
        ...
        public final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (methodToInvoke) {
                ...
                case VISIT:
                    ...
                    int i = C16081.f315x26256681[readOnly.getConsistencySelectorCase().ordinal()];
                    if (i == 1) {
                        if (this.consistencySelectorCase_ == 2) {
                            z = true;
                        }
                    ...
                    if (visitor == MergeFromVisitor.INSTANCE) {
                        int i2 = readOnly.consistencySelectorCase_;
                        if (i2 != 0) {
    ...
    /* access modifiers changed from: private */
    public void setReadOnly(Builder builder) {
    ...
    /* access modifiers changed from: private */
    public void setReadWrite(Builder builder) {
        this.mode_ = builder.build();
        this.modeCase_ = 3;
    }
    ...
    public final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                int i = C16081.$SwitchMap$com$google$firestore$v1$TransactionOptions$ModeCase[transactionOptions.getModeCase().ordinal()];
                if (i == 1) {
                    if (this.modeCase_ == 2) {
                        z = true;
                    }
                ...
                if (visitor == MergeFromVisitor.INSTANCE) {
                    int i2 = transactionOptions.modeCase_;
                    if (i2 != 0) {
                        this.modeCase_ = i2;
                    }
                }
