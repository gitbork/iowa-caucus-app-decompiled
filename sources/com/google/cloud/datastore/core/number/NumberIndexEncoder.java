...
public class NumberIndexEncoder {
    ...
    public static byte[] encode(NumberParts numberParts) {
        ...
        if (exponent < 4) {
            ...
            bArr2[0] = (byte) (((exponent - 4) | CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY) ^ ((i & 127) ^ i5));
            ...
            if (exponent < 148) {
                int i8 = exponent - 20;
                bArr2[0] = (byte) (((i8 >>> 4) | 240) ^ ((i & 127) ^ i5));
                significand <<= 4;
                bArr2[1] = (byte) ((((i8 << 4) & 240) | ((int) (significand >>> 60))) ^ ((i & 240) ^ i5));
                i3 = topSignificandByte(significand);
            } else if (exponent < EXP4_END) {
                int i9 = exponent - 148;
                bArr2[0] = (byte) ((248 | (i9 >>> 8)) ^ ((i & 127) ^ i5));
