...
public class GoogleSignInOptionsExtensionParcelable extends AbstractSafeParcelable {
    ...
    @Field(getter = "getBundle", mo15127id = 3)
    private Bundle mBundle;
    @Field(getter = "getType", mo15127id = 2)
    private int mType;
    @VersionField(mo15133id = 1)
    private final int versionCode;

    @Constructor
    GoogleSignInOptionsExtensionParcelable(@Param(mo15130id = 1) int i, @Param(mo15130id = 2) int i2, @Param(mo15130id = 3) Bundle bundle) {
        this.versionCode = i;
        this.mType = i2;
        this.mBundle = bundle;
    }
