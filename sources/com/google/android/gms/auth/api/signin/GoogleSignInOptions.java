...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Optional, ReflectedParcelable {
    ...
    @Field(getter = "isForceCodeForRefreshToken", mo15127id = 6)
    public final boolean zaaa;
    /* access modifiers changed from: private */
    @Field(getter = "getServerClientId", mo15127id = 7)
    public String zaab;
    /* access modifiers changed from: private */
    @Field(getter = "getHostedDomain", mo15127id = 8)
    public String zaac;
    /* access modifiers changed from: private */
    @Field(getter = "getExtensions", mo15127id = 9)
    ...
    /* access modifiers changed from: private */
    @Field(getter = "getScopes", mo15127id = 2)
    public final ArrayList<Scope> zaw;
    /* access modifiers changed from: private */
    @Field(getter = "getAccount", mo15127id = 3)
    public Account zax;
    /* access modifiers changed from: private */
    @Field(getter = "isIdTokenRequested", mo15127id = 4)
    public boolean zay;
    /* access modifiers changed from: private */
    @Field(getter = "isServerAuthCodeRequested", mo15127id = 5)
    ...
    @Constructor
    GoogleSignInOptions(@Param(mo15130id = 1) int i, @Param(mo15130id = 2) ArrayList<Scope> arrayList, @Param(mo15130id = 3) Account account, @Param(mo15130id = 4) boolean z, @Param(mo15130id = 5) boolean z2, @Param(mo15130id = 6) boolean z3, @Param(mo15130id = 7) String str, @Param(mo15130id = 8) String str2, @Param(mo15130id = 9) ArrayList<GoogleSignInOptionsExtensionParcelable> arrayList2) {
