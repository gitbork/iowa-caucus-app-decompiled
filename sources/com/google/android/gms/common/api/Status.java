...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    @Field(getter = "getStatusCode", mo15127id = 1)
    private final int zzh;
    @Field(getter = "getPendingIntent", mo15127id = 3)
    @Nullable
    private final PendingIntent zzi;
    @Field(getter = "getStatusMessage", mo15127id = 2)
    @Nullable
    private final String zzj;

    @Constructor
    @KeepForSdk
    Status(@Param(mo15130id = 1000) int i, @Param(mo15130id = 1) int i2, @Param(mo15130id = 2) @Nullable String str, @Param(mo15130id = 3) @Nullable PendingIntent pendingIntent) {
        this.zzg = i;
        this.zzh = i2;
        this.zzj = str;
