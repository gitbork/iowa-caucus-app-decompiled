...
public final class zak extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getSerializedDictionary", mo15127id = 2)
    private final ArrayList<zal> zaqw;
    @SafeParcelable.Field(getter = "getRootClassName", mo15127id = 3)
    private final String zaqx;

    @Constructor
    zak(@Param(mo15130id = 1) int i, @Param(mo15130id = 2) ArrayList<zal> arrayList, @Param(mo15130id = 3) String str) {
        this.zalf = i;
        this.zaqw = null;
