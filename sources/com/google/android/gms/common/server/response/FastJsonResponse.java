...
import p006io.invertase.firebase.BuildConfig;
...
public abstract class FastJsonResponse {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        @VersionField(getter = "getVersionCode", mo15133id = 1)
        private final int zalf;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getTypeIn", mo15127id = 2)
        protected final int zapr;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "isTypeInArray", mo15127id = 3)
        protected final boolean zaps;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getTypeOut", mo15127id = 4)
        protected final int zapt;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "isTypeOutArray", mo15127id = 5)
        protected final boolean zapu;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getOutputFieldName", mo15127id = 6)
        protected final String zapv;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getSafeParcelableFieldId", mo15127id = 7)
        protected final int zapw;
        protected final Class<? extends FastJsonResponse> zapx;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getConcreteTypeName", mo15127id = 8)
        private final String zapy;
        private zak zapz;
        /* access modifiers changed from: private */
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getWrappedConverter", mo15127id = 9, type = "com.google.android.gms.common.server.converter.ConverterWrapper")
        public FieldConverter<I, O> zaqa;

        @Constructor
        Field(@Param(mo15130id = 1) int i, @Param(mo15130id = 2) int i2, @Param(mo15130id = 3) boolean z, @Param(mo15130id = 4) int i3, @Param(mo15130id = 5) boolean z2, @Param(mo15130id = 6) String str, @Param(mo15130id = 7) int i4, @Param(mo15130id = 8) String str2, @Param(mo15130id = 9) zaa zaa) {
            this.zalf = i;
            this.zapr = i2;
            this.zaps = z;
            this.zapt = i3;
