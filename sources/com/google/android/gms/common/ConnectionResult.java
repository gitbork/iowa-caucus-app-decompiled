...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @Field(getter = "getErrorCode", mo15127id = 2)
    private final int zzh;
    @Field(getter = "getResolution", mo15127id = 3)
    private final PendingIntent zzi;
    @Field(getter = "getErrorMessage", mo15127id = 4)
    private final String zzj;

    @Constructor
    ConnectionResult(@Param(mo15130id = 1) int i, @Param(mo15130id = 2) int i2, @Param(mo15130id = 3) PendingIntent pendingIntent, @Param(mo15130id = 4) String str) {
        this.zzg = i;
        this.zzh = i2;
    ...
    public final String toString() {
        ...
        return Objects.toStringHelper(this).add("statusCode", zza(this.zzh)).add(str, this.zzi).add(JsonMarshaller.MESSAGE, this.zzj).toString();
    }
