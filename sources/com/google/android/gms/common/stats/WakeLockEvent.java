...
public final class WakeLockEvent extends StatsEvent {
    ...
    @Field(getter = "getTimeMillis", mo15127id = 2)
    private final long zzfo;
    @Field(getter = "getEventType", mo15127id = 11)
    private int zzfp;
    @Field(getter = "getWakeLockName", mo15127id = 4)
    private final String zzfq;
    @Field(getter = "getSecondaryWakeLockName", mo15127id = 10)
    private final String zzfr;
    @Field(getter = "getCodePackage", mo15127id = 17)
    private final String zzfs;
    @Field(getter = "getWakeLockType", mo15127id = 5)
    private final int zzft;
    @Field(getter = "getCallingPackages", mo15127id = 6)
    private final List<String> zzfu;
    @Field(getter = "getEventKey", mo15127id = 12)
    private final String zzfv;
    @Field(getter = "getElapsedRealtime", mo15127id = 8)
    private final long zzfw;
    @Field(getter = "getDeviceState", mo15127id = 14)
    private int zzfx;
    @Field(getter = "getHostPackage", mo15127id = 13)
    private final String zzfy;
    @Field(getter = "getBeginPowerPercentage", mo15127id = 15)
    private final float zzfz;
    @Field(getter = "getTimeout", mo15127id = 16)
    private final long zzga;
    @Field(getter = "getAcquiredWithTimeout", mo15127id = 18)
    private final boolean zzgb;

    @Constructor
    WakeLockEvent(@Param(mo15130id = 1) int i, @Param(mo15130id = 2) long j, @Param(mo15130id = 11) int i2, @Param(mo15130id = 4) String str, @Param(mo15130id = 5) int i3, @Param(mo15130id = 6) List<String> list, @Param(mo15130id = 12) String str2, @Param(mo15130id = 8) long j2, @Param(mo15130id = 14) int i4, @Param(mo15130id = 10) String str3, @Param(mo15130id = 13) String str4, @Param(mo15130id = 15) float f, @Param(mo15130id = 16) long j3, @Param(mo15130id = 17) String str5, @Param(mo15130id = 18) boolean z) {
        this.versionCode = i;
        this.zzfo = j;
        this.zzfp = i2;
        this.zzfq = str;
