...
public class ClientIdentity extends AbstractSafeParcelable {
    ...
    @Field(defaultValueUnchecked = "null", mo15127id = 2)
    @Nullable
    private final String packageName;
    @Field(defaultValueUnchecked = "0", mo15127id = 1)
    private final int uid;

    @Constructor
    public ClientIdentity(@Param(mo15130id = 1) int i, @Param(mo15130id = 2) @Nullable String str) {
        this.uid = i;
