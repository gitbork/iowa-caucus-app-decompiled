...
public class ResolveAccountResponse extends AbstractSafeParcelable {
    ...
    @Field(getter = "getConnectionResult", mo15127id = 3)
    private ConnectionResult zadi;
    @Field(getter = "getSaveDefaultAccount", mo15127id = 4)
    private boolean zagg;
    @VersionField(mo15133id = 1)
    private final int zalf;
    @Field(mo15127id = 2)
    private IBinder zanx;
    @Field(getter = "isFromCrossClientAuth", mo15127id = 5)
    private boolean zapc;

    @Constructor
    ResolveAccountResponse(@Param(mo15130id = 1) int i, @Param(mo15130id = 2) IBinder iBinder, @Param(mo15130id = 3) ConnectionResult connectionResult, @Param(mo15130id = 4) boolean z, @Param(mo15130id = 5) boolean z2) {
        this.zalf = i;
        this.zanx = iBinder;
