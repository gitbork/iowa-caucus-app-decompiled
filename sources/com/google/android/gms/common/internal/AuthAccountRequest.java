...
public class AuthAccountRequest extends AbstractSafeParcelable {
    ...
    @Field(mo15127id = 6, type = "android.accounts.Account")
    private Account zax;

    @Constructor
    AuthAccountRequest(@Param(mo15130id = 1) int i, @Param(mo15130id = 2) IBinder iBinder, @Param(mo15130id = 3) Scope[] scopeArr, @Param(mo15130id = 4) Integer num, @Param(mo15130id = 5) Integer num2, @Param(mo15130id = 6) Account account) {
        this.zalf = i;
        this.zanx = iBinder;
        this.zany = scopeArr;
        this.zanz = num;
