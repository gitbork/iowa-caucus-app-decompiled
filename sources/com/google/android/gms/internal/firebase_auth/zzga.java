...
import com.google.android.gms.internal.firebase_auth.zzp.zzv;
import com.google.firebase.auth.api.internal.zzea;
import java.util.ArrayList;
import java.util.List;

/* compiled from: com.google.firebase:firebase-auth@@18.1.0 */
public final class zzga implements zzea<zzga, zzv> {
    private String zza;
    private String zzb;
    private String zzc;
    private String zzd;
    ...
    public final zzjq<zzv> zza() {
        return zzv.zzj();
    }

    public final /* synthetic */ zzea zza(zzjg zzjg) {
        if (zzjg instanceof zzv) {
            zzv zzv = (zzv) zzjg;
