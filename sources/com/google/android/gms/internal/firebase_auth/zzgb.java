...
import com.google.android.gms.internal.firebase_auth.zzp.zzx;
import com.google.firebase.auth.api.internal.zzea;

/* compiled from: com.google.firebase:firebase-auth@@18.1.0 */
public final class zzgb implements zzea<zzgb, zzx> {
    private String zza;
    private String zzb;
    private long zzc;
    private String zzd;
    ...
    public final zzjq<zzx> zza() {
        return zzx.zzj();
    }

    public final /* synthetic */ zzea zza(zzjg zzjg) {
        if (zzjg instanceof zzx) {
            zzx zzx = (zzx) zzjg;
