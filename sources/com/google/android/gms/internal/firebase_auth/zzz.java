...
public final class zzz extends zzhx<zzz, zza> implements zzji {
    ...
    /* compiled from: com.google.firebase:firebase-auth@@18.1.0 */
    public static final class zza extends zzb<zzz, zza> implements zzji {
        private zza() {
            super(zzz.zzab);
        }
            ...
            case 5:
                ...
                if (zzjq == null) {
                    synchronized (zzz.class) {
                        zzjq = zzac;
                        if (zzjq == null) {
                            zzjq = new com.google.android.gms.internal.firebase_auth.zzhx.zza<>(zzab);
                            zzac = zzjq;
                        }
                    }
                }
