        ...
        while (r9 < i3) {
            ...
            if (b < 0) {
                if (b < -32) {
                    ...
                    int i6 = i4 + 1;
                    byte b3 = bArr[i4];
                    if (b3 <= -65 && (((b << Ascii.f152FS) + (b3 + 112)) >> 30) == 0) {
                        int i7 = i6 + 1;
                        if (bArr[i6] <= -65) {
                            i4 = i7 + 1;
                            if (bArr[i7] > -65) {
            ...
            while (r13 < i3) {
                ...
                if (zzkz.zzd(b2)) {
                    ...
                    if (i7 < i3 - 1) {
                        ...
                        int i13 = i12 + 1;
                        int i14 = i6 + 1;
                        zzkz.zzb(b2, bArr[i7], bArr[i12], cArr, i6);
                        r13 = i13;
                        i6 = i14;
                    } else {
                        throw zzig.zzi();
                    ...
                    int i17 = i16 + 1;
                    int i18 = i6 + 1;
                    zzkz.zzb(b2, b4, bArr[i15], bArr[i16], cArr, i6);
                    r13 = i17;
                    i6 = i18 + 1;
                } else {
                    throw zzig.zzi();
