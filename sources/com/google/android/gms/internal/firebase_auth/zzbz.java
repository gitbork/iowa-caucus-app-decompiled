...
public final class zzbz extends AbstractSafeParcelable {
    public static final Creator<zzbz> CREATOR = new zzcc();
    ...
    @Constructor
    public zzbz(@Param(mo15130id = 1) String str, @Param(mo15130id = 2) String str2, @Param(mo15130id = 3) @Nullable String str3) {
        this.zza = str;
        this.zzb = str2;
        this.zzc = str3;
    }
