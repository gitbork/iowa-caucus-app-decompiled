...
import com.google.android.gms.internal.firebase_auth.zzp.zzm.zza;
import com.google.firebase.auth.api.internal.zzfk;
import java.util.Arrays;
import java.util.List;

/* compiled from: com.google.firebase:firebase-auth@@18.1.0 */
public final class zzfl implements zzfk<zzm> {
    private String zza;
    private String zzb;
    private String zzc;
    private String zzd;
    ...
    public final /* synthetic */ zzjg zza() {
        zzv zzv;
        zza zzb2 = zzm.zza().zza(this.zzh).zzb((Iterable<String>) this.zzf.zza());
        ...
        zza zza3 = zzb2.zza((Iterable<? extends zzv>) Arrays.asList(zzvArr));
