...
final class zzhq<T extends zzhs<T>> {
    ...
    private static <T extends zzhs<T>> boolean zza(Entry<T, Object> entry) {
    ...
    public final /* synthetic */ Object clone() throws CloneNotSupportedException {
        ...
        for (int i = 0; i < this.zza.zzc(); i++) {
            ...
            zzhq.zzb((T) (zzhs) zzb2.getKey(), zzb2.getValue());
        }
        for (Entry entry : this.zza.zzd()) {
            zzhq.zzb((T) (zzhs) entry.getKey(), entry.getValue());
        }
        zzhq.zzc = this.zzc;
        return zzhq;
    }
