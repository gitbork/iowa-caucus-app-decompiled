...
public final class zzcn extends AbstractSafeParcelable {
    public static final Creator<zzcn> CREATOR = new zzcq();
    @Field(getter = "getCachedState", mo15127id = 1)
    private final String zza;
    @Field(getter = "getVerifyAssertionRequest", mo15127id = 2)
    private final zzfr zzb;

    @Constructor
    public zzcn(@Param(mo15130id = 1) String str, @Param(mo15130id = 2) zzfr zzfr) {
        this.zza = str;
        this.zzb = zzfr;
    }
