...
final class zzds<T> implements zzef<T> {
    ...
    /* JADX WARNING: type inference failed for: r0v15, types: [byte, int] */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:124:0x035b, code lost:
        ...
        r2 = r0;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:164:0x0016, code lost:
        r12 = r12;
        r1 = r1;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:97:0x0267, code lost:
        ...
        r25 = r10;
     */
    /* JADX WARNING: Incorrect type for immutable var: ssa=byte, code=null, for r0v15, types: [byte, int] */
    ...
    static <T> zzds<T> zza(Class<T> cls, zzdm zzdm, zzdw zzdw, zzcy zzcy, zzex<?, ?> zzex, zzbu<?> zzbu, zzdj zzdj) {
        ...
        if (zzdm2 instanceof zzec) {
            ...
            zzds zzds = new zzds(iArr, objArr, i2, i, zzec.zzcv(), zzec.zzch(), z, false, zzec.zzct(), iArr2, iArr3, zzdw, zzcy, zzex, zzbu, zzdj);
            return zzds;
        }
        ((zzes) zzdm2).zzcf();
