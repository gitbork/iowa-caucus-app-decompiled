        ...
        if (length <= 32) {
            ...
            while (true) {
                ...
                if (i11 == i10) {
                    ...
                    long rotateRight5 = Long.rotateRight(rotateRight3 + jArr[1] + zzb(bArr2, i7 + 48), 42) * j8;
                    long rotateRight6 = (Long.rotateRight(((rotateRight4 + rotateRight3) + jArr[0]) + zzb(bArr2, i7 + 8), 37) * j8) ^ (jArr2[1] * 9);
                    long zzb13 = rotateRight5 + (jArr[0] * 9) + zzb(bArr2, i7 + 40);
                    long rotateRight7 = Long.rotateRight(rotateRight2 + jArr2[0], 33) * j8;
                    zza(bArr, i7, jArr[1] * j8, rotateRight6 + jArr2[0], jArr);
                    zza(bArr, i7 + 32, jArr2[1] + rotateRight7, zzb13 + zzb(bArr2, i7 + 16), jArr2);
                    long j9 = j8;
                    return zza(zza(jArr[0], jArr2[0], j9) + ((zzb13 ^ (zzb13 >>> 47)) * -4348849565147123417L) + rotateRight6, zza(jArr[1], jArr2[1], j9) + rotateRight7, j9);
                }
                i8 = i11;
                i5 = i10;
                i6 = i9;
