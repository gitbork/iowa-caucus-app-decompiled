...
final class zzfp<FieldDescriptorType extends zzfr<FieldDescriptorType>> {
    ...
    public final void zza(FieldDescriptorType fielddescriptortype, Object obj) {
        ...
        if (r7 instanceof zzgi) {
            this.zzto = true;
        }
        this.zztm.put(fielddescriptortype, r7);
    }
    ...
    private final void zzc(Entry<FieldDescriptorType, Object> entry) {
        ...
        if (zzfr.zzeu()) {
            Object zza = zza((FieldDescriptorType) zzfr);
            if (zza == null) {
                zza = new ArrayList();
            }
            ...
            Object zza2 = zza((FieldDescriptorType) zzfr);
            if (zza2 == null) {
    ...
    public final int zzeq() {
        ...
        for (int i2 = 0; i2 < this.zztm.zzgu(); i2++) {
            Entry zzbp = this.zztm.zzbp(i2);
            i += zzc((zzfr) zzbp.getKey(), zzbp.getValue());
        }
        for (Entry entry : this.zztm.zzgv()) {
            i += zzc((zzfr) entry.getKey(), entry.getValue());
        }
        return i;
    }
    ...
    public final /* synthetic */ Object clone() throws CloneNotSupportedException {
        zzfp zzfp = new zzfp();
        for (int i = 0; i < this.zztm.zzgu(); i++) {
            Entry zzbp = this.zztm.zzbp(i);
            zzfp.zza((FieldDescriptorType) (zzfr) zzbp.getKey(), zzbp.getValue());
        }
        for (Entry entry : this.zztm.zzgv()) {
            zzfp.zza((FieldDescriptorType) (zzfr) entry.getKey(), entry.getValue());
        }
        zzfp.zzto = this.zzto;
        return zzfp;
    }
