...
final class zzix {
    ...
    public static void zza(byte b, byte b2, char[] cArr, int i) throws zzgf {
        ...
        cArr[i] = (char) (((b & Ascii.f161US) << 6) | (b2 & 63));
    }
    ...
    public static void zza(byte b, byte b2, byte b3, char[] cArr, int i) throws zzgf {
        ...
        cArr[i] = (char) (((b & Ascii.f158SI) << Ascii.f151FF) | ((b2 & 63) << 6) | (b3 & 63));
    }

    /* access modifiers changed from: private */
    public static void zza(byte b, byte b2, byte b3, byte b4, char[] cArr, int i) throws zzgf {
        if (zzg(b2) || (((b << Ascii.f152FS) + (b2 + 112)) >> 30) != 0 || zzg(b3) || zzg(b4)) {
            throw zzgf.zzfp();
        }
        byte b5 = ((b & 7) << Ascii.DC2) | ((b2 & 63) << Ascii.f151FF) | ((b3 & 63) << 6) | (b4 & 63);
