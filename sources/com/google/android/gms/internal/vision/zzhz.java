...
class zzhz<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public boolean containsKey(Object obj) {
        ...
        return zza((K) comparable) >= 0 || this.zzaag.containsKey(comparable);
    }
    ...
    public final V put(K k, V v) {
        ...
        int i2 = this.zzaae;
        if (size == i2) {
            zzig zzig = (zzig) this.zzaaf.remove(i2 - 1);
    ...
    private final int zza(K k) {
        ...
        if (size >= 0) {
            int compareTo = k.compareTo((Comparable) ((zzig) this.zzaaf.get(size)).getKey());
            if (compareTo > 0) {
                return -(size + 2);
            }
            if (compareTo == 0) {
        ...
        while (i <= size) {
            int i2 = (i + size) / 2;
            int compareTo2 = k.compareTo((Comparable) ((zzig) this.zzaaf.get(i2)).getKey());
            if (compareTo2 < 0) {
                size = i2 - 1;
