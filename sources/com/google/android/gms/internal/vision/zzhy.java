...
final class zzhy {
    ...
    static int zzq(List<Long> list) {
        ...
        if (list instanceof zzgt) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzfe.zzh(((Long) list.get(i2)).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzr(List<Long> list) {
        ...
        if (list instanceof zzgt) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzfe.zzi(((Long) list.get(i2)).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzs(List<Long> list) {
        ...
        if (list instanceof zzgt) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzfe.zzj(((Long) list.get(i2)).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzt(List<Integer> list) {
        ...
        if (list instanceof zzfz) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzfe.zzbb(((Integer) list.get(i2)).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzu(List<Integer> list) {
        ...
        if (list instanceof zzfz) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzfe.zzaw(((Integer) list.get(i2)).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzv(List<Integer> list) {
        ...
        if (list instanceof zzfz) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzfe.zzax(((Integer) list.get(i2)).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzw(List<Integer> list) {
        ...
        if (list instanceof zzfz) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzfe.zzay(((Integer) list.get(i2)).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzd(int i, List<zzeo> list) {
        ...
        for (int i2 = 0; i2 < list.size(); i2++) {
            zzav += zzfe.zzb((zzeo) list.get(i2));
        }
        return zzav;
    }
    ...
    static int zzd(int i, List<zzhf> list, zzhw zzhw) {
        ...
        int i2 = 0;
        for (int i3 = 0; i3 < size; i3++) {
            i2 += zzfe.zzc(i, (zzhf) list.get(i3), zzhw);
        }
        return i2;
    }
