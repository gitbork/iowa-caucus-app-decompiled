...
public final class zzjk {
    ...
    public final int zzdt() throws IOException {
        ...
        byte b2 = zzdy & Ascii.DEL;
        byte zzdy2 = zzdy();
        if (zzdy2 >= 0) {
            i = zzdy2 << 7;
        } else {
            b2 |= (zzdy2 & Ascii.DEL) << 7;
            byte zzdy3 = zzdy();
            if (zzdy3 >= 0) {
                i = zzdy3 << Ascii.f159SO;
            } else {
                b2 |= (zzdy3 & Ascii.DEL) << Ascii.f159SO;
                byte zzdy4 = zzdy();
                if (zzdy4 >= 0) {
                    i = zzdy4 << Ascii.NAK;
                } else {
                    byte b3 = b2 | ((zzdy4 & Ascii.DEL) << Ascii.NAK);
                    byte zzdy5 = zzdy();
                    b = b3 | (zzdy5 << Ascii.f152FS);
                    if (zzdy5 < 0) {
