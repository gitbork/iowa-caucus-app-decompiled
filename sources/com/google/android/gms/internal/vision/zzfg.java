...
final class zzfg implements zzjj {
    ...
    public final void zza(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzfe.zzaw(((Integer) list.get(i4)).intValue());
            }
            this.zzsd.zzas(i3);
            while (i2 < list.size()) {
    ...
    public final void zzb(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzfe.zzaz(((Integer) list.get(i4)).intValue());
            }
            this.zzsd.zzas(i3);
            while (i2 < list.size()) {
    ...
    public final void zzc(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzfe.zzh(((Long) list.get(i4)).longValue());
            }
            this.zzsd.zzas(i3);
            while (i2 < list.size()) {
    ...
    public final void zzd(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzfe.zzi(((Long) list.get(i4)).longValue());
            }
            this.zzsd.zzas(i3);
            while (i2 < list.size()) {
                this.zzsd.zze(((Long) list.get(i2)).longValue());
    ...
    public final void zze(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzfe.zzk(((Long) list.get(i4)).longValue());
            }
            this.zzsd.zzas(i3);
            while (i2 < list.size()) {
    ...
    public final void zzf(int i, List<Float> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzfe.zzg(((Float) list.get(i4)).floatValue());
            }
            this.zzsd.zzas(i3);
            while (i2 < list.size()) {
    ...
    public final void zzg(int i, List<Double> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzfe.zzb(((Double) list.get(i4)).doubleValue());
            }
            this.zzsd.zzas(i3);
            while (i2 < list.size()) {
    ...
    public final void zzh(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzfe.zzbb(((Integer) list.get(i4)).intValue());
            }
            this.zzsd.zzas(i3);
            while (i2 < list.size()) {
                this.zzsd.zzar(((Integer) list.get(i2)).intValue());
    ...
    public final void zzi(int i, List<Boolean> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzfe.zzi(((Boolean) list.get(i4)).booleanValue());
            }
            this.zzsd.zzas(i3);
            while (i2 < list.size()) {
    ...
    public final void zzj(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzfe.zzax(((Integer) list.get(i4)).intValue());
            }
            this.zzsd.zzas(i3);
            while (i2 < list.size()) {
    ...
    public final void zzk(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzfe.zzba(((Integer) list.get(i4)).intValue());
            }
            this.zzsd.zzas(i3);
            while (i2 < list.size()) {
                this.zzsd.zzau(((Integer) list.get(i2)).intValue());
    ...
    public final void zzl(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzfe.zzl(((Long) list.get(i4)).longValue());
            }
            this.zzsd.zzas(i3);
            while (i2 < list.size()) {
                this.zzsd.zzg(((Long) list.get(i2)).longValue());
    ...
    public final void zzm(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzfe.zzay(((Integer) list.get(i4)).intValue());
            }
            this.zzsd.zzas(i3);
            while (i2 < list.size()) {
    ...
    public final void zzn(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzfe.zzj(((Long) list.get(i4)).longValue());
            }
            this.zzsd.zzas(i3);
            while (i2 < list.size()) {
