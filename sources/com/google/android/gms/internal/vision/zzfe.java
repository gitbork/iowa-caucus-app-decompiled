...
public abstract class zzfe extends zzen {
    ...
    static class zza extends zzfe {
        ...
        public final void zzau(int r5) throws java.io.IOException {
            /*
                r4 = this;
            ...
            L_0x0032:
                r5 = move-exception
                com.google.android.gms.internal.vision.zzfe$zzc r0 = new com.google.android.gms.internal.vision.zzfe$zzc
                r1 = 3
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.vision.zzfe.zza.zzau(int):void");
        }
    ...
    static final class zze extends zzfe {
        ...
        public final void zzas(int i) throws IOException {
            ...
            while (true) {
                long j3 = this.zztb;
                if (j3 >= this.zzsz) {
                    throw new zzc(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Long.valueOf(j3), Long.valueOf(this.zzsz), Integer.valueOf(1)}));
                } else if ((i & -128) == 0) {
                    this.zztb = 1 + j3;
                    zziu.zza(j3, (byte) i);
                    return;
        ...
        public final void zze(long j) throws IOException {
            ...
            while (true) {
                long j4 = this.zztb;
                if (j4 >= this.zzsz) {
                    throw new zzc(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Long.valueOf(j4), Long.valueOf(this.zzsz), Integer.valueOf(1)}));
                } else if ((j & -128) == 0) {
                    this.zztb = 1 + j4;
