...
final class zzet<FieldDescriptorType extends zzev<FieldDescriptorType>> {
    ...
    public final Iterator<Entry<FieldDescriptorType, Object>> zzd() {
        if (this.zzc) {
    ...
    public final Iterator<Entry<FieldDescriptorType, Object>> zze() {
        if (this.zzc) {
    ...
    private final void zzb(FieldDescriptorType fielddescriptortype, Object obj) {
        ...
        if (r7 instanceof zzfo) {
            this.zzc = true;
        }
        this.zza.put(fielddescriptortype, r7);
    }
    ...
    private static boolean zza(Entry<FieldDescriptorType, Object> entry) {
    ...
    private final void zzb(Entry<FieldDescriptorType, Object> entry) {
        Object obj;
        zzev zzev = (zzev) entry.getKey();
        Object value = entry.getValue();
        ...
        if (zzev.zzd()) {
            Object zza2 = zza((FieldDescriptorType) zzev);
            if (zza2 == null) {
                zza2 = new ArrayList();
            }
            ...
            Object zza4 = zza((FieldDescriptorType) zzev);
            if (zza4 == null) {
    ...
    private static int zzc(Entry<FieldDescriptorType, Object> entry) {
        zzev zzev = (zzev) entry.getKey();
        Object value = entry.getValue();
        if (zzev.zzc() != zzio.MESSAGE || zzev.zzd() || zzev.zze()) {
            return zza(zzev, value);
        }
        if (value instanceof zzfo) {
    ...
    public final /* synthetic */ Object clone() throws CloneNotSupportedException {
        ...
        for (int i = 0; i < this.zza.zzc(); i++) {
            ...
            zzet.zzb((FieldDescriptorType) (zzev) zzb2.getKey(), zzb2.getValue());
        }
        for (Entry entry : this.zza.zzd()) {
            zzet.zzb((FieldDescriptorType) (zzev) entry.getKey(), entry.getValue());
        }
        zzet.zzc = this.zzc;
        return zzet;
    }
