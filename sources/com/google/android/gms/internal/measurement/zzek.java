    ...
    static class zza extends zzek {
        ...
        public final void zza(byte b) throws IOException {
            try {
                ...
                throw new zzb(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zze), Integer.valueOf(this.zzd), Integer.valueOf(1)}), e);
            }
        }
        ...
        public final void zzb(int i) throws IOException {
            if (!zzek.zzc || zzdo.zza() || zza() < 5) {
                ...
                int i16 = this.zze;
                this.zze = i16 + 1;
                zzia.zza(bArr11, (long) i16, (byte) i15);
            }
        }
