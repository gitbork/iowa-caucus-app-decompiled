...
final class zzga implements zzhf {
    ...
    public final <T> zzhc<T> zza(Class<T> cls) {
        ...
        if (zzb2.zzb()) {
            ...
            return zzgr.zza(cls, zzb2, zzgx.zzb(), zzfx.zzb(), zzhe.zzc(), null, zzgi.zzb());
        } else if (zza(zzb2)) {
            return zzgr.zza(cls, zzb2, zzgx.zza(), zzfx.zza(), zzhe.zza(), zzeu.zzb(), zzgi.zza());
        } else {
            return zzgr.zza(cls, zzb2, zzgx.zza(), zzfx.zza(), zzhe.zzb(), null, zzgi.zza());
        }
    }

    private static boolean zza(zzgl zzgl) {
        return zzgl.zza() == zzd.zzh;
    }
