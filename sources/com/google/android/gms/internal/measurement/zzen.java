...
final class zzen implements zzir {
    ...
    public final void zza(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzek.zzf(((Integer) list.get(i4)).intValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
    ...
    public final void zzb(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzek.zzi(((Integer) list.get(i4)).intValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
    ...
    public final void zzc(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzek.zzd(((Long) list.get(i4)).longValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
    ...
    public final void zzd(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzek.zze(((Long) list.get(i4)).longValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
                this.zza.zza(((Long) list.get(i2)).longValue());
    ...
    public final void zze(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzek.zzg(((Long) list.get(i4)).longValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
    ...
    public final void zzf(int i, List<Float> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzek.zzb(((Float) list.get(i4)).floatValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
    ...
    public final void zzg(int i, List<Double> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzek.zzb(((Double) list.get(i4)).doubleValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
    ...
    public final void zzh(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzek.zzk(((Integer) list.get(i4)).intValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
                this.zza.zza(((Integer) list.get(i2)).intValue());
    ...
    public final void zzi(int i, List<Boolean> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzek.zzb(((Boolean) list.get(i4)).booleanValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
    ...
    public final void zzb(int i, List<zzdv> list) throws IOException {
        for (int i2 = 0; i2 < list.size(); i2++) {
            this.zza.zza(i, (zzdv) list.get(i2));
        }
    }
    ...
    public final void zzj(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzek.zzg(((Integer) list.get(i4)).intValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
    ...
    public final void zzk(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzek.zzj(((Integer) list.get(i4)).intValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
                this.zza.zzd(((Integer) list.get(i2)).intValue());
    ...
    public final void zzl(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzek.zzh(((Long) list.get(i4)).longValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
                this.zza.zzc(((Long) list.get(i2)).longValue());
    ...
    public final void zzm(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzek.zzh(((Integer) list.get(i4)).intValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
    ...
    public final void zzn(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzek.zzf(((Long) list.get(i4)).longValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
    ...
    public final <K, V> void zza(int i, zzge<K, V> zzge, Map<K, V> map) throws IOException {
        for (Entry entry : map.entrySet()) {
            this.zza.zza(i, 2);
            this.zza.zzb(zzgf.zza(zzge, entry.getKey(), entry.getValue()));
            zzgf.zza(this.zza, zzge, entry.getKey(), entry.getValue());
        }
    }
}
