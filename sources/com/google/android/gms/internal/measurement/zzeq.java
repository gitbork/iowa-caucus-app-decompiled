...
public class zzeq {
    ...
    public final <ContainingType extends zzgn> zze<ContainingType, ?> zza(ContainingType containingtype, int i) {
        return (zze) this.zzg.get(new zza(containingtype, i));
    }
