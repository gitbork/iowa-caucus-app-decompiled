...
public final class zzi extends AbstractSafeParcelable implements Comparable<zzi> {
    ...
    @Constructor
    public zzi(@Param(mo15130id = 2) String str, @Param(mo15130id = 3) long j, @Param(mo15130id = 4) boolean z, @Param(mo15130id = 5) double d, @Param(mo15130id = 6) String str2, @Param(mo15130id = 7) byte[] bArr, @Param(mo15130id = 8) int i, @Param(mo15130id = 9) int i2) {
        this.name = str;
        this.zzab = j;
        this.zzac = z;
        this.zzad = d;
