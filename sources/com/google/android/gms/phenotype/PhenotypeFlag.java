...
public abstract class PhenotypeFlag<T> {
    ...
    public static class Factory {
        ...
        public Factory withGservicePrefix(String str) {
            boolean z = this.zzbb;
            if (!z) {
                Factory factory = new Factory(this.zzax, this.zzay, str, this.zzba, z, this.zzbc);
                return factory;
            }
        ...
        public Factory withPhenotypePrefix(String str) {
            Factory factory = new Factory(this.zzax, this.zzay, this.zzaz, str, this.zzbb, this.zzbc);
            return factory;
        }
    }
    ...
    private final T zzd() {
        if (zza("gms:phenotype:phenotype_flag:debug_bypass_phenotype", false)) {
            ...
            String str2 = (String) zza((zza<V>) new zzo<V>(this, zza.zza(zzal.getContentResolver(), this.zzao.zzay)));
            if (str2 != null) {
                return zza(str2);
            }
