...
public final class zaa extends AbstractSafeParcelable implements Result {
    ...
    @Field(getter = "getConnectionResultCode", mo15127id = 2)
    private int zarz;
    @Field(getter = "getRawAuthResolutionIntent", mo15127id = 3)
    private Intent zasa;

    @Constructor
    zaa(@Param(mo15130id = 1) int i, @Param(mo15130id = 2) int i2, @Param(mo15130id = 3) Intent intent) {
        this.zalf = i;
        this.zarz = i2;
        this.zasa = intent;
    }
