...
public final class zaj extends AbstractSafeParcelable {
    ...
    @Field(getter = "getConnectionResult", mo15127id = 2)
    private final ConnectionResult zadi;
    @VersionField(mo15133id = 1)
    private final int zalf;
    @Field(getter = "getResolveAccountResponse", mo15127id = 3)
    private final ResolveAccountResponse zase;

    @Constructor
    zaj(@Param(mo15130id = 1) int i, @Param(mo15130id = 2) ConnectionResult connectionResult, @Param(mo15130id = 3) ResolveAccountResponse resolveAccountResponse) {
        this.zalf = i;
