...
public class AppMeasurement {
    ...
    public static class ConditionalUserProperty {
        ...
        private ConditionalUserProperty(@NonNull Bundle bundle) {
            ...
            this.mAppId = (String) zzgk.zza(bundle, "app_id", String.class, null);
            this.mOrigin = (String) zzgk.zza(bundle, "origin", String.class, null);
            this.mName = (String) zzgk.zza(bundle, com.google.android.gms.measurement.api.AppMeasurementSdk.ConditionalUserProperty.NAME, String.class, null);
            this.mValue = zzgk.zza(bundle, "value", Object.class, null);
            this.mTriggerEventName = (String) zzgk.zza(bundle, com.google.android.gms.measurement.api.AppMeasurementSdk.ConditionalUserProperty.TRIGGER_EVENT_NAME, String.class, null);
            Long valueOf = Long.valueOf(0);
            this.mTriggerTimeout = ((Long) zzgk.zza(bundle, com.google.android.gms.measurement.api.AppMeasurementSdk.ConditionalUserProperty.TRIGGER_TIMEOUT, Long.class, valueOf)).longValue();
            this.mTimedOutEventName = (String) zzgk.zza(bundle, com.google.android.gms.measurement.api.AppMeasurementSdk.ConditionalUserProperty.TIMED_OUT_EVENT_NAME, String.class, null);
            this.mTimedOutEventParams = (Bundle) zzgk.zza(bundle, com.google.android.gms.measurement.api.AppMeasurementSdk.ConditionalUserProperty.TIMED_OUT_EVENT_PARAMS, Bundle.class, null);
            this.mTriggeredEventName = (String) zzgk.zza(bundle, com.google.android.gms.measurement.api.AppMeasurementSdk.ConditionalUserProperty.TRIGGERED_EVENT_NAME, String.class, null);
            this.mTriggeredEventParams = (Bundle) zzgk.zza(bundle, com.google.android.gms.measurement.api.AppMeasurementSdk.ConditionalUserProperty.TRIGGERED_EVENT_PARAMS, Bundle.class, null);
            this.mTimeToLive = ((Long) zzgk.zza(bundle, com.google.android.gms.measurement.api.AppMeasurementSdk.ConditionalUserProperty.TIME_TO_LIVE, Long.class, valueOf)).longValue();
            this.mExpiredEventName = (String) zzgk.zza(bundle, com.google.android.gms.measurement.api.AppMeasurementSdk.ConditionalUserProperty.EXPIRED_EVENT_NAME, String.class, null);
            this.mExpiredEventParams = (Bundle) zzgk.zza(bundle, com.google.android.gms.measurement.api.AppMeasurementSdk.ConditionalUserProperty.EXPIRED_EVENT_PARAMS, Bundle.class, null);
        }
    ...
    private static AppMeasurement zza(Context context, String str, String str2) {
        if (zza == null) {
            synchronized (AppMeasurement.class) {
                if (zza == null) {
                    zzhp zzb2 = zzb(context, null);
                    if (zzb2 != null) {
                        zza = new AppMeasurement(zzb2);
                    } else {
                        zza = new AppMeasurement(zzfn.zza(context, null, null, null));
                    }
                }
            }
        }
    ...
    public static AppMeasurement zza(Context context, Bundle bundle) {
        if (zza == null) {
            synchronized (AppMeasurement.class) {
                if (zza == null) {
                    zzhp zzb2 = zzb(context, bundle);
                    if (zzb2 != null) {
                        zza = new AppMeasurement(zzb2);
                    } else {
                        zza = new AppMeasurement(zzfn.zza(context, null, null, bundle));
                    }
                }
            }
        }
    ...
    private static com.google.android.gms.measurement.internal.zzhp zzb(android.content.Context r8, android.os.Bundle r9) {
        /*
            r0 = 0
            ...
            com.google.android.gms.measurement.internal.zzhp r8 = (com.google.android.gms.measurement.internal.zzhp) r8     // Catch:{  }
            return r8
        L_0x0027:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.AppMeasurement.zzb(android.content.Context, android.os.Bundle):com.google.android.gms.measurement.internal.zzhp");
    }
    ...
    private AppMeasurement(zzfn zzfn) {
    ...
    private AppMeasurement(zzhp zzhp) {
    ...
    public Map<String, Object> getUserProperties(boolean z) {
        ...
        List<zzjw> zzc2 = this.zzb.zzh().zzc(z);
    ...
    public List<ConditionalUserProperty> getConditionalUserPropertiesAs(@Size(min = 1) @NonNull String str, @Nullable String str2, @Size(max = 23, min = 1) @Nullable String str3) {
        int i;
        if (!this.zzd) {
            ArrayList zza2 = this.zzb.zzh().zza(str, str2, str3);
            int i2 = 0;
            if (zza2 == null) {
                i = 0;
            } else {
