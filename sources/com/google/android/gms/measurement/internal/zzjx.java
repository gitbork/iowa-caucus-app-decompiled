...
public final class zzjx extends zzgi {
    ...
    public final zzai zza(String str, String str2, Bundle bundle, String str3, long j, boolean z, boolean z2) {
        ...
        if (zzb(str2) == 0) {
            ...
            zzai zzai = new zzai(str2, new zzah(zza(zza(str, str2, bundle2, CollectionUtils.listOf(str4), false, false))), str3, j);
            return zzai;
        }
    ...
    public static Bundle zza(List<zzjw> list) {
        ...
        for (zzjw zzjw : list) {
            if (zzjw.zzd != null) {
                bundle.putString(zzjw.zza, zzjw.zzd);
            } else if (zzjw.zzc != null) {
                bundle.putLong(zzjw.zza, zzjw.zzc.longValue());
            } else if (zzjw.zzf != null) {
                bundle.putDouble(zzjw.zza, zzjw.zzf.doubleValue());
            }
        }
        return bundle;
    }
    ...
    public static ArrayList<Bundle> zzb(List<zzq> list) {
        ...
        for (zzq zzq : list) {
            Bundle bundle = new Bundle();
            bundle.putString("app_id", zzq.zza);
            bundle.putString("origin", zzq.zzb);
            bundle.putLong(ConditionalUserProperty.CREATION_TIMESTAMP, zzq.zzd);
            bundle.putString(ConditionalUserProperty.NAME, zzq.zzc.zza);
            zzgk.zza(bundle, zzq.zzc.zza());
            bundle.putBoolean("active", zzq.zze);
            if (zzq.zzf != null) {
                bundle.putString(ConditionalUserProperty.TRIGGER_EVENT_NAME, zzq.zzf);
            }
            if (zzq.zzg != null) {
                bundle.putString(ConditionalUserProperty.TIMED_OUT_EVENT_NAME, zzq.zzg.zza);
                if (zzq.zzg.zzb != null) {
                    bundle.putBundle(ConditionalUserProperty.TIMED_OUT_EVENT_PARAMS, zzq.zzg.zzb.zzb());
                }
            }
            bundle.putLong(ConditionalUserProperty.TRIGGER_TIMEOUT, zzq.zzh);
            if (zzq.zzi != null) {
                bundle.putString(ConditionalUserProperty.TRIGGERED_EVENT_NAME, zzq.zzi.zza);
                if (zzq.zzi.zzb != null) {
                    bundle.putBundle(ConditionalUserProperty.TRIGGERED_EVENT_PARAMS, zzq.zzi.zzb.zzb());
                }
            }
            bundle.putLong(ConditionalUserProperty.TRIGGERED_TIMESTAMP, zzq.zzc.zzb);
            bundle.putLong(ConditionalUserProperty.TIME_TO_LIVE, zzq.zzj);
            if (zzq.zzk != null) {
                bundle.putString(ConditionalUserProperty.EXPIRED_EVENT_NAME, zzq.zzk.zza);
                if (zzq.zzk.zzb != null) {
                    bundle.putBundle(ConditionalUserProperty.EXPIRED_EVENT_PARAMS, zzq.zzk.zzb.zzb());
                }
            }
