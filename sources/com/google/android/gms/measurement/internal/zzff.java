...
final class zzff implements Runnable {
    ...
    private final /* synthetic */ PendingResult zzf;

    zzff(zzfd zzfd, zzfn zzfn, long j, Bundle bundle, Context context, zzej zzej, PendingResult pendingResult) {
        this.zza = zzfn;
        this.zzb = j;
        this.zzc = bundle;
        this.zzd = context;
    ...
    public final void run() {
        ...
        PendingResult pendingResult = this.zzf;
