...
public final class zzhx extends zzg {
    ...
    public static void zza(zzhu zzhu, Bundle bundle, boolean z) {
        ...
        String str2 = "_sn";
        String str3 = "_sc";
        if (bundle == null || zzhu == null || (bundle.containsKey(str3) && !z)) {
            if (bundle != null && zzhu == null && z) {
                bundle.remove(str2);
                bundle.remove(str3);
                bundle.remove(str);
            }
        ...
        if (zzhu.zza != null) {
            bundle.putString(str2, zzhu.zza);
        } else {
            bundle.remove(str2);
        }
        bundle.putString(str3, zzhu.zzb);
        bundle.putLong(str, zzhu.zzc);
    }
    ...
    private final zzhu zzd(@NonNull Activity activity) {
        ...
        zzhu zzhu = (zzhu) this.zzd.get(activity);
        if (zzhu != null) {
            return zzhu;
        }
        zzhu zzhu2 = new zzhu(null, zza(activity.getClass().getCanonicalName()), zzp().zzg());
    ...
    public final void zza(Activity activity, Bundle bundle) {
        if (bundle != null) {
            ...
            if (bundle2 != null) {
                this.zzd.put(activity, new zzhu(bundle2.getString(ConditionalUserProperty.NAME), bundle2.getString("referrer_name"), bundle2.getLong("id")));
            }
        }
    }
    ...
    public final void zzb(Activity activity, Bundle bundle) {
        if (bundle != null) {
            ...
            if (zzhu != null) {
                ...
                bundle2.putString(ConditionalUserProperty.NAME, zzhu.zza);
