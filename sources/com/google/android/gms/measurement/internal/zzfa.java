        ...
        if (zza3 != null) {
            ...
            if (j == 0) {
                ...
                if (string == null || string.isEmpty()) {
                    ...
                    Bundle zza4 = zzi.zza(Uri.parse(valueOf.length() != 0 ? str.concat(valueOf) : new String(str)));
                    if (zza4 == null) {
                        ...
                        if (j == zzey.zza.zzc().zzi.zza()) {
                            ...
                            zzey.zza.zzr().zzx().zza("Logging Install Referrer campaign from sdk with ", str2);
                            zza4.putString("_cis", str2);
