...
final class zzhq implements Runnable {
    ...
    public final void run() {
        ...
        L_0x0039:
            ...
            byte[] r4 = com.google.android.gms.measurement.internal.zzho.zza(r2)     // Catch:{ IOException -> 0x0056, all -> 0x0050 }
    ...
    private final void zzb(int i, Exception exc, byte[] bArr, Map<String, List<String>> map) {
        zzfg zzq = this.zzf.zzq();
        zzht zzht = new zzht(this, i, exc, bArr, map);
        zzq.zza((Runnable) zzht);
    }
