...
final class zzy extends SQLiteOpenHelper {
        ...
        if (this.zza.zzk.zza(3600000)) {
            try {
                ...
                if (!this.zza.zzn().getDatabasePath(str).delete()) {
                    this.zza.zzr().zzf().zza("Failed to delete corrupted db file", str);
                }
                try {
    ...
    public final void onOpen(SQLiteDatabase sQLiteDatabase) {
        ...
        zzab.zza(this.zza.zzr(), sQLiteDatabase2, "raw_events_metadata", "CREATE TABLE IF NOT EXISTS raw_events_metadata ( app_id TEXT NOT NULL, metadata_fingerprint INTEGER NOT NULL, metadata BLOB NOT NULL, PRIMARY KEY (app_id, metadata_fingerprint));", "app_id,metadata_fingerprint,metadata", null);
        ...
        zzab.zza(this.zza.zzr(), sQLiteDatabase2, "audience_filter_values", "CREATE TABLE IF NOT EXISTS audience_filter_values ( app_id TEXT NOT NULL, audience_id INTEGER NOT NULL, current_results BLOB, PRIMARY KEY (app_id, audience_id));", "app_id,audience_id,current_results", null);
        ...
        zzab.zza(this.zza.zzr(), sQLiteDatabase2, "main_event_params", "CREATE TABLE IF NOT EXISTS main_event_params ( app_id TEXT NOT NULL, event_id TEXT NOT NULL, children_to_process INTEGER NOT NULL, main_event BLOB NOT NULL, PRIMARY KEY (app_id));", "app_id,event_id,children_to_process,main_event", null);
    }
