...
public final class zzgt extends zzg {
    ...
    public final void zza(String str, String str2, long j, Bundle bundle) {
        zzb();
        zzd();
        zza(str, str2, j, bundle, true, this.zzc == null || zzjx.zze(str2), false, null);
    }
    ...
    public final void zza(java.lang.String r28, java.lang.String r29, long r30, android.os.Bundle r32, boolean r33, boolean r34, boolean r35, java.lang.String r36) {
        ...
        L_0x0134:
            ...
            r1.zzi()
            java.lang.String r0 = com.google.android.gms.measurement.internal.zzjx.zza(r15, r0, r9)
        ...
        L_0x0187:
            r4 = 0
        L_0x0188:
            com.google.android.gms.measurement.internal.zzhx.zza(r2, r12, r4)
        ...
        L_0x03ba:
            ...
            r27.zzp()
            android.os.Bundle[] r8 = com.google.android.gms.measurement.internal.zzjx.zza(r18)
        ...
        L_0x03d6:
            ...
            r2 = r8[r1]
            r5 = 1
            com.google.android.gms.measurement.internal.zzhx.zza(r14, r2, r5)
        ...
        L_0x049b:
            ...
            com.google.android.gms.measurement.internal.zzjx r4 = r27.zzp()
            android.os.Bundle r1 = r4.zza(r1)
        L_0x04aa:
            r12 = r1
            com.google.android.gms.measurement.internal.zzej r1 = r27.zzr()
            ...
            java.lang.String r5 = r5.zza(r12)
    ...
    private final void zzb(String str, String str2, long j, Bundle bundle, boolean z, boolean z2, boolean z3, String str3) {
        Bundle zzb2 = zzjx.zzb(bundle);
        zzfg zzq = zzq();
        zzgu zzgu = new zzgu(this, str, str2, j, zzb2, z, z2, z3, str3);
        zzq.zza((Runnable) zzgu);
    }
    ...
    public final void zza(String str, String str2, Object obj, boolean z, long j) {
        ...
        if (i != 0) {
            ...
            this.zzw.zzi().zza(i, str5, zza2, i2);
        } else if (obj != null) {
            ...
            if (zzb2 != 0) {
                ...
                this.zzw.zzi().zza(zzb2, str5, zza3, i2);
                return;
            }
    ...
    private final void zza(String str, String str2, long j, Object obj) {
        zzfg zzq = zzq();
        zzgx zzgx = new zzgx(this, str, str2, obj, j);
        zzq.zza((Runnable) zzgx);
    }
    ...
    private final void zzb(Bundle bundle, long j) {
        ...
        String str = "origin";
        zzgk.zza(bundle, str, String.class, null);
        String str2 = ConditionalUserProperty.NAME;
        zzgk.zza(bundle, str2, String.class, null);
        String str3 = "value";
        zzgk.zza(bundle, str3, Object.class, null);
        String str4 = ConditionalUserProperty.TRIGGER_EVENT_NAME;
        zzgk.zza(bundle, str4, String.class, null);
        Long valueOf = Long.valueOf(0);
        String str5 = ConditionalUserProperty.TRIGGER_TIMEOUT;
        zzgk.zza(bundle, str5, Long.class, valueOf);
        zzgk.zza(bundle, ConditionalUserProperty.TIMED_OUT_EVENT_NAME, String.class, null);
        zzgk.zza(bundle, ConditionalUserProperty.TIMED_OUT_EVENT_PARAMS, Bundle.class, null);
        zzgk.zza(bundle, ConditionalUserProperty.TRIGGERED_EVENT_NAME, String.class, null);
        zzgk.zza(bundle, ConditionalUserProperty.TRIGGERED_EVENT_PARAMS, Bundle.class, null);
        String str6 = ConditionalUserProperty.TIME_TO_LIVE;
        zzgk.zza(bundle, str6, Long.class, valueOf);
        zzgk.zza(bundle, ConditionalUserProperty.EXPIRED_EVENT_NAME, String.class, null);
        zzgk.zza(bundle, ConditionalUserProperty.EXPIRED_EVENT_PARAMS, Bundle.class, null);
    ...
    public final void zzd(Bundle bundle) {
        ...
        zzjw zzjw = new zzjw(bundle2.getString(str4), 0, null, null);
        try {
            zzai zza2 = zzp().zza(bundle2.getString(str3), bundle2.getString(ConditionalUserProperty.EXPIRED_EVENT_NAME), bundle2.getBundle(ConditionalUserProperty.EXPIRED_EVENT_PARAMS), bundle2.getString(str2), bundle2.getLong(str), true, false);
            zzjw zzjw2 = zzjw;
            zzq zzq = new zzq(bundle2.getString(str3), bundle2.getString(str2), zzjw2, bundle2.getLong(str), bundle2.getBoolean("active"), bundle2.getString(ConditionalUserProperty.TRIGGER_EVENT_NAME), null, bundle2.getLong(ConditionalUserProperty.TRIGGER_TIMEOUT), null, bundle2.getLong(ConditionalUserProperty.TIME_TO_LIVE), zza2);
            zzh().zza(zzq);
        } catch (IllegalArgumentException unused) {
        }
    }
    ...
    private final ArrayList<Bundle> zzb(String str, String str2, String str3) {
        if (zzq().zzg()) {
            ...
            AtomicReference atomicReference = new AtomicReference();
            synchronized (atomicReference) {
                zzfg zzq = this.zzw.zzq();
                zzhc zzhc = new zzhc(this, atomicReference, str, str2, str3);
                zzq.zza((Runnable) zzhc);
                try {
                    atomicReference.wait(5000);
                } catch (InterruptedException e) {
    ...
    private final Map<String, Object> zzb(String str, String str2, String str3, boolean z) {
        if (zzq().zzg()) {
            ...
            synchronized (atomicReference) {
                zzfg zzq = this.zzw.zzq();
                zzhe zzhe = new zzhe(this, atomicReference, str, str2, str3, z);
                zzq.zza((Runnable) zzhe);
                try {
                    atomicReference.wait(5000);
                } catch (InterruptedException e) {
                    zzr().zzi().zza("Interrupted waiting for get user properties", e);
