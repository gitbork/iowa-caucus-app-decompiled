...
public final class zzfg extends zzgi {
    ...
    /* access modifiers changed from: private */
    public zzfk zzb;
    private final PriorityBlockingQueue<zzfl<?>> zzc = new PriorityBlockingQueue<>();
    private final BlockingQueue<zzfl<?>> zzd = new LinkedBlockingQueue();
    private final UncaughtExceptionHandler zze = new zzfi(this, "Thread death: Uncaught exception on worker thread");
    private final UncaughtExceptionHandler zzf = new zzfi(this, "Thread death: Uncaught exception on network thread");
    /* access modifiers changed from: private */
    ...
    public final <V> Future<V> zza(Callable<V> callable) throws IllegalStateException {
        ...
        zzfl zzfl = new zzfl(this, callable, false, "Task exception on worker thread");
        if (Thread.currentThread() == this.zza) {
            if (!this.zzc.isEmpty()) {
    ...
    public final <V> Future<V> zzb(Callable<V> callable) throws IllegalStateException {
        zzaa();
        Preconditions.checkNotNull(callable);
        zzfl zzfl = new zzfl(this, callable, true, "Task exception on worker thread");
        if (Thread.currentThread() == this.zza) {
            zzfl.run();
        } else {
            zza(zzfl);
    ...
    public final void zza(Runnable runnable) throws IllegalStateException {
        ...
        zza(new zzfl<>(this, runnable, false, "Task exception on worker thread"));
    }
    ...
    public final <T> T zza(java.util.concurrent.atomic.AtomicReference<T> r1, long r2, java.lang.String r4, java.lang.Runnable r5) {
        /*
            r0 = this;
            monitor-enter(r1)
            com.google.android.gms.measurement.internal.zzfg r2 = r0.zzq()     // Catch:{ all -> 0x005c }
            ...
            com.google.android.gms.measurement.internal.zzej r2 = r0.zzr()
        ...
        L_0x0036:
            return r1
        L_0x0037:
            com.google.android.gms.measurement.internal.zzej r2 = r0.zzr()     // Catch:{ all -> 0x005c }
            com.google.android.gms.measurement.internal.zzel r2 = r2.zzi()     // Catch:{ all -> 0x005c }
        ...
        L_0x005c:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzfg.zza(java.util.concurrent.atomic.AtomicReference, long, java.lang.String, java.lang.Runnable):java.lang.Object");
    }
    ...
    public final void zzb(Runnable runnable) throws IllegalStateException {
        zzaa();
        Preconditions.checkNotNull(runnable);
        zzfl zzfl = new zzfl(this, runnable, false, "Task exception on network thread");
        synchronized (this.zzg) {
            this.zzd.add(zzfl);
            if (this.zzb == null) {
                this.zzb = new zzfk(this, "Measurement Network", this.zzd);
