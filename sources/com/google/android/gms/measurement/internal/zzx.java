...
import com.google.android.gms.internal.measurement.zzbr.zzg.zza;
...
final class zzx extends zzjm {
    ...
    public final void zzf() {
        zzak();
        mo19334c_().beginTransaction();
    }

    @WorkerThread
    /* renamed from: b_ */
    public final void mo19333b_() {
        zzak();
        mo19334c_().setTransactionSuccessful();
    }

    @WorkerThread
    public final void zzh() {
        zzak();
        mo19334c_().endTransaction();
    }
    ...
    private final long zzb(String str, String[] strArr) {
        Cursor cursor = null;
        try {
            cursor = mo19334c_().rawQuery(str, strArr);
    ...
    private final long zza(String str, String[] strArr, long j) {
        Cursor cursor = null;
        try {
            Cursor rawQuery = mo19334c_().rawQuery(str, strArr);
    ...
    @VisibleForTesting
    /* renamed from: c_ */
    public final SQLiteDatabase mo19334c_() {
        zzd();
        try {
    ...
    public final com.google.android.gms.measurement.internal.zzae zza(java.lang.String r32, java.lang.String r33) {
        ...
        L_0x0056:
            r18 = 0
            android.database.sqlite.SQLiteDatabase r19 = r31.mo19334c_()     // Catch:{ SQLiteException -> 0x014f, all -> 0x014b }
        ...
        L_0x0108:
            ...
            java.lang.Object r3 = com.google.android.gms.measurement.internal.zzej.zza(r32)     // Catch:{ SQLiteException -> 0x0141 }
        ...
        L_0x0152:
            ...
            java.lang.Object r3 = com.google.android.gms.measurement.internal.zzej.zza(r32)     // Catch:{ all -> 0x0173 }
            com.google.android.gms.measurement.internal.zzeh r4 = r31.zzo()     // Catch:{ all -> 0x0173 }
            r5 = r33
            java.lang.String r4 = r4.zza(r5)     // Catch:{ all -> 0x0173 }
    ...
    public final void zza(zzae zzae) {
        ...
        contentValues.put(ConditionalUserProperty.NAME, zzae.zzb);
        ...
        contentValues.put("last_exempt_from_sampling", (zzae.zzk == null || !zzae.zzk.booleanValue()) ? null : Long.valueOf(1));
        try {
            if (mo19334c_().insertWithOnConflict("events", null, contentValues, 5) == -1) {
    ...
    public final void zzb(String str, String str2) {
        ...
        zzak();
        try {
            zzr().zzx().zza("Deleted user attribute rows", Integer.valueOf(mo19334c_().delete("user_attributes", "app_id=? and name=?", new String[]{str, str2})));
        } catch (SQLiteException e) {
    ...
    public final boolean zza(zzjy zzjy) {
        ...
        if (zzc(zzjy.zza, zzjy.zzc) == null) {
            if (zzjx.zza(zzjy.zzc)) {
                ...
                if (zzt().zze(zzjy.zza, zzak.zzbg)) {
                    if (!"_npa".equals(zzjy.zzc)) {
                        if (zzb(str, new String[]{zzjy.zza, zzjy.zzb}) >= 25) {
                            return false;
                        }
                    }
                } else {
        ...
        contentValues.put(ConditionalUserProperty.NAME, zzjy.zzc);
        contentValues.put("set_timestamp", Long.valueOf(zzjy.zzd));
        zza(contentValues, "value", zzjy.zze);
        try {
            if (mo19334c_().insertWithOnConflict("user_attributes", null, contentValues, 5) == -1) {
    ...
    public final com.google.android.gms.measurement.internal.zzjy zzc(java.lang.String r19, java.lang.String r20) {
        /*
            ...
            r18.zzak()
            r9 = 0
            android.database.sqlite.SQLiteDatabase r10 = r18.mo19334c_()     // Catch:{ SQLiteException -> 0x0088, all -> 0x0083 }
        ...
        L_0x0044:
            ...
            java.lang.Object r3 = com.google.android.gms.measurement.internal.zzej.zza(r19)     // Catch:{ SQLiteException -> 0x0079 }
        ...
        L_0x008c:
            ...
            java.lang.Object r3 = com.google.android.gms.measurement.internal.zzej.zza(r19)     // Catch:{ all -> 0x00ab }
    ...
    public final java.util.List<com.google.android.gms.measurement.internal.zzjy> zza(java.lang.String r23) {
        /*
            ...
            r0.<init>()
            r1 = 0
            android.database.sqlite.SQLiteDatabase r2 = r22.mo19334c_()     // Catch:{ SQLiteException -> 0x009a, all -> 0x0095 }
        ...
        L_0x0054:
            ...
            java.lang.Object r6 = com.google.android.gms.measurement.internal.zzej.zza(r23)     // Catch:{ SQLiteException -> 0x008b }
        ...
        L_0x009e:
            ...
            java.lang.Object r6 = com.google.android.gms.measurement.internal.zzej.zza(r23)     // Catch:{ all -> 0x00b5 }
    ...
    public final java.util.List<com.google.android.gms.measurement.internal.zzjy> zza(java.lang.String r22, java.lang.String r23, java.lang.String r24) {
        ...
        L_0x004c:
            ...
            android.database.sqlite.SQLiteDatabase r12 = r21.mo19334c_()     // Catch:{ SQLiteException -> 0x011a, all -> 0x0122 }
        ...
        L_0x00ae:
            ...
            java.lang.Object r7 = com.google.android.gms.measurement.internal.zzej.zza(r22)     // Catch:{ SQLiteException -> 0x00dd }
            r12 = r24
        ...
        L_0x012e:
            ...
            java.lang.Object r6 = com.google.android.gms.measurement.internal.zzej.zza(r22)     // Catch:{ all -> 0x0145 }
    ...
    public final boolean zza(zzq zzq) {
        ...
        contentValues.put(ConditionalUserProperty.NAME, zzq.zzc.zza);
        zza(contentValues, "value", zzq.zzc.zza());
        contentValues.put("active", Boolean.valueOf(zzq.zze));
        contentValues.put(ConditionalUserProperty.TRIGGER_EVENT_NAME, zzq.zzf);
        contentValues.put(ConditionalUserProperty.TRIGGER_TIMEOUT, Long.valueOf(zzq.zzh));
        zzp();
        contentValues.put("timed_out_event", zzjx.zza((Parcelable) zzq.zzg));
        contentValues.put(ConditionalUserProperty.CREATION_TIMESTAMP, Long.valueOf(zzq.zzd));
        zzp();
        contentValues.put("triggered_event", zzjx.zza((Parcelable) zzq.zzi));
        contentValues.put(ConditionalUserProperty.TRIGGERED_TIMESTAMP, Long.valueOf(zzq.zzc.zzb));
        contentValues.put(ConditionalUserProperty.TIME_TO_LIVE, Long.valueOf(zzq.zzj));
        zzp();
        contentValues.put("expired_event", zzjx.zza((Parcelable) zzq.zzk));
        try {
            if (mo19334c_().insertWithOnConflict("conditional_properties", null, contentValues, 5) == -1) {
    ...
    public final com.google.android.gms.measurement.internal.zzq zzd(java.lang.String r33, java.lang.String r34) {
        /*
            ...
            r32.zzak()
            r8 = 0
            android.database.sqlite.SQLiteDatabase r9 = r32.mo19334c_()     // Catch:{ SQLiteException -> 0x012f, all -> 0x012a }
        ...
        L_0x0093:
            ...
            java.lang.Object r3 = com.google.android.gms.measurement.internal.zzej.zza(r33)     // Catch:{ SQLiteException -> 0x0120 }
        ...
        L_0x0133:
            ...
            java.lang.Object r3 = com.google.android.gms.measurement.internal.zzej.zza(r33)     // Catch:{ all -> 0x0152 }
    ...
    public final int zze(String str, String str2) {
        ...
        zzak();
        try {
            return mo19334c_().delete("conditional_properties", "app_id=? and name=?", new String[]{str, str2});
        } catch (SQLiteException e) {
    ...
    public final java.util.List<com.google.android.gms.measurement.internal.zzq> zza(java.lang.String r40, java.lang.String[] r41) {
        /*
            ...
            java.util.ArrayList r0 = new java.util.ArrayList
            r0.<init>()
            android.database.sqlite.SQLiteDatabase r2 = r39.mo19334c_()     // Catch:{ SQLiteException -> 0x0158, all -> 0x0155 }
    ...
    public final com.google.android.gms.measurement.internal.zzf zzb(java.lang.String r21) {
        /*
            ...
            r20.zzak()
            r2 = 0
            android.database.sqlite.SQLiteDatabase r3 = r20.mo19334c_()     // Catch:{ SQLiteException -> 0x025a, all -> 0x0255 }
        ...
        L_0x0196:
            r4.zzc(r6)     // Catch:{ SQLiteException -> 0x024b }
            r0 = 18
            java.lang.String r0 = r3.getString(r0)     // Catch:{ SQLiteException -> 0x024b }
        ...
        L_0x022b:
            ...
            java.lang.Object r7 = com.google.android.gms.measurement.internal.zzej.zza(r21)     // Catch:{ SQLiteException -> 0x024b }
        ...
        L_0x025e:
            ...
            java.lang.Object r1 = com.google.android.gms.measurement.internal.zzej.zza(r21)     // Catch:{ all -> 0x0275 }
    ...
    public final void zza(zzf zzf2) {
        ...
        try {
            SQLiteDatabase c_ = mo19334c_();
            if (((long) c_.update(str, contentValues, "app_id = ?", new String[]{zzf2.zzb()})) == 0 && c_.insertWithOnConflict(str, null, contentValues, 5) == -1) {
    ...
    public final long zzc(String str) {
        ...
        zzak();
        try {
            return (long) mo19334c_().delete("raw_events", "rowid in (select rowid from raw_events where app_id=? order by rowid desc limit -1 offset ?)", new String[]{str, String.valueOf(Math.max(0, Math.min(1000000, zzt().zzb(str, zzak.zzs))))});
        } catch (SQLiteException e) {
    ...
    public final com.google.android.gms.measurement.internal.zzw zza(long r22, java.lang.String r24, boolean r25, boolean r26, boolean r27, boolean r28, boolean r29) {
        /*
            ...
            r9.<init>()
            android.database.sqlite.SQLiteDatabase r15 = r21.mo19334c_()     // Catch:{ SQLiteException -> 0x010e, all -> 0x010b }
            ...
            java.lang.Object r2 = com.google.android.gms.measurement.internal.zzej.zza(r24)     // Catch:{ SQLiteException -> 0x0109 }
        ...
        L_0x0110:
            ...
            java.lang.Object r3 = com.google.android.gms.measurement.internal.zzej.zza(r24)     // Catch:{ all -> 0x0127 }
    ...
    public final byte[] zzd(java.lang.String r12) {
        /*
            ...
            r11.zzak()
            r0 = 0
            android.database.sqlite.SQLiteDatabase r1 = r11.mo19334c_()     // Catch:{ SQLiteException -> 0x005d, all -> 0x005a }
        ...
        L_0x0037:
            ...
            java.lang.Object r5 = com.google.android.gms.measurement.internal.zzej.zza(r12)     // Catch:{ SQLiteException -> 0x0058 }
        ...
        L_0x005f:
            ...
            java.lang.Object r12 = com.google.android.gms.measurement.internal.zzej.zza(r12)     // Catch:{ all -> 0x0076 }
    ...
    @WorkerThread
    public final boolean zza(zzg zzg2, boolean z) {
        zzd();
        zzak();
        ...
        try {
            ...
            try {
                if (mo19334c_().insert("queue", null, contentValues) != -1) {
                    return true;
                }
    ...
    /* renamed from: d_ */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final java.lang.String mo19335d_() {
        /*
            r6 = this;
            android.database.sqlite.SQLiteDatabase r0 = r6.mo19334c_()
            r1 = 0
        ...
        L_0x0044:
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzx.mo19335d_():java.lang.String");
    }
    ...
    public final List<Pair<zzg, Long>> zza(String str, int i, int i2) {
        ...
        Cursor cursor = null;
        try {
            cursor = mo19334c_().query("queue", new String[]{"rowid", "data", "retry_count"}, "app_id=?", new String[]{str}, null, null, "rowid", String.valueOf(i));
            if (!cursor.moveToFirst()) {
            ...
            do {
                ...
                try {
                    ...
                    try {
                        zza zza = (zza) zzg.zzbe().zza(zzb2, zzeq.zzb());
                        if (!cursor.isNull(2)) {
                            zza.zzh(cursor.getInt(2));
                        }
                        i4 += zzb2.length;
                        arrayList.add(Pair.create((zzg) ((zzfd) zza.zzu()), Long.valueOf(j)));
                    } catch (IOException e) {
    ...
    public final void zzv() {
        ...
        if (zzam()) {
            ...
            if (Math.abs(elapsedRealtime - zza) > ((Long) zzak.zzab.zza(null)).longValue()) {
                zzs().zzf.zza(elapsedRealtime);
                zzd();
                zzak();
                if (zzam()) {
                    int delete = mo19334c_().delete("queue", "abs(bundle_end_timestamp - ?) > cast(? as integer)", new String[]{String.valueOf(zzm().currentTimeMillis()), String.valueOf(zzs.zzk())});
                    if (delete > 0) {
    ...
    public final void zza(String str, zzbj.zza[] zzaArr) {
        ...
        try {
            ...
            zzd();
            Preconditions.checkNotEmpty(str);
            SQLiteDatabase c_2 = mo19334c_();
            c_2.delete(str5, str4, new String[]{str});
            c_2.delete(str3, str4, new String[]{str});
                        ...
                        if (it.hasNext()) {
                            ...
                            while (true) {
                                if (it2.hasNext()) {
                                    ...
                                    Iterator it3 = zza.zze().iterator();
                                    while (true) {
                                        if (it3.hasNext()) {
                                            if (!zza(str, zzb2, (zzb) it3.next())) {
                                                z = false;
                                                break;
                                            }
                                        } else {
                                    ...
                                    if (z) {
                                        Iterator it4 = zza.zzc().iterator();
                                        while (true) {
                                            if (it4.hasNext()) {
                                                if (!zza(str, zzb2, (zze) it4.next())) {
                                                    z = false;
                                                    break;
                                                }
                                            } else {
                                    ...
                                    if (!z) {
                                        ...
                                        zzd();
                                        Preconditions.checkNotEmpty(str);
                                        SQLiteDatabase c_3 = mo19334c_();
                                        c_3.delete(str5, str2, new String[]{str, String.valueOf(zzb2)});
                                        c_3.delete(str3, str2, new String[]{str, String.valueOf(zzb2)});
                                    }
                                }
                            }
                        }
    ...
    @WorkerThread
    private final boolean zza(String str, int i, zzb zzb2) {
        zzak();
        zzd();
        Preconditions.checkNotEmpty(str);
        ...
        try {
            if (mo19334c_().insertWithOnConflict("event_filters", null, contentValues, 5) == -1) {
    ...
    @WorkerThread
    private final boolean zza(String str, int i, zze zze2) {
        zzak();
        zzd();
        Preconditions.checkNotEmpty(str);
        ...
        contentValues.put("data", zzbh);
        try {
            if (mo19334c_().insertWithOnConflict("property_filters", null, contentValues, 5) != -1) {
                return true;
            }
    ...
    public final java.util.Map<java.lang.Integer, java.util.List<com.google.android.gms.internal.measurement.zzbj.zzb>> zzf(java.lang.String r13, java.lang.String r14) {
        /*
            ...
            r0.<init>()
            android.database.sqlite.SQLiteDatabase r1 = r12.mo19334c_()
            r9 = 0
        ...
        L_0x0048:
            ...
            com.google.android.gms.internal.measurement.zzbj$zzb r1 = com.google.android.gms.internal.measurement.zzbj.zzb.zza(r1, r2)     // Catch:{ IOException -> 0x0074 }
        ...
        L_0x0074:
            ...
            java.lang.Object r4 = com.google.android.gms.measurement.internal.zzej.zza(r13)     // Catch:{ SQLiteException -> 0x0092 }
        ...
        L_0x0099:
            ...
            java.lang.Object r13 = com.google.android.gms.measurement.internal.zzej.zza(r13)     // Catch:{ all -> 0x00b0 }
    ...
    public final java.util.Map<java.lang.Integer, java.util.List<com.google.android.gms.internal.measurement.zzbj.zze>> zzg(java.lang.String r13, java.lang.String r14) {
        ...
        L_0x0048:
            byte[] r1 = r14.getBlob(r11)     // Catch:{ SQLiteException -> 0x0092 }
            com.google.android.gms.internal.measurement.zzeq r2 = com.google.android.gms.internal.measurement.zzeq.zzb()     // Catch:{ IOException -> 0x0074 }
            com.google.android.gms.internal.measurement.zzbj$zze r1 = com.google.android.gms.internal.measurement.zzbj.zze.zza(r1, r2)     // Catch:{ IOException -> 0x0074 }
            int r2 = r14.getInt(r10)     // Catch:{ SQLiteException -> 0x0092 }
            java.lang.Integer r3 = java.lang.Integer.valueOf(r2)     // Catch:{ SQLiteException -> 0x0092 }
            java.lang.Object r3 = r0.get(r3)     // Catch:{ SQLiteException -> 0x0092 }
            java.util.List r3 = (java.util.List) r3     // Catch:{ SQLiteException -> 0x0092 }
    ...
    public final java.util.Map<java.lang.Integer, java.util.List<java.lang.Integer>> zza(java.lang.String r14, java.util.List<java.lang.String> r15) {
        ...
        L_0x0039:
            ...
            r3.<init>(r15)
            r3.add(r2, r14)
            android.database.sqlite.SQLiteDatabase r4 = r13.mo19334c_()
            r15 = 0
        ...
        L_0x00b3:
            ...
            java.lang.Object r14 = com.google.android.gms.measurement.internal.zzej.zza(r14)     // Catch:{ all -> 0x00ca }
    ...
    public final java.util.Map<java.lang.Integer, java.util.List<java.lang.Integer>> zze(java.lang.String r8) {
        /*
            ...
            androidx.collection.ArrayMap r0 = new androidx.collection.ArrayMap
            r0.<init>()
            android.database.sqlite.SQLiteDatabase r1 = r7.mo19334c_()
            r2 = 0
        ...
        L_0x006c:
            ...
            java.lang.Object r8 = com.google.android.gms.measurement.internal.zzej.zza(r8)     // Catch:{ all -> 0x0083 }
    ...
    public final java.util.Map<java.lang.Integer, com.google.android.gms.internal.measurement.zzbr.zzi> zzf(java.lang.String r12) {
        /*
            ...
            r11.zzd()
            com.google.android.gms.common.internal.Preconditions.checkNotEmpty(r12)
            android.database.sqlite.SQLiteDatabase r0 = r11.mo19334c_()
            r8 = 0
        ...
        L_0x003b:
            ...
            com.google.android.gms.internal.measurement.zzbr$zzi r3 = com.google.android.gms.internal.measurement.zzbr.zzi.zza(r3, r4)     // Catch:{ IOException -> 0x0053 }
        ...
        L_0x0053:
            ...
            java.lang.Object r6 = com.google.android.gms.measurement.internal.zzej.zza(r12)     // Catch:{ SQLiteException -> 0x0075 }
            java.lang.Integer r2 = java.lang.Integer.valueOf(r2)     // Catch:{ SQLiteException -> 0x0075 }
        ...
        L_0x007c:
            ...
            java.lang.Object r12 = com.google.android.gms.measurement.internal.zzej.zza(r12)     // Catch:{ all -> 0x0093 }
        ...
        try {
            ...
            try {
                ...
                if (j == -1) {
                    ...
                    if (c_.insertWithOnConflict(str3, null, contentValues, 5) == -1) {
                        zzr().zzf().zza("Failed to insert column (got -1). appId", zzej.zza(str), str6);
                        c_.endTransaction();
                        return -1;
                    }
                    j = 0;
                ...
                j = 0;
                try {
                    zzr().zzf().zza("Error inserting column. appId", zzej.zza(str), str6, e);
                    c_.endTransaction();
                    return j;
                } catch (Throwable th) {
                    th = th;
            ...
            try {
                ...
                if (((long) c_.update(str3, contentValues2, "app_id = ?", new String[]{str5})) == 0) {
                    zzr().zzf().zza("Failed to update column (got 0). appId", zzej.zza(str), str6);
                    c_.endTransaction();
                    return -1;
                }
                c_.setTransactionSuccessful();
    ...
    public final long zza(zzg zzg2) throws IOException {
        zzd();
        zzak();
        Preconditions.checkNotNull(zzg2);
        Preconditions.checkNotEmpty(zzg2.zzx());
        ...
        try {
            mo19334c_().insertWithOnConflict("raw_events_metadata", null, contentValues, 4);
            return zza;
        } catch (SQLiteException e) {
    ...
    public final java.lang.String zza(long r5) {
        /*
            ...
            r4.zzak()
            r0 = 0
            android.database.sqlite.SQLiteDatabase r1 = r4.mo19334c_()     // Catch:{ SQLiteException -> 0x0043, all -> 0x0040 }
    ...
    public final long zzaa() {
        Cursor cursor = null;
        try {
            cursor = mo19334c_().rawQuery("select rowid from raw_events order by rowid desc limit 1;", null);
            if (!cursor.moveToFirst()) {
                if (cursor != null) {
                    cursor.close();
                }
    ...
    public final android.util.Pair<com.google.android.gms.internal.measurement.zzbr.zzc, java.lang.Long> zza(java.lang.String r8, java.lang.Long r9) {
        /*
            ...
            r7.zzak()
            r0 = 0
            android.database.sqlite.SQLiteDatabase r1 = r7.mo19334c_()     // Catch:{ SQLiteException -> 0x0072, all -> 0x006f }
        ...
        L_0x0037:
            ...
            com.google.android.gms.internal.measurement.zzbr$zzc r8 = com.google.android.gms.internal.measurement.zzbr.zzc.zza(r2, r4)     // Catch:{ IOException -> 0x0055 }
        ...
        L_0x0055:
            ...
            java.lang.Object r8 = com.google.android.gms.measurement.internal.zzej.zza(r8)     // Catch:{ SQLiteException -> 0x006d }
    ...
    public final boolean zza(String str, Long l, long j, zzc zzc2) {
        zzd();
        zzak();
        ...
        try {
            if (mo19334c_().insertWithOnConflict("main_event_params", null, contentValues, 5) != -1) {
                return true;
            }
    ...
    public final boolean zza(zzaf zzaf, long j, boolean z) {
        ...
        zzc.zza zzb2 = zzc.zzj().zzb(zzaf.zzd);
        Iterator it = zzaf.zze.iterator();
        while (it.hasNext()) {
            String str = (String) it.next();
            zzbr.zze.zza zza = zzbr.zze.zzh().zza(str);
            zzg().zza(zza, zzaf.zze.zza(str));
            zzb2.zza(zza);
        }
        byte[] zzbh = ((zzc) ((zzfd) zzb2.zzu())).zzbh();
        zzr().zzx().zza("Saving event, name, data size", zzo().zza(zzaf.zzb), Integer.valueOf(zzbh.length));
        ContentValues contentValues = new ContentValues();
        contentValues.put("app_id", zzaf.zza);
        contentValues.put(ConditionalUserProperty.NAME, zzaf.zzb);
        contentValues.put("timestamp", Long.valueOf(zzaf.zzc));
        contentValues.put("metadata_fingerprint", Long.valueOf(j));
        contentValues.put("data", zzbh);
        contentValues.put("realtime", Integer.valueOf(z ? 1 : 0));
        try {
            if (mo19334c_().insert("raw_events", null, contentValues) != -1) {
                return true;
            }
    ...
    static {
        ...
        zzg = new String[]{str, "ALTER TABLE event_filters ADD COLUMN session_scoped BOOLEAN;"};
        zzh = new String[]{str, "ALTER TABLE property_filters ADD COLUMN session_scoped BOOLEAN;"};
    }
}
