...
public class Barcode extends AbstractSafeParcelable {
    ...
    public static class Address extends AbstractSafeParcelable {
        ...
        @Constructor
        public Address(@Param(mo15130id = 2) int i, @Param(mo15130id = 3) String[] strArr) {
            this.type = i;
    ...
    public static class CalendarDateTime extends AbstractSafeParcelable {
        ...
        @Constructor
        public CalendarDateTime(@Param(mo15130id = 2) int i, @Param(mo15130id = 3) int i2, @Param(mo15130id = 4) int i3, @Param(mo15130id = 5) int i4, @Param(mo15130id = 6) int i5, @Param(mo15130id = 7) int i6, @Param(mo15130id = 8) boolean z, @Param(mo15130id = 9) String str) {
            this.year = i;
            this.month = i2;
            this.day = i3;
            this.hours = i4;
    ...
    public static class CalendarEvent extends AbstractSafeParcelable {
        ...
        @Constructor
        public CalendarEvent(@Param(mo15130id = 2) String str, @Param(mo15130id = 3) String str2, @Param(mo15130id = 4) String str3, @Param(mo15130id = 5) String str4, @Param(mo15130id = 6) String str5, @Param(mo15130id = 7) CalendarDateTime calendarDateTime, @Param(mo15130id = 8) CalendarDateTime calendarDateTime2) {
            this.summary = str;
    ...
    public static class ContactInfo extends AbstractSafeParcelable {
        ...
        @Constructor
        public ContactInfo(@Param(mo15130id = 2) PersonName personName, @Param(mo15130id = 3) String str, @Param(mo15130id = 4) String str2, @Param(mo15130id = 5) Phone[] phoneArr, @Param(mo15130id = 6) Email[] emailArr, @Param(mo15130id = 7) String[] strArr, @Param(mo15130id = 8) Address[] addressArr) {
    ...
    public static class DriverLicense extends AbstractSafeParcelable {
        ...
        @Constructor
        public DriverLicense(@Param(mo15130id = 2) String str, @Param(mo15130id = 3) String str2, @Param(mo15130id = 4) String str3, @Param(mo15130id = 5) String str4, @Param(mo15130id = 6) String str5, @Param(mo15130id = 7) String str6, @Param(mo15130id = 8) String str7, @Param(mo15130id = 9) String str8, @Param(mo15130id = 10) String str9, @Param(mo15130id = 11) String str10, @Param(mo15130id = 12) String str11, @Param(mo15130id = 13) String str12, @Param(mo15130id = 14) String str13, @Param(mo15130id = 15) String str14) {
    ...
    public static class Email extends AbstractSafeParcelable {
        ...
        @Constructor
        public Email(@Param(mo15130id = 2) int i, @Param(mo15130id = 3) String str, @Param(mo15130id = 4) String str2, @Param(mo15130id = 5) String str3) {
            this.type = i;
            this.address = str;
            this.subject = str2;
            this.body = str3;
    ...
    public static class GeoPoint extends AbstractSafeParcelable {
        ...
        @Constructor
        public GeoPoint(@Param(mo15130id = 2) double d, @Param(mo15130id = 3) double d2) {
            this.lat = d;
            this.lng = d2;
        }
    ...
    public static class PersonName extends AbstractSafeParcelable {
        ...
        @Constructor
        public PersonName(@Param(mo15130id = 2) String str, @Param(mo15130id = 3) String str2, @Param(mo15130id = 4) String str3, @Param(mo15130id = 5) String str4, @Param(mo15130id = 6) String str5, @Param(mo15130id = 7) String str6, @Param(mo15130id = 8) String str7) {
    ...
    public static class Phone extends AbstractSafeParcelable {
        ...
        @Constructor
        public Phone(@Param(mo15130id = 2) int i, @Param(mo15130id = 3) String str) {
            this.type = i;
            this.number = str;
        }
    ...
    public static class Sms extends AbstractSafeParcelable {
        ...
        @Constructor
        public Sms(@Param(mo15130id = 2) String str, @Param(mo15130id = 3) String str2) {
            this.message = str;
    ...
    public static class UrlBookmark extends AbstractSafeParcelable {
        ...
        @Constructor
        public UrlBookmark(@Param(mo15130id = 2) String str, @Param(mo15130id = 3) String str2) {
            this.title = str;
            this.url = str2;
        }
    ...
    public static class WiFi extends AbstractSafeParcelable {
        ...
        @Constructor
        public WiFi(@Param(mo15130id = 2) String str, @Param(mo15130id = 3) String str2, @Param(mo15130id = 4) int i) {
            this.ssid = str;
            this.password = str2;
    ...
    @Constructor
    public Barcode(@Param(mo15130id = 2) int i, @Param(mo15130id = 3) String str, @Param(mo15130id = 4) String str2, @Param(mo15130id = 5) int i2, @Param(mo15130id = 6) Point[] pointArr, @Param(mo15130id = 7) Email email2, @Param(mo15130id = 8) Phone phone2, @Param(mo15130id = 9) Sms sms2, @Param(mo15130id = 10) WiFi wiFi, @Param(mo15130id = 11) UrlBookmark urlBookmark, @Param(mo15130id = 12) GeoPoint geoPoint2, @Param(mo15130id = 13) CalendarEvent calendarEvent2, @Param(mo15130id = 14) ContactInfo contactInfo2, @Param(mo15130id = 15) DriverLicense driverLicense2) {
        this.format = i;
        this.rawValue = str;
