            ...
            while (i2 < zzc.length) {
                ...
                if (landmarkParcelArr == null) {
                    ...
                    while (i4 < landmarkParcelArr.length) {
                        ...
                        landmarkArr[i4] = new Landmark(new PointF(landmarkParcel.f92x, landmarkParcel.f93y), landmarkParcel.type);
                        i4++;
                        zzc = faceParcelArr2;
                        faceArr2 = faceArr3;
                ...
                Face face = new Face(i3, pointF, f, f2, f3, f4, f5, landmarkArr, contourArr, faceParcel.zzcg, faceParcel.zzch, faceParcel.zzci);
                faceArr[i2] = face;
                i2++;
                zzc = faceParcelArr;
                faceArr2 = faceArr;
