...
final class zze implements zzfe<zzga> {
    ...
    public final /* synthetic */ void zza(Object obj) {
        zzga zzga = (zzga) obj;
        if (!zzga.zzg()) {
            this.zzb.zza(new zzey(zzga.zzc(), zzga.zzb(), Long.valueOf(zzga.zzd()), "Bearer"), null, null, Boolean.valueOf(false), null, this.zza, this);
        } else if (this.zzb.zzc.zzb()) {
            this.zza.zza(new zzed(zzga.zzf(), zzga.zze(), null));
        } else {
            zza.zza.mo15179e("Need to do multi-factor auth, but SDK does not support it.", new Object[0]);
