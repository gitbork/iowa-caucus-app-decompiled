...
abstract class zzes<ResultT, CallbackT> implements zzap<zzdu, ResultT> {
    ...
    protected final List<OnVerificationStateChangedCallbacks> zzi = new ArrayList();
    ...
    static class zza extends LifecycleCallback {
        private final List<OnVerificationStateChangedCallbacks> zza;
    ...
    public final zzes<ResultT, CallbackT> zza(OnVerificationStateChangedCallbacks onVerificationStateChangedCallbacks, Activity activity, Executor executor) {
        synchronized (this.zzi) {
            this.zzi.add((OnVerificationStateChangedCallbacks) Preconditions.checkNotNull(onVerificationStateChangedCallbacks));
        }
        this.zza = activity;
        if (this.zza != null) {
