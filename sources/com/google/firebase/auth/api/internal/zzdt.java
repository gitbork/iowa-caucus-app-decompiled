...
public final class zzdt extends GmsClient<zzee> implements zzdu {
    ...
    public zzdt(Context context, Looper looper, ClientSettings clientSettings, zzej zzej, ConnectionCallbacks connectionCallbacks, OnConnectionFailedListener onConnectionFailedListener) {
    ...
    public final String getStartServicePackage() {
        if (this.zzc.zza) {
            zza.mo15180i("Preparing to create service connection to fallback implementation", new Object[0]);
            return this.zzb.getPackageName();
        }
        zza.mo15180i("Preparing to create service connection to gms implementation", new Object[0]);
