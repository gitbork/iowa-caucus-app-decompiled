...
public final class zzad {
    ...
    public final boolean zza(Activity activity, TaskCompletionSource<AuthResult> taskCompletionSource, FirebaseAuth firebaseAuth, FirebaseUser firebaseUser) {
        ...
        zzal zzal = new zzal(this, activity, taskCompletionSource, firebaseAuth, firebaseUser);
        instance.registerReceiver(zzal, new IntentFilter("com.google.firebase.auth.ACTION_RECEIVE_FIREBASE_AUTH_INTENT"));
        this.zza = true;
        return true;
    }
