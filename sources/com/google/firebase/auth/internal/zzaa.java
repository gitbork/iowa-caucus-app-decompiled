...
public final class zzaa {
    ...
    public zzaa(FirebaseApp firebaseApp) {
        zzc.mo15182v("Initializing TokenRefresher", new Object[0]);
    ...
    public final void zza() {
        ...
        sb.append(j);
        logger.mo15182v(sb.toString(), new Object[0]);
        zzc();
    ...
    public final void zzb() {
        int i = (int) this.zzb;
        long j = (i == 30 || i == 60 || i == 120 || i == 240 || i == 480) ? 2 * this.zzb : i != 960 ? 30 : 960;
        this.zzb = j;
