...
public class FirebaseInstanceId {
    ...
    public final synchronized void zza(long j) {
        zzax zzax2 = new zzax(this, this.zzav, this.zzay, Math.min(Math.max(30, j << 1), zzaq));
        zza((Runnable) zzax2, j);
        this.zzaz = true;
    }
    ...
    public final /* synthetic */ Task zza(String str, String str2, Task task) throws Exception {
        ...
        String zzb2 = zzay.zzb(zzb);
        zzaq zzaq2 = this.zzax;
        zzn zzn = new zzn(this, zzj, zzb2, str, str2);
        return zzaq2.zza(str, str2, zzn);
    }
