...
public abstract class StorageTask<ResultT extends ProvideError> extends ControllableTask<ResultT> {
    ...
    static {
        HashMap<Integer, HashSet<Integer>> hashMap = ValidUserInitiatedStateChanges;
        Integer valueOf = Integer.valueOf(1);
        Integer valueOf2 = Integer.valueOf(2);
        Integer valueOf3 = Integer.valueOf(16);
        Integer valueOf4 = Integer.valueOf(256);
        hashMap.put(valueOf, new HashSet(Arrays.asList(new Integer[]{valueOf3, valueOf4})));
        HashMap<Integer, HashSet<Integer>> hashMap2 = ValidUserInitiatedStateChanges;
        Integer valueOf5 = Integer.valueOf(8);
        hashMap2.put(valueOf2, new HashSet(Arrays.asList(new Integer[]{valueOf5, Integer.valueOf(32)})));
        HashMap<Integer, HashSet<Integer>> hashMap3 = ValidUserInitiatedStateChanges;
        Integer valueOf6 = Integer.valueOf(4);
        hashMap3.put(valueOf6, new HashSet(Arrays.asList(new Integer[]{valueOf5, Integer.valueOf(32)})));
        ValidUserInitiatedStateChanges.put(valueOf3, new HashSet(Arrays.asList(new Integer[]{valueOf2, valueOf4})));
        HashMap<Integer, HashSet<Integer>> hashMap4 = ValidUserInitiatedStateChanges;
        Integer valueOf7 = Integer.valueOf(64);
        hashMap4.put(valueOf7, new HashSet(Arrays.asList(new Integer[]{valueOf2, valueOf4})));
        ValidTaskInitiatedStateChanges.put(Integer.valueOf(1), new HashSet(Arrays.asList(new Integer[]{valueOf2, valueOf7})));
        HashMap<Integer, HashSet<Integer>> hashMap5 = ValidTaskInitiatedStateChanges;
        Integer valueOf8 = Integer.valueOf(128);
        hashMap5.put(valueOf2, new HashSet(Arrays.asList(new Integer[]{valueOf6, valueOf7, valueOf8})));
        ValidTaskInitiatedStateChanges.put(valueOf6, new HashSet(Arrays.asList(new Integer[]{valueOf6, valueOf7, valueOf8})));
        ValidTaskInitiatedStateChanges.put(valueOf5, new HashSet(Arrays.asList(new Integer[]{valueOf3, valueOf7, valueOf8})));
        ValidTaskInitiatedStateChanges.put(Integer.valueOf(32), new HashSet(Arrays.asList(new Integer[]{valueOf4, valueOf7, valueOf8})));
    }
    ...
    public boolean tryChangeState(int[] r9, boolean r10) {
        ...
        L_0x0064:
            ...
            java.lang.String r2 = r8.getStateString(r5)     // Catch:{ all -> 0x00f4 }
            r0.append(r2)     // Catch:{ all -> 0x00f4 }
            ...
            java.lang.String r10 = r8.getStateString(r10)     // Catch:{ all -> 0x00f4 }
            r0.append(r10)     // Catch:{ all -> 0x00f4 }
        ...
        L_0x00c2:
            ...
            java.lang.String r9 = r8.getStateString(r9)     // Catch:{ all -> 0x00f4 }
