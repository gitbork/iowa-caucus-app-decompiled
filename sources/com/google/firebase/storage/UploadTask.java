...
public class UploadTask extends StorageTask<TaskSnapshot> {
    ...
    private void uploadChunk() {
        ...
        try {
            ...
            if (!send(resumableUploadByteRequest)) {
                ...
                sb.append(this.mCurrentChunkSize);
            ...
            if (!this.mStreamBuffer.isFinished()) {
                ...
                if (this.mCurrentChunkSize < MAXIMUM_CHUNK_SIZE) {
                    ...
                    sb2.append(this.mCurrentChunkSize);
    ...
    public TaskSnapshot snapStateImpl() {
        TaskSnapshot taskSnapshot = new TaskSnapshot(StorageException.fromExceptionAndHttpCode(this.mException != null ? this.mException : this.mServerException, this.mResultCode), this.mBytesUploaded.get(), this.mUploadUri, this.mMetadata);
        return taskSnapshot;
    }
}
