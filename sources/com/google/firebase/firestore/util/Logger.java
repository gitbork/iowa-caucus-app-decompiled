...
public class Logger {
    ...
    static /* synthetic */ class C15531 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.firestore.util.Logger.C15531.<clinit>():void");
        }
    }
    ...
    private static void doLog(Level level, String str, String str2, Object... objArr) {
        if (level.ordinal() >= logLevel.ordinal()) {
            ...
            sb.append(String.format("(%s) [%s]: ", new Object[]{BuildConfig.VERSION_NAME, str}));
            sb.append(String.format(str2, objArr));
            String sb2 = sb.toString();
            int i = C15531.$SwitchMap$com$google$firebase$firestore$util$Logger$Level[level.ordinal()];
