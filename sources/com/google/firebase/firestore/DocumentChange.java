...
public class DocumentChange {
    ...
    /* compiled from: com.google.firebase:firebase-firestore@@20.2.0 */
    static /* synthetic */ class C15151 {

        /* renamed from: $SwitchMap$com$google$firebase$firestore$core$DocumentViewChange$Type */
        static final /* synthetic */ int[] f234x33862af7 = new int[com.google.firebase.firestore.core.DocumentViewChange.Type.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f234x33862af7 = r0
                int[] r0 = f234x33862af7     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f234x33862af7     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                int[] r0 = f234x33862af7     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                int[] r0 = f234x33862af7     // Catch:{ NoSuchFieldError -> 0x0035 }
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.firestore.DocumentChange.C15151.<clinit>():void");
        }
    }
    ...
    private static Type getType(DocumentViewChange documentViewChange) {
        int i = C15151.f234x33862af7[documentViewChange.getType().ordinal()];
        if (i == 1) {
            return Type.ADDED;
        }
        if (i == 2 || i == 3) {
