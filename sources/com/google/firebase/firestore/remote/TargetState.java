...
final class TargetState {
    ...
    /* compiled from: com.google.firebase:firebase-firestore@@20.2.0 */
    static /* synthetic */ class C15501 {

        /* renamed from: $SwitchMap$com$google$firebase$firestore$core$DocumentViewChange$Type */
        static final /* synthetic */ int[] f268x33862af7 = new int[Type.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f268x33862af7 = r0
                int[] r0 = f268x33862af7     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f268x33862af7     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                int[] r0 = f268x33862af7     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.firestore.remote.TargetState.C15501.<clinit>():void");
        }
    }
    ...
    public TargetChange toTargetChange() {
        ...
        for (Entry entry : this.documentChanges.entrySet()) {
            ...
            int i = C15501.f268x33862af7[type.ordinal()];
            if (i == 1) {
