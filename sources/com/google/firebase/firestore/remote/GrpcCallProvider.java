...
import com.google.firestore.p008v1.FirestoreGrpc.FirestoreStub;
...
import p006io.grpc.android.AndroidChannelBuilder;
...
public class GrpcCallProvider {
    ...
    static /* synthetic */ ManagedChannel lambda$new$0(GrpcCallProvider grpcCallProvider, Context context, DatabaseInfo databaseInfo, CallCredentials callCredentials) throws Exception {
        ...
        grpcCallProvider.callOptions = ((FirestoreStub) FirestoreGrpc.newStub(initChannel).withCallCredentials(callCredentials)).getCallOptions();
        return initChannel;
    }
