...
public class WatchChangeAggregator {
    ...
    static /* synthetic */ class C15521 {
        ...
        static final /* synthetic */ int[] f269x3bf9e295 = new int[WatchTargetChangeType.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f269x3bf9e295 = r0
                int[] r0 = f269x3bf9e295     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f269x3bf9e295     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                int[] r0 = f269x3bf9e295     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                int[] r0 = f269x3bf9e295     // Catch:{ NoSuchFieldError -> 0x0035 }
            ...
            L_0x0035:
                int[] r0 = f269x3bf9e295     // Catch:{ NoSuchFieldError -> 0x0040 }
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.firestore.remote.WatchChangeAggregator.C15521.<clinit>():void");
        }
    }
    ...
    public void handleTargetChange(WatchTargetChange watchTargetChange) {
        for (Integer intValue : getTargetIds(watchTargetChange)) {
            ...
            int i = C15521.f269x3bf9e295[watchTargetChange.getChangeType().ordinal()];
            boolean z = true;
            if (i != 1) {
                if (i == 2) {
    ...
    private Collection<Integer> getTargetIds(WatchTargetChange watchTargetChange) {
        List targetIds = watchTargetChange.getTargetIds();
    ...
    private void resetTarget(int i) {
        Assert.hardAssert(this.targetStates.get(Integer.valueOf(i)) != null && !((TargetState) this.targetStates.get(Integer.valueOf(i))).isPending(), "Should only reset active targets", new Object[0]);
