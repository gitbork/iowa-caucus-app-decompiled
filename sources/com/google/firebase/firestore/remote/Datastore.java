...
import com.google.firestore.p008v1.BatchGetDocumentsRequest;
import com.google.firestore.p008v1.CommitRequest;
import com.google.firestore.p008v1.CommitRequest.Builder;
import com.google.firestore.p008v1.CommitResponse;
import com.google.firestore.p008v1.FirestoreGrpc;
...
public class Datastore {
    ...
    static /* synthetic */ java.util.List lambda$lookup$1(com.google.firebase.firestore.remote.Datastore r3, java.util.List<com.google.firebase.firestore.model.DocumentKey> r4, com.google.android.gms.tasks.Task r5) throws java.lang.Exception {
        /*
            ...
            com.google.firebase.firestore.remote.FirestoreChannel r0 = r3.channel
            r0.invalidateToken()
        L_0x0021:
        ...
        L_0x0030:
            ...
            com.google.firestore.v1.BatchGetDocumentsResponse r1 = (com.google.firestore.p008v1.BatchGetDocumentsResponse) r1
    ...
    public static boolean isSslHandshakeError(Status status) {
        ...
        return VERSION.SDK_INT < 21 && code.equals(Status.Code.UNAVAILABLE) && ((cause instanceof SSLHandshakeException) || ((cause instanceof ConnectException) && cause.getMessage().contains("EHOSTUNREACH")));
    }
