...
public final class RemoteStore implements TargetMetadataProvider {
    ...
    public RemoteStore(RemoteStoreCallback remoteStoreCallback2, LocalStore localStore2, Datastore datastore2, AsyncQueue asyncQueue, ConnectivityMonitor connectivityMonitor2) {
        ...
        this.watchStream = datastore2.createWatchStream(new Callback() {
            public void onOpen() {
        ...
        this.writeStream = datastore2.createWriteStream(new Callback() {
            public void onOpen() {
    ...
    public void handleWatchChange(SnapshotVersion snapshotVersion, WatchChange watchChange) {
        ...
        boolean z = watchChange instanceof WatchTargetChange;
    ...
    public void handleWatchStreamClose(Status status) {
        if (Status.f146OK.equals(status)) {
    ...
    private void raiseWatchSnapshot(SnapshotVersion snapshotVersion) {
        ...
        for (Integer intValue2 : createRemoteEvent.getTargetMismatches()) {
            ...
            if (queryData2 != null) {
                ...
                QueryData queryData3 = new QueryData(queryData2.getQuery(), intValue3, queryData2.getSequenceNumber(), QueryPurpose.EXISTENCE_FILTER_MISMATCH);
                sendWatchRequest(queryData3);
            }
        }
    ...
    public void fillWritePipeline() {
        int batchId = this.writePipeline.isEmpty() ? -1 : ((MutationBatch) this.writePipeline.getLast()).getBatchId();
        while (true) {
