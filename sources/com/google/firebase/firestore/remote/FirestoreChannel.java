...
import p006io.grpc.ForwardingClientCall;
...
class FirestoreChannel {
    private static final Key<String> RESOURCE_PREFIX_HEADER = Key.m370of("google-cloud-resource-prefix", Metadata.ASCII_STRING_MARSHALLER);
    private static final Key<String> X_GOOG_API_CLIENT_HEADER = Key.m370of("x-goog-api-client", Metadata.ASCII_STRING_MARSHALLER);
    ...
    public <ReqT, RespT> ClientCall<ReqT, RespT> runBidiStreamingRpc(MethodDescriptor<ReqT, RespT> methodDescriptor, IncomingStreamObserver<RespT> incomingStreamObserver) {
        ...
        final Task createClientCall = this.callProvider.createClientCall(methodDescriptor);
        createClientCall.addOnCompleteListener(this.asyncQueue.getExecutor(), FirestoreChannel$$Lambda$1.lambdaFactory$(this, clientCallArr, incomingStreamObserver));
    ...
    static /* synthetic */ void lambda$runBidiStreamingRpc$0(FirestoreChannel firestoreChannel, final ClientCall[] clientCallArr, final IncomingStreamObserver incomingStreamObserver, Task task) {
        ...
        clientCallArr[0].start(new Listener<RespT>() {
            public void onReady() {
            }
    ...
    static /* synthetic */ void lambda$runStreamingResponseRpc$1(FirestoreChannel firestoreChannel, final TaskCompletionSource taskCompletionSource, Object obj, Task task) {
        ...
        clientCall.start(new Listener<RespT>() {
            public void onMessage(RespT respt) {
                arrayList.add(respt);
