...
public class View {
    ...
    /* compiled from: com.google.firebase:firebase-firestore@@20.2.0 */
    static /* synthetic */ class C15261 {

        /* renamed from: $SwitchMap$com$google$firebase$firestore$core$DocumentViewChange$Type */
        static final /* synthetic */ int[] f240x33862af7 = new int[Type.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f240x33862af7 = r0
                int[] r0 = f240x33862af7     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f240x33862af7     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                int[] r0 = f240x33862af7     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                int[] r0 = f240x33862af7     // Catch:{ NoSuchFieldError -> 0x0035 }
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.firestore.core.View.C15261.<clinit>():void");
        }
    }
    ...
    public static class DocumentChanges {
        ...
        /* synthetic */ DocumentChanges(DocumentSet documentSet2, DocumentViewChangeSet documentViewChangeSet, ImmutableSortedSet immutableSortedSet, boolean z, C15261 r5) {
    ...
    public ViewChange applyChanges(DocumentChanges documentChanges, TargetChange targetChange) {
        ...
        SyncState syncState2 = this.limboDocuments.size() == 0 && this.current ? SyncState.SYNCED : SyncState.LOCAL;
        boolean z = syncState2 != this.syncState;
        this.syncState = syncState2;
        if (changes.size() != 0 || z) {
            viewSnapshot = new ViewSnapshot(this.query, documentChanges2.documentSet, documentSet2, changes, syncState2 == SyncState.LOCAL, documentChanges2.mutatedKeys, z, false);
        } else {
            viewSnapshot = null;
        }
    ...
    public ViewChange applyOnlineStateChange(OnlineState onlineState) {
        ...
        this.current = false;
        DocumentChanges documentChanges = new DocumentChanges(this.documentSet, new DocumentViewChangeSet(), this.mutatedKeys, false, null);
        return applyChanges(documentChanges);
    }
    ...
    private void applyTargetChange(TargetChange targetChange) {
        if (targetChange != null) {
            ...
            Iterator it3 = targetChange.getRemovedDocuments().iterator();
            while (it3.hasNext()) {
                this.syncedDocuments = this.syncedDocuments.remove((DocumentKey) it3.next());
            }
    ...
    private List<LimboDocumentChange> updateLimboDocuments() {
        ...
        Iterator it3 = this.limboDocuments.iterator();
        while (it3.hasNext()) {
    ...
    private static int changeTypeOrder(DocumentViewChange documentViewChange) {
        int i = C15261.f240x33862af7[documentViewChange.getType().ordinal()];
        int i2 = 1;
        if (i != 1) {
            i2 = 2;
            if (!(i == 2 || i == 3)) {
