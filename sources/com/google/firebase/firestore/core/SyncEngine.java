...
public class SyncEngine implements RemoteStoreCallback {
    ...
    static /* synthetic */ class C15241 {
        ...
        static final /* synthetic */ int[] f239x84ba890d = new int[Type.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f239x84ba890d = r0
                int[] r0 = f239x84ba890d     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f239x84ba890d     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.firestore.core.SyncEngine.C15241.<clinit>():void");
        }
    }
    ...
    public ImmutableSortedSet<DocumentKey> getRemoteKeysForTarget(int i) {
        ...
        if (queryView != null) {
            immutableSortedSet = queryView.getView().getSyncedDocuments();
        } else {
            immutableSortedSet = DocumentKey.emptyKeySet();
        }
    ...
    public void handleRejectedListen(int i, Status status) {
        ...
        if (access$100 != null) {
            ...
            RemoteEvent remoteEvent = new RemoteEvent(SnapshotVersion.NONE, Collections.emptyMap(), Collections.emptySet(), Collections.singletonMap(access$100, new NoDocument(access$100, SnapshotVersion.NONE, false)), Collections.singleton(access$100));
    ...
    private void updateTrackedLimboDocuments(List<LimboDocumentChange> list, int i) {
        for (LimboDocumentChange limboDocumentChange : list) {
            int i2 = C15241.f239x84ba890d[limboDocumentChange.getType().ordinal()];
            if (i2 == 1) {
