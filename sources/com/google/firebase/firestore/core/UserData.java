...
public class UserData {
    ...
    static /* synthetic */ class C15251 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.firestore.core.UserData.C15251.<clinit>():void");
        }
    }
    ...
    public static class ParseAccumulator {
        ...
        public ParsedSetData toMergeData(ObjectValue objectValue, FieldMask fieldMask2) {
            ...
            while (it.hasNext()) {
                ...
                if (fieldMask2.covers(fieldTransform.getFieldPath())) {
    ...
    public static class ParseContext {
        ...
        /* synthetic */ ParseContext(ParseAccumulator parseAccumulator, FieldPath fieldPath, boolean z, C15251 r4) {
        ...
        public boolean isWrite() {
            int i = C15251.$SwitchMap$com$google$firebase$firestore$core$UserData$Source[this.accumulator.dataSource.ordinal()];
            if (i == 1 || i == 2 || i == 3) {
                return true;
            }
            if (i == 4) {
