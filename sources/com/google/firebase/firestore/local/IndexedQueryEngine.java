...
public class IndexedQueryEngine implements QueryEngine {
    ...
    static /* synthetic */ class C15271 {
        ...
        static {
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.firestore.local.IndexedQueryEngine.C15271.<clinit>():void");
        }
    }
    ...
    private static double estimateFilterSelectivity(Filter filter) {
        ...
        double d2 = fieldFilter.getOperator().equals(Operator.EQUAL) ? 1.0d : 0.5d;
    ...
    private static IndexRange convertFilterToIndexRange(Filter filter) {
        ...
        if (filter instanceof FieldFilter) {
            ...
            int i = C15271.$SwitchMap$com$google$firebase$firestore$core$Filter$Operator[fieldFilter.getOperator().ordinal()];
            if (i == 1) {
