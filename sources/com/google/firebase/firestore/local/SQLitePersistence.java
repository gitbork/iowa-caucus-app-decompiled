...
public final class SQLitePersistence extends Persistence {
    ...
    static class LongQuery {
        ...
        /* renamed from: db */
        private final SQLitePersistence f248db;
        ...
        public Query performNextSubquery() {
            ...
            SQLitePersistence sQLitePersistence = this.f248db;
    ...
    static class Query {
        ...
        /* renamed from: db */
        private final SQLiteDatabase f249db;
        private final String sql;

        Query(SQLiteDatabase sQLiteDatabase, String str) {
            this.f249db = sQLiteDatabase;
            this.sql = str;
        }
        ...
        private Cursor startQuery() {
            ...
            if (cursorFactory2 != null) {
                return this.f249db.rawQueryWithFactory(cursorFactory2, this.sql, null, null);
            }
            return this.f249db.rawQuery(this.sql, null);
        }
    }
    ...
    public void start() {
        ...
        this.started = true;
        try {
            this.f247db = this.opener.getWritableDatabase();
    ...
    public void runTransaction(String str, Runnable runnable) {
        ...
        this.f247db.beginTransactionWithListener(this.transactionListener);
        try {
            runnable.run();
            this.f247db.setTransactionSuccessful();
        } finally {
            this.f247db.endTransaction();
        }
    }
    ...
    public static void clearPersistence(Context context, DatabaseId databaseId, String str) throws FirebaseFirestoreException {
        ...
        try {
            ...
            sb5.append("Failed to clear persistence.");
            sb5.append(e);
            throw new FirebaseFirestoreException(sb5.toString(), Code.UNKNOWN);
        }
    }
    ...
    public void execute(String str, Object... objArr) {
        this.f247db.execSQL(str, objArr);
    }

    /* access modifiers changed from: 0000 */
    public SQLiteStatement prepare(String str) {
        return this.f247db.compileStatement(str);
    }
    ...
    public Query query(String str) {
        return new Query(this.f247db, str);
    }
