...
public final class LocalSerializer {
    ...
    /* compiled from: com.google.firebase:firebase-firestore@@20.2.0 */
    static /* synthetic */ class C15281 {

        /* renamed from: $SwitchMap$com$google$firebase$firestore$proto$MaybeDocument$DocumentTypeCase */
        static final /* synthetic */ int[] f241xe45654f0 = new int[DocumentTypeCase.values().length];

        /* renamed from: $SwitchMap$com$google$firebase$firestore$proto$Target$TargetTypeCase */
        static final /* synthetic */ int[] f242x5167ea64 = new int[TargetTypeCase.values().length];
        ...
        static {
            /*
                ...
                f242x5167ea64 = r0
                r0 = 1
                int[] r1 = f242x5167ea64     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                r1 = 2
                int[] r2 = f242x5167ea64     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                ...
                int[] r2 = new int[r2]
                f241xe45654f0 = r2
                int[] r2 = f241xe45654f0     // Catch:{ NoSuchFieldError -> 0x0032 }
            ...
            L_0x0032:
                int[] r0 = f241xe45654f0     // Catch:{ NoSuchFieldError -> 0x003c }
            ...
            L_0x003c:
                int[] r0 = f241xe45654f0     // Catch:{ NoSuchFieldError -> 0x0047 }
            ...
            L_0x0047:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.firestore.local.LocalSerializer.C15281.<clinit>():void");
        }
    }
    ...
    public com.google.firebase.firestore.model.MaybeDocument decodeMaybeDocument(MaybeDocument maybeDocument) {
        int i = C15281.f241xe45654f0[maybeDocument.getDocumentTypeCase().ordinal()];
        if (i == 1) {
    ...
    private com.google.firestore.p008v1.Document encodeDocument(Document document) {
        com.google.firestore.p008v1.Document.Builder newBuilder = com.google.firestore.p008v1.Document.newBuilder();
        ...
        return (com.google.firestore.p008v1.Document) newBuilder.build();
    }

    private Document decodeDocument(com.google.firestore.p008v1.Document document, boolean z) {
        ...
        Document document2 = new Document(decodeKey, decodeVersion, documentState2, document, LocalSerializer$$Lambda$1.lambdaFactory$(remoteSerializer));
        return document2;
    }
    ...
    public QueryData decodeQueryData(Target target) {
        ...
        int i = C15281.f242x5167ea64[target.getTargetTypeCase().ordinal()];
        if (i == 1) {
