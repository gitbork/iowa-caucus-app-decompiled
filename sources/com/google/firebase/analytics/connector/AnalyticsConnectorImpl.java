        ...
        return new AnalyticsConnectorHandle() {
            public void unregister() {
                if (AnalyticsConnectorImpl.this.zza(str)) {
                    AnalyticsConnectorListener zza2 = ((zza) AnalyticsConnectorImpl.this.zza.get(str)).zza();
                    if (zza2 != null) {
            ...
            public void registerEventNames(Set<String> set) {
                if (AnalyticsConnectorImpl.this.zza(str) && str.equals("fiam") && set != null && !set.isEmpty()) {
                    ((zza) AnalyticsConnectorImpl.this.zza.get(str)).zza(set);
                }
            }
            ...
            public void unregisterEventNames() {
                if (AnalyticsConnectorImpl.this.zza(str) && str.equals("fiam")) {
                    ((zza) AnalyticsConnectorImpl.this.zza.get(str)).zzb();
                }
            }
        };
    }
