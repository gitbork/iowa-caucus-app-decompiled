    ...
    static /* synthetic */ class C19831 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.swmansion.reanimated.nodes.PropsNode.C19831.<clinit>():void");
        }
    }
        ...
        for (Entry entry : this.mMapping.entrySet()) {
            ...
            if (findNodeById instanceof StyleNode) {
                ...
                while (keySetIterator.hasNextKey()) {
                    ...
                    int i = C19831.$SwitchMap$com$facebook$react$bridge$ReadableType[type.ordinal()];
                    if (i == 1) {
