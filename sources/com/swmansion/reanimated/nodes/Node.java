...
public abstract class Node {
    ...
    public final Object value() {
        if (this.mLastLoopID.containsKey(this.mUpdateContext.callID) && ((Long) this.mLastLoopID.get(this.mUpdateContext.callID)).longValue() >= this.mUpdateContext.updateLoopID) {
