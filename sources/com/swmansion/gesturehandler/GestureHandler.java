...
public class GestureHandler<T extends GestureHandler> {
    ...
    /* renamed from: mX */
    private float f452mX;

    /* renamed from: mY */
    private float f453mY;
    ...
    public final void handle(MotionEvent motionEvent) {
        if (this.mEnabled) {
            ...
            if (!(i == 3 || i == 1 || i == 5 || this.mTrackedPointersCount < 1)) {
                ...
                this.f452mX = adaptEvent.getX();
                this.f453mY = adaptEvent.getY();
                this.mNumberOfPointers = adaptEvent.getPointerCount();
                this.mWithinBounds = isWithinBounds(this.mView, this.f452mX, this.f453mY);
