...
final class Base64 {
    ...
    public static byte[] decode(String str) {
        ...
        if (i8 == 2) {
            int i9 = i3 + 1;
            bArr[i3] = (byte) ((b << Ascii.f151FF) >> 16);
            i3 = i9;
        } else if (i8 == 3) {
            int i10 = b << 6;
            int i11 = i3 + 1;
    ...
    private static String encode(byte[] bArr, byte[] bArr2) {
        ...
        for (int i2 = 0; i2 < length; i2 += 3) {
            ...
            int i6 = i4 + 1;
            int i7 = i2 + 2;
            bArr3[i4] = bArr2[((bArr[i5] & Ascii.f158SI) << 2) | ((bArr[i7] & UnsignedBytes.MAX_VALUE) >> 6)];
            i = i6 + 1;
        ...
        if (length2 == 1) {
            ...
            int i14 = length + 1;
            bArr3[i11] = bArr2[((bArr[i14] & UnsignedBytes.MAX_VALUE) >> 4) | i13];
            int i15 = i12 + 1;
            bArr3[i12] = bArr2[(bArr[i14] & Ascii.f158SI) << 2];
            bArr3[i15] = 61;
        }
        try {
